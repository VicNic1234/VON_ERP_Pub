...
//Update the rpo table
    mysql_query("UPDATE poreq SET Approved='5', LastActor='GM of Corporate Services', Status='Approved', DDApp='".$GMDD."', MgrApp='".$uid."', ApprovedBy='".$staffname."', MgrAppDate='".$TodayD."',  MgrAppComment='".$hodMSG."' WHERE RequestID = '$ReqCode'");
...
function require_approval_action_notification ($email, $fullnme, $pdfid, $role, $msg)
{
        ...
        $msgLink = 'https://www.elshcon.space/requisition/mgddppor?pdfid='.$pdfid;
