     ...
     $Approved = $row['Status'];
      ...
      else if ($Approved == 5)
      {
        //$Approved = "Pending with HR";
         $Approved = '<a href="BackToGMDiv?id='.$reqid.'"><button title="By Clicking, you send back to GM of Division" class="btn btn-warning"><i class="fa fa-undo"></i> Send To GM of Division</button></a> &nbsp; <a href="SendToGMCS?id='.$reqid.'"><button title="By Clicking, you send to GM Coporate Services" class="btn btn-success"><i class="fa fa-send"></i> Send to GM of CS</button></a>';
      }
      else if ($Approved == 6)
      {
