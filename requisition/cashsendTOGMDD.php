...
//Update the rpo table
    mysql_query("UPDATE cashreq SET Approved='8', LastActor='GM Division', Status='Approved', DDApp='".$GMDD."', MgrApp='".$uid."', ApprovedBy='".$staffname."', MgrAppDate='".$TodayD."',  MgrAppComment='".$hodMSG."' WHERE RequestID = '$ReqCode'");
   // mysql_query("UPDATE cashreq SET Approved='8', LastActor='GM Division', Status='Approved', DDApp='".$GMDD."', DDOfficerApp='".$uid."', ApprovedBy='".$staffname."', DDOfficerAppDate='".$TodayD."',  DDOfficerAppComment='".$hodMSG."' WHERE RequestID = '$ReqCode'");
