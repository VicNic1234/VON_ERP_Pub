...
$resultLeave = mysql_query("UPDATE empleave SET DivHApp='$StaffID', DivHAppDate='$TodayD', DivHAppComment='Sent Back', Status='1' WHERE id = '".$reqID."'");
...
//Lets sned the EMail here, No time
		function require_approval_action_notification ($email, $fullnme, $pdfid, $role)
		{
		        ...
		        $msgLink = 'https://elshcon.space/leave/deptleave';
