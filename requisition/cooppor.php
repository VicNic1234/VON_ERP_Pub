            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"> <strong>COO's Office</strong> Material Request Pending Approval</h3>
...
function MDAction(elem)
    {
     ...
     if (ActionOfMD != "")
     {     
    window.location.href ="cooaction?pdfid=" + ReQID + "&ActionOfMD="+ActionOfMD+"&Mgs="+MsgMD;
    //window.alert("JKJ");
     }
...
function ReadLineItem(elem)
    {
     ...
     if (hhh != "")
     {     
    window.location.href ="cooppor?pdfid=" + hhh;
    //window.alert("JKJ");
     }
