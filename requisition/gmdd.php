...
function printDiv(divName) {
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"> <strong>[<?php echo $DivisonName; ?>]</strong> Pending Approval</h3>
   ...
   <div class="form-group has-feedback" style="width:40%; display: inline-block; margin:12px; ">
    ...
    <div class="form-group has-feedback">
      <div>
        <?php if($sReqID != "" && $ApprovedChk == 8) {  ?>
       <button class="btn btn-success pull-right" onclick="sendTOMD('GM')" type="button"> Send to MD | <i class="fa fa-send"></i></button>
       <button class="btn btn-warning pull-left" onclick="sendTOBOfficierDD('GM')" type="button"> Send back to GM | <i class="fa fa-send"></i></button>
        <!-- <button class="btn btn-warning pull-left" onclick="sendTOBOfficierDD('GM')" type="button"> Send to back of Due Diligence Officer | <i class="fa fa-send"></i></button> -->
     <?php } ?>
      </div>
    </div>
...
function ReadLineItem(elem)
    {
     ...
     if (hhh != "")
     {     
    window.location.href ="gmdd?pdfid=" + hhh;
    //window.alert("JKJ");
     }
