       ...
       <?php 
        ...
        { 
         ...
         elseif ($myHDiv > 0 && $MyID != $myHDiv && $MyID != $myGM) { ?>
          ...
          <?php }
           elseif (($myGM > 0 && $MyID == $myGM) || $myHDiv == 0) { ?>
             <button class="btn btn-warning pull-right" onclick="sendTODD()" type="button"> Send to Internal Control | <i class="fa fa-send"></i></button>
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td style="font-weight: 700; color:#006600"> <?php echo $RCurr . ' ' . number_format($TAmt); ?></td>
                    </tr>
