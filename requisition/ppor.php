...
////////////////////////////////////////////////////////////////////
$resultRFQ1 = mysql_query("SELECT DISTINCT RequestID, Approved FROM poreq Where staffID='$MyID' ORDER BY reqid DESC");
...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $_SESSION['CompanyAbbr']; ?> ERP | Treat PO Requisition</title>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">View Purchase Requisition</h3>
   ...
   <div class="form-group has-feedback" style="width:40%; display: inline-block; margin:12px; ">
    ...
    <div class="form-group has-feedback">
      <div>
        ...
        $Apprs = getDeptApprovals($ReqDept,$MyID,$Approved); 

        if($sReqID != "" AND $ApprovedCHK == 0) 
        { 
          
          
         echo RequesterNextApproval($MyID, $Apprs['supervisor'], $Apprs['hod'], $Apprs['DH'], $Apprs['CPHOD'], $Apprs['GM'], $Apprs['GMCS'], $Apprs['GMDD'], $myDivID);
	...
	<div class="row">
        ...
        <a class="logo">
          ...
          <span class="logo-lg"> <img src="../mBOOT/plant.png" style ="width:40px; height:40px;"/></span>-->
                  ...
                  <a href="rpor"><button class="btn btn-success pull-right" type="button"><i class="fa fa-edit"></i> | <i class="fa fa-add"></i> Edit/Add Item to Request</button></a>
