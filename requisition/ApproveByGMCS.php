...
$resultLeave = mysql_query("UPDATE empleave SET GMCSApp='$StaffID', GMCSAppDate='$TodayD', GMCSAppComment='Approved', Status='7' WHERE id = '".$reqID."'");
...
//Lets sned the EMail here, No time
		function require_approval_action_notification ($email, $fullnme, $pdfid, $role)
		{
		        ...
		        $msgLink = 'https://elshcon.space/leave/myleave';
