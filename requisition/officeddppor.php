...
$resultRFQ1 = mysql_query("SELECT DISTINCT RequestID, Approved, Deparment FROM poreq 
   WHERE Approved=7 AND isActive=1");
...
function printDiv(divName) {
   ...
   <div class="form-group has-feedback" style="width:90%; display: inline-block; margin:12px; ">
    ...
    <div class="form-group has-feedback">
     ...
     <?php } ?>
     <?php if($RepDivID != 1 ) {} ?>
         <button class="btn btn-warning pull-left" onclick="sendTOBGMCS()" type="button"> Send back to GM Corporate Services | <i class="fa fa-send"></i></button>
     <?php } ?>
      </div>
    </div>
   <script type="text/javascript">
...
function ReadLineItem(elem)
    {
     ...
     if (hhh != "")
     {     
    window.location.href ="officeddppor?pdfid=" + hhh;
    //window.alert("JKJ");
     }
