...
//FOR APPROV
   mysql_query("UPDATE poreq SET Approved='".$Apn."', LastActor='COO\'s Office', Status='".$ReqMSG."', COOApp='".$uid."', ApprovedBy='".$staffname."', COOAppDate='".$TodayD."',  COOComment='".$Mgs."' WHERE RequestID = '$ReqCode'");
...
function require_approval_action_notification ($email, $fullnme, $pdfid, $role, $msg)
{
        ...
        $MsgTitle = "Elshcon ERP [COO's Office]";
        ...
        $msgLink = 'https://elshcon.space/requisition/ppor?sReqID='.$pdfid;
...
header('Location: cooppor?pdfid='.$ReqCode);
