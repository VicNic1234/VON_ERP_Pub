...
if(!(strpos($_SESSION['AccessModule'], "Due Diligence") > -1))//if($DeptID != 3)
{
...
$resultRFQ1 = mysql_query("SELECT DISTINCT RequestID, Approved, Deparment FROM cashreq WHERE Approved=7 AND isActive=1");
...
function printDiv(divName) {
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"> <strong>[DD Officer]</strong> Pending Approval</h3>
   ...
   <div class="form-group has-feedback" style="width:90%; display: inline-block; margin:12px; ">
    ...
    <div class="form-group has-feedback">
      <div>
        <?php if($sReqID != "" AND $ApprovedChk == 7) {  ?>
          <?php { ?>
       <button class="btn btn-success pull-right" onclick="sendTOGMDD()" type="button"> Send to GM Due Dilligence | <i class="fa fa-send"></i></button>
     <?php } ?>
         <button class="btn btn-warning pull-left" onclick="sendTOBGM()" type="button"> Send back to  GM of Requester's Division | <i class="fa fa-send"></i></button>
     <?php } ?>
      </div>
    </div>
   <script type="text/javascript">
      /*function sendTOGMDD()
      {
        ...
        //var OptType =   loadAccType(acctclass); //'<?php echo $OptType ?>';
          ...
          var size='standart';
                  var content = '<form role="form" action="cashsendTOGMDD" method="POST" ><div class="form-group">' +
                  ...
                  var title = 'Send To GM Due Dilligence';
       ...
       function sendTOBGM()
      {
        ...
        var DivisonName = '<?php echo $DivisonName ?>';
          ...
          var size='standart';
                  ...
                  ;
                  var title = 'Send Back To Requester GM';
                  var footer = '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
...
function ReadLineItem(elem)
    {
     ...
     if (hhh != "")
     {     
    window.location.href ="cashofficeddppor?pdfid=" + hhh;
    //window.alert("JKJ");
     }
