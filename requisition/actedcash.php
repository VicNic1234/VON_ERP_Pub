    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Cash Requests Acted On By Me
           <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">My Cash Requests</li>
          </ol>
        </section>
...
<?php
 ...
 LEFT JOIN users ON cashreq.staffID = users.uid where cashreq.isActive=1 AND ((cashreq.staffID = $ACTNOWID)
 OR (cashreq.SupervisorApp = $ACTNOWID)
 OR (cashreq.DeptHeadApp = $ACTNOWID)
 OR (cashreq.DivHeadApp = $ACTNOWID)
 OR (cashreq.MgrApp = $ACTNOWID)
 OR (cashreq.DDApp = $ACTNOWID)
 OR (cashreq.DDOfficerApp = $ACTNOWID)
 OR (cashreq.SetForPaymentBy = $ACTNOWID)
 OR (cashreq.COOApp = $ACTNOWID)
  OR (cashreq.MDApp = $ACTNOWID && cashreq.MDComment <> '')
	 ...
	 if ($NoRowLI > 0) 
   {
    ...
    if ($Approved == 0) 
             ...
             else if ($Approved == 8)
            {
              ...
              $ApprovedN = "Pending with Internal Control";
            }
    ...
    $ViewCash = '<a title="View full Request" href="cashview?rNo='.$RequestID.'"><i class="fa fa-eye"></i></a>';
if($Approved == 17)
{
  $Record .='
