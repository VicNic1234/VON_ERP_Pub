...
//Update the rpo table
    mysql_query("UPDATE poreq SET Approved='7', LastActor='GM of Corporate Services', Status='Approved', MDApp='".$MDID."', MgrApp='".$uid."', ApprovedBy='".$staffname."', MgrAppDate='".$TodayD."',  MgrAppComment='".$hodMSG."' WHERE RequestID = '$ReqCode'");
...
function require_approval_action_notification ($email, $fullnme, $pdfid, $role, $msg)
{
        ...
        $msgLink = 'https://elshcon.space/requisition/mdppor?pdfid='.$pdfid;
		include('../notify.php');
