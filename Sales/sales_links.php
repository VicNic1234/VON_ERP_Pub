         ...
         <div class="row">
            <div class="col-md-4">
              <div class="box box-solid">
                ...
                <div class="box-body">
                  <ul>
                    <li onclick="SalesQEntry()"> Sales Quotation Entry</li>
                    ...
                    <li><a href=""> Create and Print Recurrent Invoices</a></li>
					<br>
                    <li><a href=""> Customer Payments</a></li>
                    <li><a href=""> Customer Credit Notes</a></li>
                    <li><a href=""> Allocate Customer Payments or Credit Notes</a></li>
            ...
            <div class="col-md-4">
              <div class="box box-solid">
                ...
                <div class="box-body">
                  <li><a href="">Add and Manage Customers</a></li>
