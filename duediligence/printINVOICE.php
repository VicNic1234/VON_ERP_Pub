...
//Get Users Status if User is Officer or GM
 $resultGMDD = mysql_query("SELECT * FROM divisions WHERE divid=3");

 while ($row = mysql_fetch_array($resultGMDD)) {
            $DDGM = $row['GM'];
 }
 
 if($DDGM == $UID) { $isDDGM = "Yes"; } else { $isDDGM = "No"; }
                ...
                <div class="box-body">
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                       ...
                       <a target="_blank" href="<?php echo $FileLink; ?>"><center><strong>Main Invoice Document</strong></center></a>
                     <?php } ?></td></tr>
                    <?php echo $SupDocs; ?>
                    </tbody>
                  </table>
                   ...
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <div>
                           <div class="form-group has-feedback col-md-12" >
                            ...
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $CONID; ?>">
                                  <?php if($IVSTATUS == 2) { ?> 
                                  <textarea class="form-control" required name="DDcomment" id="GMDDcomment" ></textarea> 
                                  <?php } ?>
                            ...
                            <div class="col-md-12">
                               ...
                               <?php if($IVSTATUS == 2) { ?>
                            <div class="col-md-6">
                            <form action="updateIVCONT" method="post" id="sndbkIVCONTGMDD" >
                              <input type="hidden" name="conID" value="<?php echo $CONID; ?>">
                              <input type="hidden" name="DDcomment" id="GMDDCMBK" />
                              <input type="hidden" name="DDapprove" value="" />  <!-- onclick="gmddsndbk();" -->
                              <button type="button" onclick="sndbktogmcs();" class="btn btn-danger btn-block btn-flat">Send Back GM CS</button>
                             </form>
                            </div>
                            ...
                            <form action="updateIVCONT" method="post" id="IVCONTGMDD">
                              <input type="hidden" name="conID" value="<?php echo $CONID; ?>">
                              <input type="hidden" name="DDcomment" id="GMDDCM" />
                              <input type="hidden" name="DDapprove" value="1" /> <!-- onclick="gmddsnd();" -->
                              <button type="button"  onclick="sndtomd();"   class="btn btn-success btn-block btn-flat">Approve (Move to MD)</button>
                             </form>
                            </div> 
                             <?php } ?>
                             </div>
                      ...
                      <script>
                          function sndtomd()
                          {
                              var GMDDcomment = $('#GMDDcomment').val();
                              $('#GMDDCM').val(GMDDcomment);
                              $('#IVCONTGMDD').submit();
                          }
                          
                          function sndbktogmcs()
                          {
                              var GMDDcomment = $('#GMDDcomment').val();
                              $('#GMDDCMBK').val(GMDDcomment);
                              $('#sndbkIVCONTGMDD').submit();
                          }
                      </script>
