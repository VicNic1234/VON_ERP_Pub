...
$RecChartClass = "";
$resultChartClass = mysql_query("SELECT * FROM itemcategory");
...
if ($NoRowChartClass > 0) {
  while ($row = mysql_fetch_array($resultChartClass)) {
    ...
    <td>'.$class_name.'</td>
    <td>'.$ShortCode.'</td>
    <td><a acctnme="'.$class_name.'" acctid="'.$cid.'" ShortCode="'.$ShortCode.'" onclick="editAcc(this)"><i class="fa fa-edit"></i></a></td>
            ...
            var content = '<form role="form" action="editItemCat" method="POST" ><div class="form-group">' +
             '<input type="hidden" value="'+acctid+'" id="idClass" name="idClass" />'+
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Category Name: </label><input type="text" class="form-control" id="nmeClass" name="nmeClass" value="'+acctnme+'" placeholder="" required ></div>' +
               ...
               '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Short Code: </label><input type="text" class="form-control" id="nmeClass" name="ShortCode" value="'+ShortCode+'" placeholder="" required ></div>' +
...
function addAcc(elem)
{
    ...
    var size='standart';
            var content = '<form role="form" action="addItemCat" method="POST" ><div class="form-group">' +
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Item Category Name: </label><input type="text" class="form-control" id="newClass" name="newStation" placeholder="New Item Category" required ></div>' +
              
                 '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Short Code: </label><input type="text" class="form-control" id="nmeClass" name="ShortCode" placeholder="" required ></div>' +

              '<button type="submit" class="btn btn-primary pull-right">Add Item Category</button><br/></form>';
            var title = 'New Item Category';
            var footer = '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
           ...
           <div class="col-md-12">
              ...
              <div class="box">
                <div class="box-header">
                 <button class="btn btn-success pull-right" id="addAcct" onclick="addAcc(this)" > Add Item Category</button>
