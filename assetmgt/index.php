...
include('route.php');
$PageTitle = "Asset Managment";
//Get No of Activities
$resultact = mysql_query("SELECT * FROM maintain_activities where isActive =1");
$NoRowAct = mysql_num_rows($resultact);
//Get No of Equip
$resultEquip = mysql_query("SELECT * FROM equipments");
$NoRowEquip = mysql_num_rows($resultEquip);
//Get No of Done Act
$resultDact = mysql_query("SELECT * FROM maintain_activities where isActive =1 and Done=1");
$NoRowDAct = mysql_num_rows($resultDact);
//No of Stations
$resultStations = mysql_query("SELECT * FROM equip_stations");
$NoRowStations = mysql_num_rows($resultStations);
//No of Storages
$resultStorages = mysql_query("SELECT * FROM wh_storages");
$NoRowStorages = mysql_num_rows($resultStorages);
//No of Bins
$resultBins = mysql_query("SELECT * FROM wh_bins");
$NoRowBins = mysql_num_rows($resultBins);
//No of Stocks
$resultStocks = mysql_query("SELECT * FROM wh_stock");
$NoRowStocks = mysql_num_rows($resultStocks);
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">No. of Equip.</span>
                  <span class="info-box-number"><?php echo $NoRowEquip; ?><small> for <?php echo date("Y"); ?></small></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            <div class="col-md-3 col-sm-6 col-xs-12">
			 <a title="Add Equipment Location" href="stations" target="_blank" >
              <div class="info-box">
                <span class="info-box-icon bg-red"><i class="fa fa-map-marker"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">Equip. Locations</span>
                  <span class="info-box-number"><?php echo $NoRowStations; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
        </a>
            </div><!-- /.col -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">No. of Activites</span>
                  <span class="info-box-number"><?php echo $NoRowAct; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
              <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa fa-cogs"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">Closed Activites</span>
                  <span class="info-box-number"><?php echo $NoRowDAct; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
