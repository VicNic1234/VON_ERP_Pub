	...
	<div class="row">
        ...
        <a class="logo">
          ...
          <span class="logo-lg"> <img src="../mBOOT/plant.png" style ="width:40px; height:40px;"/></span>-->
                  ...
                  <h3 class="box-title"> <?php echo $_SESSION['CompanyAbbr']; ?>- - Business Intelligence </h3>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box collapsed-box">
                <div class="box-header with-border">
                    <h3 class="box-title">[Mokveld Product Sales], [Key Opportunities for <b><?php echo $BusinessYr; ?></b> Estimate], [Breakdown in progressive sales walk]</h3>
                  <div class="box-tools pull-right">
             ...
             <div class="col-md-4">
              ...
              <div class="box box-primary" style="background:#99CCFF;">
                <div class="box-header">
                  <h3 class="box-title">Mokveld Product Sales </h3> &nbsp;<i class="fa fa-cogs"></i>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form">
                  <div class="box-body">
                    ...
                    function reportMPS()
                    {
                      ...
                      var formData = { ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, OP:OP, EAOP:EAOP, OB:OB, OBN:OBN };
                        $.ajax({
                            type:"POST",
                            url: "addmps",
                            data: formData,
                ...
                <form role="form">
                  <div class="box-body">
                    ...
                    function reportKOP()
                    {
                      ...
                      var formData = { ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, CusProj:CusProj, ProdRef:ProdRef, ProdLine:ProdLine, ValueEst:ValueEst, KOStatus:KOStatus, KOclose:KOclose };
                        $.ajax({
                            type:"POST",
                            url: "addkop",
                            data: formData,
