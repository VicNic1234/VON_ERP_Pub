...
//Let's just Update
$query = "INSERT INTO issues (Issues, Party, Status, CreatedBy, Wk, Qtr, FirstDayOfWeek, DaysOfWeek) 
VALUES ('$aIssues','$aParty','$iStatus','$uid','$ReportWeek', '$ReportQtr', '$FirstWeekDay', '$DaysOfRtpWeek' );"; 
