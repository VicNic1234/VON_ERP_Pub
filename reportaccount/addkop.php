...
$KOclose = mysql_real_escape_string(trim(strip_tags($_POST['KOclose']))); //
$TodayD = date("Y-m-d h:i:sa");


//Let's just Update
$query = "INSERT INTO kops (CusProj, ProdRef, ProdLine, ValueEst, KOStatus, KOclose, CreatedBy, Wk, Qtr, FirstDayOfWeek, DaysOfWeek) 
VALUES ('$CusProj','$ProdRef','$ProdLine','$ValueEst', '$KOStatus', '$KOclose', '$uid','$ReportWeek', '$ReportQtr', '$FirstWeekDay', '$DaysOfRtpWeek' );"; 
