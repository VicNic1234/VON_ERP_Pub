...
$CPOfficer = $_SESSION['Firstname'] . " " . $_SESSION['Surname'];
  ...
  $CHRNum = trim(strip_tags($_POST['CHRNum']));
  $CHSItem = trim(strip_tags($_POST['CHSItem']));
...
$CPOfficer = "C&P : ". $CPOfficer;
  $Today = date('Y/m/d h:i:s a'); 
	...
	$query1 = "INSERT INTO ivitems (PONo, PDFNUM, PDFItemID, CreatedBy, description, units, qty, unitprice, CreatedOn) 
