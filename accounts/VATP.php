    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Accounts - VAT Payable Ledger
            <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href=""><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">VAT Payable Ledger</li>
          </ol>
        </section>
...
?>
           ...
           <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">VAT Payable Ledger</h3>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="VATP" method="POST" ><div class="form-group">
    ...
    <script type="text/javascript">
     function ExportToExcel()
      {
        var Dat = "VAT Payable Ledger Account"; //+ new Date();
        $("#userTab").table2excel({
              exclude: ".noExl",
              name: "VAT Payable Ledger Account",
              filename: Dat,
              fileext: ".xls",
              exclude_img: true,
              exclude_links: true,
