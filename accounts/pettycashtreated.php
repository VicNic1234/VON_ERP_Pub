...
include('route.php');
 $PageTitle = "CFO Treated Cash Request";
...
<?php
 ...
 LEFT JOIN users ON cashreq.staffID = users.uid where cashreq.isActive=1 AND cashreq.Approved=16"); //WHERE isActive=1 ORDER BY cid WHERE poreq.Approved = 11
