...
require '../DBcon/db_config.php';
  ...
  $PageTitle = "ENL Invoice Lists";
  $InvoiceYears .= '<option value="ALL"> ALL </option>';  
 
$resultENLIVList = mysql_query("SELECT DISTINCT  SUBSTRING(IVDate, 1, 4) AS ExtractString FROM acct_vendorsinvoices");
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">ENL Invoices</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">ENL Invoice List</h3>
...
<?php
/*
 LEFT JOIN enlivitems ON enlinvoices.cid = enlivitems.PONo
...
*/
 ...
 LEFT JOIN users ON enlinvoices.RaisedBy = users.uid
  ...
  WHERE enlinvoices.isActive=1 ORDER BY enlinvoices.cid
...
//fetch tha data from the database
	 if ($NoRowLI > 0) 
   {
    ...
    if($PostID > 0) { $VSTAT = '<i class="fa fa-thumbs-up text-green"></i>'; } else { $VSTAT = '<i class="fa fa-thumbs-down text-red"></i>'; }
    $ViewCon = '<a title="View full ENL\'s Invoice" href="viewenlinvoice?poid='.$cid.'"><i class="fa fa-edit"></i></a>';
    $PrintPO = '<form action="printENLINVOICE" method="POST">
