...
if ($NoRowClass > 0) {
  ...
  $RecChartMaster .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
$RecChartMaster .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
$GROSSPROFIT = floatval($T7) - floatval($T6);
...
function getTotalAmt($MasterID)
{
  ...
  $resultChartMaster = mysql_query("SELECT * FROM postings
             ...
             WHERE acc_chart_master.mid = $MasterID
            ...
            if ($NoRowChartMaster > 0) {
              while ($row = mysql_fetch_array($resultChartMaster)) {
                ...
                if($TT =="CREDIT") { $CRD = $CRD + $TAmount; } else {  }
                if($TT =="DEBIT") { $DRD = $DRD + $TAmount; } else {  }
              }
                ...
                <div class="box-body">
                   <table id="userTab" class="table table-bordered table-striped">
                    <thead>
                        ...
                        <tr>
                            <th colspan="3"><center style="font-size:1.3em"> Income Statement [Profit/Loss] as at <?php echo date("Y F"); ?> </center> </th>
                        </tr>
                      <tr>
                        <th>--</th>
                        <th>Notes</th>
