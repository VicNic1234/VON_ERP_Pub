...
if ($NoRowMsg > 0) 
{
	...
	$msg .= '<li>
                        <a href="#">
                          <i class="fa fa-users text-aqua"></i> '.$row{'Message'}.'up
                        </a>
                      </li>';
	}
...
$CONID = $_GET['poid'];
 ...
 LEFT JOIN users ON acct_vendorsinvoices.RaisedBy = users.uid
 WHERE cid='".$CONID."'
...
$PageTitle = "VENDOR's INVOICE :".$INVo;
/*Get ATTNTION*/
 ...
 while ($row = mysql_fetch_array($GLAccounts)) {
     ...
     $GLmid = $row['mid'];
      ...
      else
      {
          if(602 == $GLmid)
          {
            $CCGLOpt .= '<option value="'.$GLmid.'" selected >['. $acctvariable .'] ' .$GLAcct.'</option>';
          }
...
<?php if ($NoRowCUS > 0) 
         ...
         /*Get Supporting Docs*/
$resultSDoc = mysql_query("SELECT * FROM supportingdoc Where docid='".$CONID."' AND isActive=1 AND  module='CNPINV' Order By sdid");
...
if ($NoRowPOIt > 0) {
  ...
  if($PostID == 0)
  {
      $delDoc = '<form action="acct_delIVItem" method="POST">
...
if ($NoRowPOM > 0) {
  while ($row = mysql_fetch_array($resultPOM)) 
  {
    ...
    if($PostID == 0)
    {
      $delM = '<form action="acct_delIVMItem" method="POST">
      <input type="hidden" name="id" value="'.$sdid.'" />
      <input type="hidden" name="poid" value="'.$CONID.'" />
      <button type="submit" class="btn btn-success"><i class="fa fa-trash"></i></button>
      </form>';
...
?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box collapsed-box">
                ...
                <?php if($PostID == 0) { ?>    
                     <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="updateIV" method="post">
                         <?php } ?>
          ...
          <div class="form-group has-feedback col-md-12" >
                <label>Choose Vendor:</label> <br/>
          		  <select class="form-control select2" id="VendSource" name="VendSource" required style="width:100%" >
		  ...
		  <div class="form-group has-feedback col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control datep" value="<?php echo $IVDate; ?>" name="IVDate" id="IVDate" readonly placeholder="Click to set date" required />
                    </div><!-- /.input group -->
          </div>
         ...
         <div class="form-group has-feedback col-md-6">
           ...
           <div class="form-group has-feedback col-md-6">
                   ...
                   <div class="input-group">
                      ...
                      <input class="form-control" name="VENATTN" value="<?php echo $VENATTN; ?>" />
         ...
         <div class="form-group has-feedback col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="NGNRate" onKeyPress="return isNumber(event)" required value="<?php echo $NGNRate; ?>" />
                    </div><!-- /.input group -->
          </div>
          ...
          <div class="form-group has-feedback col-md-3">
           ...
           <div class="form-group has-feedback col-md-6">
                    ...
                    <div class="input-group">
                     ...
                     <select class="srcselect form-control" id="DBDGL" name="DBDGL" style="width:100%" required readonly >
                <option value=""> --</option>
                <?php echo $CCGLOpt; ?>
                </select>
                    </div><!-- /.input group -->
		 ...
		 <div class="form-group has-feedback col-md-12">
		   ...
		   <textarea rows="4" cols="50" placeholder=" Enter comment here..." id="Comment" name="Comment" style="width:100%; display: inline-block;"><?php echo $Comment; ?></textarea>
            ...
            <input type="text" class="form-control" value="<?php echo $IVNo; ?>" id="VenInvoiceID" name="VenInvoiceID" placeholder=""  required />
		 ...
		 <br/>
          ...
          <div class="form-group has-feedback">
           <select class="form-control select2" name="PDFNum" style="width:100%">
            <option value="">--</option>
            <?php echo $ReQOpt; ?>
           </select>
            <span class="glyphicon glyphicon-barcode form-control-feedback"></span>
          ...
          <div class="form-group has-feedback">
           <select class="form-control select2" name="PONum" style="width:100%" >
            <option value="">--</option>
            <?php echo $POOpt; ?>
           </select>
            <span class="glyphicon glyphicon-barcode form-control-feedback"></span>
...
<br/>
            ...
            <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
                      ...
                      <p class="text-center">
                        <?php if($FileLink != "") { ?>
                       <a href="<?php echo $FileLink; ?>"><strong>Main Invoice Document</strong></a>
                     <?php } ?>
                      </p>
          ...
          <div class="row">
            <?php if($PostID == 0) { ?>   
            <div class="col-xs-12">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Update Vendors Invoice</button>
            </div><!-- /.col -->
            <?php } ?>
          </div>
                      </form> 
              ...
              <div class="box box-success">
                <div class="box-header">
                 Line Items
                  <form action="postINVOICE" method="POST">
                  ...
                  { ?>
                  <button class="btn btn-success pull-right"> <i class="fa fa-file"></i>  Post Vendor's Invoice </button>
                 <?php } ?>
                </form>
                 <form action="printINVOICE" method="POST">
                  <input type="hidden" name="poid" value="<?php echo $cid; ?>">
                  <button class="btn btn-info pull-right"> <i class="fa fa-file"></i>  View Vendor's Invoice </button>
    ...
    <script type="text/javascript">
      function addLI()
      {
        ...
        var UOMOpt = '<?php echo $UOMOpt; ?>';
          var size='standart';
                  var content = '<form role="form" action="addIVItem" method="POST" enctype="multipart/form-data" ><div class="form-group">' +
                   '<input type="hidden" name="conID" value="'+CONID+'" required />'+
                   ...
                   '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Item Description: </label><textarea class="form-control"  name="ItemDesc" required ></textarea></div>' +
                    ...
                    '<div class="form-group" style="width:45%; display: inline-block; margin: 6px"><label>Debiting GL: </label><select class="form-control"  name="ItemGL" required ><option value=""> --</option>'+OPTGL+'</select></div>' +
      ...
      function addMI()
      {
        ...
        var UOMOpt = '<?php echo $UOMOpt; ?>';
          var size='standart';
                  var content = '<form role="form" action="addIVMItem" method="POST" enctype="multipart/form-data" ><div class="form-group">' +
                   '<input type="hidden" name="conID" value="'+CONID+'" required />'+
