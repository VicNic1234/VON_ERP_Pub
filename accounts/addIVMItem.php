...
$UID = $_SESSION['uid'];
  ...
  $Today = date('Y/m/d h:i:s a'); 
	...
	$query1 = "INSERT INTO acct_ivmiscellaneous (ItemGL, PONo, CreatedBy, description, Impact, price, AmtType, CreatedOn) 
	VALUES ('".$ItemGL."','".$conID."','".$UID."','".$ItemDesc."','".$ItemImpact."','".$ItemPrice."','".$AmtType."','".$Today."');";
