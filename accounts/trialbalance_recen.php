...
if ($NoRowClass > 0) {
  while ($row = mysql_fetch_array($ChartClassQ)) {
    ...
    {
        //$RecChartMaster .= '<tr><td><b>'.$AccTClass.' - - '.$ClassNature.'</b></td><td>-</td><td>-</td><td>-</td></tr>'; 
    }
   ...
   //Let's Read ChartType
      ...
      while ($row = mysql_fetch_array($ChartTypeQ)) {
          ...
          {
             // $RecChartMaster .= '<tr><td>-</td><td><b><em>'.$tname.'</em></b></td><td>-</td><td>-</td><td>-</td></tr>';
          }
            ...
            if ($NoRowChartMaster > 0) {
              while ($row = mysql_fetch_array($resultChartMaster)) {
               ...
               {    
                   ...
                   ////////***********////////////////// CLEAN CODE //////////////////////////
                   //No brought forward for income and expenses
                   // $cid == 3 || $cid == 4
                 
                   if($FromD == "")
                   {
                       if($cid == 3 || $cid == 4) //No brought forward for income and expenses
                       {
                           if ( $FromD <= $TD && $TD <= $ToD)  
                           {
                           if($TT =="CREDIT") { 
                               $TOTALHEADCR += floatval($TAmount);  
                                if($EXZ != 1)
                                {
                                $RecChartMaster .= '<tr><td>-</td><td>-</td><td>'.$acid.'</td><td><a href="viewacct?TID='.$cidIM.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td>'.$TD.'</td><td><a href="viewacct?ACCTID='.$mid2.'"><i class="fa fa-eye text-green"></i></a> '.$mid3.'</td><td>'.$TDescr.'</td><td>  </td><td>'.number_format($TAmount,2).'</td>
                                </tr>';
                                }
                            }
                            ...
                            if($TT =="DEBIT") { 
                               $TOTALHEADDR += floatval($TAmount);  
                                if($EXZ != 1)
                                {
                                $RecChartMaster .= '<tr><td>-</td><td>-</td><td>'.$acid.'</td><td><a href="viewacct?TID='.$cidIM.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td>'.$TD.'</td><td><a href="viewacct?ACCTID='.$mid2.'"><i class="fa fa-eye text-green"></i></a> '.$mid3.'</td><td>'.$TDescr.'</td><td> '.number_format($TAmount,2).'  </td><td> </td>
                                </tr>';
                                }
                            }
                           }
                ...
                if($ACLASS == 1 ||  $ACLASS == 4)
                {
                    ...
                    $TOTALHEADBAL =  floatval($TOTALHEADDR) - floatval($TOTALHEADCR); $DISBAL =  abs($TOTALHEADBAL);
                    ...
                    if($EXZ == 1)
                    {
                        ...
                        if($acctTypeID == 11)
                        {
                         ...
                         if($TOTALHEADBAL > 0) {  //Let's know if we have to flip
                         $RecChartMaster .= '<tr><td>'.$acid.'</td><td><a href="viewacct?TID='.$cidIM.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td></td><td> '.number_format($DISBAL,2).' </td></tr>';
                          $SuperCredit += $DISBAL;
                         }
                         else
                         {
                              $RecChartMaster .= '<tr><td>'.$acid.'</td><td><a href="viewacct?TID='.$cidIM.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td> '.number_format($DISBAL,2).' </td><td>  </td></tr>';
                          $SuperDebit += $DISBAL;
                         }
                ...
                else
                {
                  /* if($TOTALHEADCR != 0 || $TOTALHEADDR != 0) { 
                   ...
                   $TOTALHEADBAL =  floatval($TOTALHEADCR) - floatval($TOTALHEADDR); $DISBAL =  abs($TOTALHEADBAL);
                   if($EXZ == 1)
                    {
                        // $RecChartMaster .= '<tr><td></td><td></td><td>'.$acid.'</td><td><a href="viewacct?TID='.$cidIM.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td></td><td></td><td></td><td>'.number_format($TOTALHEADDR,2).'</td><td>'.number_format($TOTALHEADCR,2).'</td></tr>';
                        if($TOTALHEADBAL > 0) {
    ...
    if($EXZ == 1)
                {
  $RecChartMaster .= '<tr><td>-</td><td>-</td><td style="border-top: double;  border-bottom: double ">'.number_format($SuperDebit,2).'</td><td style="border-top: double; border-bottom: double ">'.number_format($SuperCredit,2).'</td>
