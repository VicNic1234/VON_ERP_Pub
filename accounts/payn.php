   ...
   // $amtOweing = ChkIfOwening($cusid);
    ...
    //if($amtOweing > 0)
    {
        ...
        //New Algorithm to net out per customer
         ...
         $TotalAmtPaid = getTotalAmtPaid($supid);
         // TAP ON OVER PAY 
        // if($AMTPOSTED[0] < $TotalAmtPaid) { $TotalAmtPaid = $AMTPOSTED[0];  }
       ...
       // exit;
        ...
        {
            /////////////////////////////////
 /*           SELECT SUBSTRING_INDEX(TransactionDate, '/', 1) AS street1 FROM `postings` WHERE 
(
    SUBSTRING_INDEX(TransactionDate, '/', 1) <> '2019'
    AND
    SUBSTRING_INDEX(TransactionDate, '/', 1) <> '2018'
    AND
    SUBSTRING_INDEX(TransactionDate, '/', 1) <> '2020'
...
*/
           ...
           */
           ...
           if($FTotalAmtPaid > 0 )
            ...
            if($FTotalAmtPaid > 0 )
                       {
                         $FTotalAmtPaid = $FTotalAmtPaid - $AMTPOSTED[1];
                         if($FTotalAmtPaid >= 0) { $AMTPOSTED[1] = 0;  } else { $AMTPOSTED[1] = ($FTotalAmtPaid); }
                       }
          ///////////////////////////////////////////////////////
        ...
        //$TotalAmtPaidGP =  number_format($TotalAmtPaid, 2);
                ...
                <div class="box-header with-border">
                  ...
                  <div class="row">
                   <div class="col-md-12">
                        ...
                        <form role="form" action="payn" method="POST" ><div class="form-group">
