...
return ($MainTotal);
  ...
  $ChqNo = "";
   //First we need to Debit the Customer now
    $query1 = "INSERT INTO postings (ChqNo, VINVOICE, REQCODE, BankAccount, ReceivedBy, GLImpacted, GLDescription, GLDescriptionPB, TransactionAmount, 
         TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, Currency, CounterTrans, VendorID) 
         VALUES ('$ChqNo', '$ENLIV','VENCREDIT', '$BANKGL','$RaisedBy','602','$GLDes', '$GLDes', '$GLAmt', 'CREDIT', '$trandate', '$Comment', '$uid', '$TodayD', 'Payable', '$Currency', '0', '$VenCode');";
