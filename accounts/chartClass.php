...
$RecChartClass = "";
$resultChartClass = mysql_query("SELECT * FROM acc_chart_class");
...
function addAcc(elem)
{
    ...
    var size='standart';
            var content = '<form role="form" action="addClass" method="POST" ><div class="form-group">' +
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Class Name: </label><input type="text" class="form-control" id="newClass" name="newClass" placeholder="New Class" ></div>' +
              '<button type="submit" class="btn btn-primary pull-right">Add Class</button><br/></form>';
            var title = 'New Account Class';
            var footer = '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Accounts - Chart Class
            <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href=""><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Chart Class</li>
          </ol>
        </section>
           ...
           <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Chart Class</h3>
                  <div class="box-tools pull-right">
                  </div>
                </div><!-- /.box-header -->
              <div class="box">
                <div class="box-header">
                 <button class="btn btn-success pull-right" id="addAcct" onclick="addAcc(this)" > Add Account Class</button>
