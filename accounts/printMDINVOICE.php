                ...
                <div class="box-body">
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <form enctype="multipart/form-data" action="updateCONTIVMD" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $cid; ?>">
                                  <textarea disabled class="form-control" required name="MDcomment"  ><?php echo $MDOfficeComment; ?></textarea> 
                            </div>
                            ...
                            <div class="form-group has-feedback col-md-12" >
                             <?php if($MDOfficeOn == "") { ?>
                                  <label><input type="checkbox" name="MDapprove" > &nbsp; &nbsp; Approved</label>
                              <?php } else { ?>
                                <label><input type="checkbox" checked name="MDapprove" > &nbsp; &nbsp; Approved</label>
                              <?php } ?>
