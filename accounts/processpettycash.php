      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Disburse Petty Cash</li>
          </ol>
        </section>
...
'<div class="alert alert-info alert-dismissable">' .
									...
									$_SESSION['ErrMsgB'] = "";}
?>
  <form id="postPetty" action="postPettyCash" method="POST">
          <div class="row">
            <div class="col-md-12">
      ...
      var OptGLBank = '<?php echo $OptGLBank ?>'; 
         ...
         <div class="form-group has-feedback col-md-3">
          ...
          <!--<div class="form-group has-feedback col-md-3">
           ...
           <input type="text" class="form-control" name="TAMT" id="TAMT" onKeyPress="return isNumber(event)" />
            <span class="glyphicon glyphicon-cash form-control-feedback"></span>
          </div>
          -->
          ...
          <input type="hidden" id="payerDECV" name="payerDECV" />
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <center><h4> EXPENSE ACCOUNT  </h4></center> 
                   <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-6" style="background-color: #9cddf4">
                        <div class="form-group col-md-12">
                          <br/>
                          <label>Debiting GL Account: </label>
                          <select class="select2 form-control" style="width: 100%" id="DBGL" name="DBGL" required ><option value=""> --- </option><?php echo $GLOptV; ?></select>
                        </div> 
                      ...
                      <div class="col-md-6" style="background-color: #9cddf4">
                        ...
                        <div class="form-group col-md-12">
                          <button type="button" class="btn btn-primary" onclick="addLIVEN()"> Add Item From Vendor's Invoice </button>
                        </div>
                        -->
              ...
              <div class="box box-warning ">
                <div class="box-header with-border">
                  <center><h4> PETTY CASH ACCOUNT </h4></center> 
                   <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12" style="background-color: #9cddf4">

                      
                        <div class="form-group col-md-4">
                         <label>Crediting GL Account: </label>
                          <select class="select2 form-control" style="width: 100%" id="DBGLV" name="DBGLV" required ><option value=""> --- </option><?php echo $GLOpt; ?></select>
                        </div> 
                        <!-- <div class="form-group col-md-6">
              ...
              <div class="box box-success">
                ...
                <div class="box-body">
                     ...
                     <tr id="BALCASH" style="border-top: 1px solid #000; border-style: double; border-left: 0px solid; border-right: 0px solid;">
                          <th> &nbsp; </th> 
                          <th> &nbsp; </th> 
                  ...
                  var content = '<form role="form" enctype="multipart/form-data" ><div class="form-group">' +
                   ...
                   '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Item Description: </label><textarea class="form-control" id="nItemDesc"  name="ItemDesc" required ></textarea></div>' +
                    ...
                    '<div class="form-group" style="width:45%; display: inline-block; margin: 6px"><label>Item Unit: </label><select class="form-control"  name="ItemUnit" id="nItemUnit" >'+UOMOpt+'</select></div>' +
                     ...
                     '<div class="form-group" style="width:45%; display: inline-block; margin: 6px"><label>PV No.: </label><input type="text" class="form-control" id="PVNo" name="PVNo" required ></div>' +
                   ...
                   '<button type="button" onclick="nBDV()" class="btn btn-success pull-right">Add Item</button><br/></form>';
                  var title = 'New Item Details 1';
        ...
        var CHSTotalPrice = $('#nTotalPrice').val(); if(CHSTotalPrice == "") { alert("Kindly enter Cash Amount"); return false; }
         ...
         // { alert('Debit Amount must balance on table'); return false; }
          ...
          var TRow =   '<tr>'+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="CrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+DBNUM+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+PVNo+'@&@'+CHRItem+'@&@JITEM@&@'+CHRID+'@&@'+mItem+'@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
        ...
        var CHSTotalPrice = $('#nTotalPrice').val(); if(CHSTotalPrice == "") { alert("Kindly enter Cash Amount"); return false; }
         ...
         // { alert('Debit Amount must balance on table'); return false; }
          ...
          var TRow =   '<tr>'+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="DrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+DBNUM+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+CHRNum+'@&@'+CHRItem+'@&@JITEM@&@'+CHRID+'@&@'+mItem+'@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
         ...
         // { alert('Debit Amount must balance on table'); return false; }
          ...
          var TRow =   '<tr>'+
                    ...
                    CHSItemDesc+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="DrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+CHSTotalPrice+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+CHRNum+'@&@'+CHSItem+'@&@VENDINV@&@'+CHRID+'@&@'+mItem+'@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
