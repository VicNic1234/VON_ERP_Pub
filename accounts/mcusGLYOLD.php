          ...
          <div class="row">
           <div class="col-md-12">
              ...
              <div class="form-group col-md-6">
                ...
                <select class="form-control srcselect" id="CusID" name="CusID" >
                    <?php echo $SupOpt; ?>
                </select>
              </div>
