...
?>
  ...
  <script language="javascript">
      ...
      var tDate = $(elem).attr('tDate'); 
      var cid = $(elem).attr('cid');
            var size='standart';
            var content = '<form role="form" method="post" action="updatejob">'+
            '<div class="row">'+
                  '<div class="col-md-12">'+
                     ...
                     '<input class="form-control" id="ChqDate" name="ChqDate" value="'+tDate+'" placeholder="Click to select" readonly required >'+ 
                     '</div>' +
      ...
      var OptGLBank = '<?php echo $OptGLBank ?>'; 
            ...
            var size='standart';
            var content = '<form role="form" method="post" action="regjob">'+
            '<div class="row">'+
                  '<div class="col-md-12">'+
                     /*'<div class="form-group col-md-12">'+
                     '<label>Select Bank Account: </label>'+
...
<?php
 ...
 $resultLI = mysql_query("SELECT *, jobs.isActive AS CAct, 
 users.isActive AS UAct  FROM jobs 
 
 LEFT JOIN users
 ON jobs.CreatedBy = users.uid
 "
...
//fetch tha data from the database
    ...
    */
    ...
    $ViewCon = '<a title="View full details" cid="'.$chid.'" cheuqeNME="'.$cheuqeNME.'" tDate="'.$jdate.'" onclick="editCHK(this)"><i class="fa fa-edit"></i></a>';
...
?>	
              ...
              <div class="box">
                <div class="box-header">
                 <button class="btn btn-success" onclick="RegChk()">Register Job</button>
                </div><!-- /.box-header -->
                <div class="box-body">
