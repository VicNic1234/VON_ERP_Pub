    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <i class="fa fa-undo fa-spin text-green"></i> Process Petty Cash
           <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Approved Petty Cash</li>
          </ol>
        </section>
	 ...
	 if ($NoRowLI > 0) 
   {
    ...
    if ($Approved == 0) {
        ...
        $ApprovedOpt = "Raised";
            ...
            {
              $ApprovedN = "Cash Disbursed";
            }


    $ViewCon = '<a title="View Status" href="../requisition/cashviewacct?rNo='.$RequestID.'&ty=2"><i class="fa fa-eye"></i></a>';
