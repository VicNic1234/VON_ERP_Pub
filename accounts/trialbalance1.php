...
if ($NoRowClass > 0) {
  while ($row = mysql_fetch_array($ChartClassQ)) {
   ...
   //Let's Read ChartType Where isActive=1
      ...
      if ($NoRowMst > 0) {
        while ($row = mysql_fetch_array($ChartMstQ)) {
          ...
          $TOTALHEADBAL = 0.0; $TOTALHEADDR = 0.0; $TOTALHEADCR = 0.0;
             ...
             $resultChartMaster = mysql_query("SELECT *, postings1.ChqNo As ChqNoM, acc_chart_class.cid AS ACLASS FROM postings1 
             ...
             WHERE postings1.GLImpacted = '$GLIMPTY' AND postings1.isActive=1
             ORDER BY postings1.GLImpacted, postings1.TransactionDate");
            ...
            elseif ($FromD <= $TD && $TD <= $ToD)
            {
                ...
                */
                if($EXZ == 1)
                {
                    ...
                    $RecChartMaster .= '<tr><td>'.$acid.'</td><td><a href="viewacct?TID='.$cidIM.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td>'.number_format($TOTALHEADDR,2).'</td><td>'.number_format($TOTALHEADCR,2).'</td></tr>';
                ...
                <div class="box-header with-border">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="trialbalance1" method="POST" ><div class="form-group">
