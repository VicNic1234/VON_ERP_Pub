     ...
     if ($_POST['searchso'])
        {
          ...
          $fmVenID = mysql_real_escape_string(trim(strip_tags($_POST['VendorID'])));
          ...
          {
            $resultRFQ= mysql_query("SELECT * FROM so LEFT JOIN users 
            ON so.SOAssignStaff=users.uid WHERE Customer='$fmVenID' AND STR_TO_DATE(SOdate, '%m/%d/%Y') between '$fmfrmDate' and '$fmtoDate' Order By poID DESC");
          }
//exit;
        ...
        <div class="box">
            <div class="box-header">
                <form action="" method="POST">
                  ...
                  <select onclick="chkVendor(this);" name="VendorID" class="form-control" required >
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Total No. of Invoice </span>
