...
$VendSource = $nVendSource = $_POST['VendSource']; 
...
//(postings.GLImpacted <> 602 AND TransacType = 'CREDIT' AND postings.VendorID = $VendSource )   OR (GLDescription =  'Trade Payable' AND postings.VendorID = $VendSource)
   ...
   //Let's Read ChartType  OR (postings.GLImpacted = '602' AND TransacType = 'CREDIT' AND postings.VendorID = '$VendSource' AND postings.isActive=1 AND TransactionAmount > 0) 
     ...
     //(GLDescriptionPB =  'Trade Payable' AND postings.VendorID = '$VendSource' AND postings.isActive=1) 
          //////////////////////////////////////////////////////////////////////////
          if($FromD == "") {
          $resultChartMaster = mysql_query("SELECT *, postings.tncid As TNID, suppliers.isActive As SupActive  FROM postings
             ...
             (postings.GLImpacted <> '602' AND postings.TransacType = 'CREDIT' AND postings.VendorID = '$VendSource' AND postings.isActive=1343 AND postings.TransactionAmount > 0  )   
          ...
          else if ($nVendSource != "")
          {
            ...
            elseif ($FromD <= $TD && $TD <= $ToD)
            {
              ...
              $RecChartMaster .= '<tr><td>'.$VendorFName.'</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>'.number_format($TDRD, 2).'</td><td>'.number_format($TCRD, 2).'</td>
     ...
     $RecChartMasterOB .= '<tr><td>'.$VendorFName.'</td><td>(Opening Balance)</td><td>(Opening Balance)</td><td>(Opening Balance)</td><td>(Opening Balance)</td><td>(Opening Balance)</td><td>(Opening Balance)</td><td>(Opening Balance)</td><td id="dr-1" >'.number_format($DRDOB,2).'</td><td id="cr-1" >'.number_format($CRDOB,2).'</td>
          ...
          <div class="row">
           <div class="col-md-12">
              ...
              <div class="form-group col-md-6">
                <label>Vendor: </label>
                <select class="form-control select2" id="VendSource" name="VendSource" >
                    <?php echo $SupOpt; ?>
                </select>
              </div>
              ...
              <div class="box">
                <div class="box-header">
                 <!--<a href="venALL"><button class="btn btn-warning pull-right" id="addAcct" > ALL Vendor's Legder</button></a>-->
                ...
                <div class="box-body">
                   ...
                   <table id="userTab" class="table table-bordered table-striped">
                       ...
                       <tr>
                          ...
                          <td colspan="11"><center style="font-weight:800; font-size:1.2em">Vendor - <?php echo $VenNme; ?>'s Ledger</center></td>
                      </tr>
                       </thead>
                    <thead>
                      <tr>
