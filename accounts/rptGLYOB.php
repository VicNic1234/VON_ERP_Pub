      ...
      if ($NoRowMaster > 0) {
        while ($row = mysql_fetch_array($ChartMasterQ)) {
            ...
            $resultChartMaster = mysql_query("SELECT *, postings.ChqNo As ChqNoM FROM postings
             ...
             WHERE postings.GLImpacted = '$mid' AND postings.isActive=1 AND postings.TransactionAmount > 0
                ...
                <div class="box-header with-border">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="rptGLYOB" method="POST" ><div class="form-group">
              ...
              <div class="box">
                ...
                <div class="box-body">
                   ...
                   <table id="userTab" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <th colspan="11"><center style="font-size:1.5em">GL Report (With Opening Balance)</center></th>
                      </tr>
                      <tr>
