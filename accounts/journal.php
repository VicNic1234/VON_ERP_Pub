...
//Lets get GL for BANK
  ...
  //$resultGLBnk = mysql_query("SELECT * FROM  acc_chart_master LEFT JOIN bankaccount ON  acc_chart_master.mid = bankaccount.GLAcct  ORDER BY account_name");
    //check if user exist
...
//Let's Get All GL accounts
 ...
 while ($row = mysql_fetch_array($GLAccounts)) {
     ...
     $GLmid = $row['mid'];
      ...
      if($GLmid == 593)
      {
        $GLOptV .= '<option value="'.$GLmid.'" selected >['. $acctvariable .'] ' .$GLAcct.'</option>'; // $row['DeptmentName'];
      }
      else
      {
        $GLOptV .= '<option value="'.$GLmid.'">['. $acctvariable .'] ' .$GLAcct.'</option>'; // $row['DeptmentName'];
      }
     }
...
'<div class="alert alert-info alert-dismissable">' .
									...
									$_SESSION['ErrMsgB'] = "";}
?>
  <form id="postPetty" action="postJournal" method="POST">
          <div class="row">
            <div class="col-md-12">
            ...
            <div class="form-group col-md-8">
                          ...
                          <select class="select2 form-control" style="width: 100%" onchange="loadInvoice()" id="CusID" name="CusID" required ><option value=""> --- </option><?php echo $SupOpt; ?></select>
                        </div> 
             ...
             <div class="form-group has-feedback col-md-4" >
                ...
                <div class="input-group">
                      ...
                      <select class="select2 form-control" onchange="setInvItems(this)" id="CusInv" name="CusInv" required>
                <option value=""> Choose Invoice No./Ref No.</option>
          ...
          <div class="form-group has-feedback col-md-4">
                    ...
                    <label>Received By <span style="font-weight:800; font-size:14px; color:red">*</span>;</label>
                   <div class="input-group">
      ...
      var OptGLBank = '<?php echo $OptGLBank ?>'; 
           ...
           // var title = 'Add Quotation Price to Line Item';
            ...
            $('#ChqDate').datepicker({dateFormat : 'yy/mm/dd', minDate : LastEntryDate });
        }
         ...
         $.ajax({
		  ...
		  <div class="form-group has-feedback col-md-3">
                    <label>Transaction Date <span style="font-weight:800; font-size:14px; color:red">*</span>:</label>
                    <div class="input-group">
          ...
          <div class="form-group has-feedback col-md-2">
            <label>Currency <span style="font-weight:800; color:red">*</span>:</label>
          ...
          <!-- <div class="form-group has-feedback col-md-3">
            <label>Total Amount To Bank:</label>
           <input type="text" class="form-control" name="TAMT" id="TAMT" value="0" oninput="setAMT(this);" onKeyPress="return isNumber(event)" />
            <span class="glyphicon glyphicon-cash form-control-feedback"></span>
          </div> -->
          ...
          <div class="form-group has-feedback col-md-3">
            <label>NGN To Curreny rate <span style="font-weight:800; font-size:14px; color:red">*</span>:</label>
           <input type="text" class="form-control" name="NGNTCURR" id="NGNTCURR" value="1" onKeyPress="return isNumber(event)" />
            <span class="glyphicon glyphicon-cash form-control-feedback"></span>
          </div>
        
            <div class="form-group col-md-3">
                          <label>Revenue/Cost Center <span style="font-weight:800; font-size:14px; color:red">*</span>:</label>
          ...
          <input type="hidden" id="payerDECV" name="payerDECV" />
              ...
              <!-- Transaction Table collapsed-box -->
         
                <div class="col-md-12">
              <div class="box box-warning ">
                <div class="box-header with-border">
                  <center><h4> Crediting GL </h4></center> 
                   <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                ...
                <div class="box-body">
                 ...
                 <div class="row">
                    <div class="col-md-12" style="background-color: #FFFFB7">
                        ...
                        <div class="form-group col-md-2">
                          ...
                          <button type="button" class="btn btn-warning form-control" onclick="addLI()"> Add Item </button>
                        </div>
                       
                        <div class="form-group col-md-4">
                         <label style="color:#FFF"> .....</label>
                          <button type="button" class="btn btn-primary form-control" onclick="addLIVEN()"> Add Item From Customer's Invoice </button>
                        </div>
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <center><h4> Debiting GL </h4></center> 
                   <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    ...
                    <div class="col-md-12" style="background-color: #FFFFB7">
                        ...
                        <div class="form-group col-md-4">
                         <label>Debiting GL Account: </label>
                          <select class="select2 form-control" style="width: 100%" id="DBGLV" name="DBGL" required ><option value=""> --- </option><?php echo $GLOptV; ?></select>
                        </div> 
                        ...
                        <div class="form-group col-md-4">
                         <label style="color:#FFF"> .....</label>
                           <button type="button" class="btn btn-primary form-control" onclick="addLIVENV()"> Add Item From Invoice To Customer </button>
                        </div>
              ...
              <div class="box box-success">
                ...
                <div class="box-body">
                     ...
                     <tr><th>Description</th><th>GL Impacting</th><th>Debit </th><th>Credit</th></tr> 
                      ...
                      <td id="payerDEC">-</td>
                      <td id="payerGL">-</td>
                      <td id="rDDebit" class="pCredit">0.00</td>
  ...
  <script src="../mBOOT/jquery-ui.js"></script>
    ...
    <script type="text/javascript">
      $(function () {
        $("#userTab").dataTable();
        var LastEntryDate = '<?php echo $LastEntryDate; ?>'; 
          $(".datep").datepicker({dateFormat : 'yy/mm/dd', minDate: LastEntryDate});
      });
    </script>
 ...
 <script>
        ...
        var UOMOpt = '<?php echo $UOMOpt; ?>';
          var size='standart';
                  var content = '<form role="form" enctype="multipart/form-data" ><div class="form-group">' +
                   ...
                   '<div class="form-group col-md-12" ><label>Item Description: </label><textarea class="form-control" id="INVItemDesc"  name="ItemDesc" required ></textarea></div>' +

                    '<div class="form-group col-md-6"><label>Item Unit: </label><select class="form-control"  name="ItemUnit" id="nItemUnit" >'+UOMOpt+'</select></div>' +
                   ...
                   '<button type="button" onclick="addCDINV()" class="btn btn-success pull-right">Add Item</button><br/></form>';
    ...
    <script type="text/javascript">
      function addLIVEN()
      {
        ...
        //if(CusID == "") { alert("Kindly select Customer. Thanks"); return false; }
        
        
         var CusInv = $('#CusInv').val();
        if(CusInv == "") { alert("Kindly select Invoice Number. Thanks"); return false; }
        ...
        if(TCurr == "") { alert("Kindly select Currency. Thanks"); return false; }
           ...
           var TAMT = $('#TAMT').val();
        if(TAMT == "") { alert("Kindly enter amount receiving. Thanks"); return false; }
        ...
        var DBGL = $('#DBGL').val(); //589;// 
        var DBGLt = $('#DBGL :selected').text();//"[1211001] TRADE DEBTORS";//
        ...
        /////////////////////////////////////////////////////////////
         ...
         var size='standart';
                  var content = '<div class="row" style="background:#EEE6E6; border-radius:5px;" > <div class="col-md-12"><form role="form" ><div class="form-group">' +
                   ...
                   /* '<div class="form-group col-md-6"><label>Select Posted ENL Invoice: </label><select class="form-control" onchange="setInvItems(this)" id="VenInv" name="VenInv" required ><option value=""> --- </option>'
                    +'</select></div>' +
                    */

                    '<div class="form-group col-md-12"><label>Select Invoice Item: </label><select class="form-control" onchange="getINVItemInfo()"  name="INVItem" id="INVItem" ></select></div>' +
    ...
    <script type="text/javascript">
     ...
     function setDescription()
     {
        ...
        $('#payerDEC').html("GL/Bank to be Debited");
      ...
      function addBDINV()
     {
         ...
         var DBGL = $('#DBGL').val();
         var DBGLt = $('#DBGL :selected').text();
         // var DBGL = 589;// $('#DBGL').val();
        //var DBGLt = "[1211001] TRADE DEBTORS";//$('#DBGL :selected').text();
        //alert(DBGLt);
         var DBNUM = $('#DBNUM').val();
         //////////////////////////////////////////////////////////////////////////
        var BANKGL = $('#BANKGL').val();
        ...
        ////////////////////////////////////////////////////////////
        var CusID = $('#CusID').val(); //if(CusID == "") { alert("Kindly select Customer"); return false; }
         ...
         // { alert('Credit Amount must balance on table'); return false; }
          ...
          var TRow =   '<tr>'+
                    ...
                    CHSItemDesc+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="DrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+CHSTotalPrice+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+CHRNum+'@&@'+CHSItem+'@&@VENDINV@&@'+CusID+'@&@'+mItem+'@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
        ...
        //alert("Debit Test");
          ...
          var TRow =   '<tr>'+
                    ...
                    CHSItemDesc+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="CrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+CHSTotalPrice+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+CHRNum+'@&@'+CHSItem+'@&@VENDINV@&@'+CHRID+'@&@'+mItem+'@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
      ...
      function addBDCHS()
     {
        ...
        ////////////////////////////////////////////////////////////
        var CHRID = $('#CusID').val(); if(CHRID == "") { alert("Kindly select Cash Request Code"); return false; }
       
        var CHRNum = $('#CusInv').val(); if(CHRNum == "") { alert("Kindly select Cash Request Code"); return false; }
         ...
         if(Number(FBALDiff) < Number(CHSTotalPrice) )
          ...
          var TRow =   '<tr>'+
                    ...
                    CHSItemDesc+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="DrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+CHSTotalPrice+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+CHRNum+'@&@'+CHSItem+'@&@CASHR@&@'+CHRID+'@&@0@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
        ...
        var CHSTotalPrice = $('#nTotalPrice').val(); if(CHSTotalPrice == "") { alert("Kindly enter Cash Amount"); return false; }
          ...
          */
          ...
          var TRow =   '<tr>'+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="DrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+DBNUM+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+CHRNum+'@&@'+CHRItem+'@&@JITEM@&@'+CHRID+'@&@0@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
