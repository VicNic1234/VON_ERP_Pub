            ...
            if ($NoRowChartMaster > 0) {
              while ($row = mysql_fetch_array($resultChartMaster)) {
               ...
               $CusIDM = getCustomer($row['VendorID']);
                ...
                $DelBtn = '&nbsp; <a href="viewacctentries?ACCTID='.$mid2.'"><span title="View Full Entry" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></span></a>';
               
                //$UpdBtn = '<span onclick="updateVAL('.$TNCID.')" title="Update Posting" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></span>';
                }
                if($ChqNoM != "")
                {
         ...
         function updateVAL(tnic)
         {
            ...
            success: function(html)
            {
                  ...
                  var content = '<div class="row" style="background:#EEE6E6; border-radius:5px;" > <div class="col-md-12"><form role="form" action="updatepost" method="post" ><div class="form-group">' +
                    ...
                    '<div class="form-group col-md-12"><label>Select GL Account: </label><select class="form-control"  name="PostGL" id="PostGL" disabled >'+GLOpt+'</select></div>' +
