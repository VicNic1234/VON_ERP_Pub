...
$MYID = $_SESSION['uid'];
//Business Year
$BYr = "2022";//$_SESSION['AcctBusinessYear'];
if($BYr == "")
{
...
?>
  <form id="postPetty" action="postRecipt" method="POST">
          <div class="row">
            ...
            <div class="form-group col-md-6">
                        ...
                        <script>
                            ...
                            {
                                var CusID = $('#CusID').val();
                                var vwCusID = $("#CusID option:selected").text();
          ...
          <div class="form-group has-feedback col-md-6" >
                ...
                <select class="select2 form-control" id="BANKGL" name="BANKGL" onChange="setDescription(); loadChk(this);" required>
         ...
         $.ajax({
          ...
          <input type="hidden" id="payerDECV" name="payerDECV" />
                      ...
                      <div class="col-md-6" style="background-color: #FFFFB7">
                        <br/>
                         <div class="form-group col-md-8">
                           ...
                           <button type="button" class="btn btn-primary form-control" onclick="addLIVEN()"> Add Item From Invoice To Customer </button>
                        </div>
              ...
              <div class="box box-warning collapsed-box">
                <div class="box-header with-border">
                  <center><h4> WHT AND TAXS </h4></center> 
                   <div class="box-tools pull-right">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12" style="background-color: #FFFFB7">
                        ...
                        <!-- <div class="form-group col-md-6">
                          <label>Select Customer: </label>
                          <select class="srcselect3 form-control" style="width: 100%" id="VENDV" name="VEND" required ><option value=""> --- </option><?php echo $SupOpt; ?></select>
                        </div> -->
                    
                        
                        <!--<div class="form-group col-md-4">
                          <button type="button" class="btn btn-warning" onclick="addLIV()"> Add Item </button>
                        </div>-->
        ...
        var CHSTotalPrice = $('#INVTotalPrice').val(); if(CHSTotalPrice == "") { alert("Kindly enter Invoice Item Amount"); return false; }
         ...
         // { alert('Credit Amount must balance on table'); return false; }
          ...
          var TRow =   '<tr>'+
                     '<td class="receiveDEC">'+
                    CHSItemDesc+
                     '<br/> <em style="color:green; font-size:11px">' +vwCusID+ '</em></td>'+
