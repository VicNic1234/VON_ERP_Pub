      ...
      if ($NoRowType > 0) {
        while ($row = mysql_fetch_array($ChartTypeQ)) {
          ...
          $resultChartMaster = mysql_query("SELECT *, postings1.ChqNo As ChqNoM FROM postings1
             ...
             WHERE acc_chart_master.account_type = $tid AND 
             (RptType='Opening Balance') AND postings1.isActive=1
                ...
                <div class="box-header with-border">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="allopenbal1" method="POST" ><div class="form-group">
