      ...
      if ($NoRowType > 0) {
        while ($row = mysql_fetch_array($ChartTypeQ)) {
          ...
          $tname = $row['name'];
           if($SelectSRC == 1 && in_array($cid, $TIDn, true))
          {
          $RecChartMaster .= '<tr><td>-</td><td><em><b>'.$tname.'</b></em></td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td>
          <td>-</td></tr>';
          }
          
          //Let's Read ChartMaster
           $ChartMasterQ = mysql_query("SELECT * FROM acc_chart_master Where account_type='$tid' ORDER BY account_name");
      $NoRowMaster = mysql_num_rows($ChartMasterQ);
      if ($NoRowMaster > 0) {
        while ($row = mysql_fetch_array($ChartMasterQ)) {
            $mid = $row{'mid'};
            ...
            $HaveRec = 0;
            //*******************************************************
            //AND postings.TransactionAmount > 0
            $resultChartMaster = mysql_query("SELECT *, postings.ChqNo As ChqNoM FROM postings
             ...
             WHERE postings.GLImpacted = '$mid' AND postings.isActive=1 
            ...
            if ($NoRowChartMaster > 0) {
              ...
              while ($row = mysql_fetch_array($resultChartMaster)) {
                ...
                $TDate = $row['TransactionDate']; //ClassName
                $TD = DateTime::createFromFormat('Y/m/d', $TDate)->format('Y/m/d');
        ...
        if($SelectSRC == 1 && in_array($cid, $TIDn, true))
          {
            ...
            if($FromD == "")
            {
                 if($TT =="CREDIT") { $TTCR += $TAmount; $MTCR += $TAmount; } 
                if($TT =="DEBIT") { $TTDR += $TAmount; $MTDR += $TAmount; } 
                 $HaveRec = 1;
               // $RecChartMaster .= '<tr><td><b>'.$AccTClass.'</b></td><td><em><b>'.$tname.'</b></em></td><td>'.$acid.'</td><td><a href="viewacct?TID='.$cid.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td>'.$TD.'</td><td><a href="viewacct?ACCTID='.$mid2.'"><i class="fa fa-eye text-green"></i></a> '.$mid3.'</td><td>'.$TDescr.'</td><td>'.number_format($DRD, 2).'</td><td>'.number_format($CRD, 2).'</td>
               //<td>'.number_format($TTDR - $TTCR, 2).'</td></tr>';
                $RecChartMaster .= '<tr><td><b>'.$AccTClass.'</b></td><td><em><b>'.$tname.'</b></em></td><td>'.$acid.'</td><td><a href="viewacct?TID='.$cid.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td>'.$TD.'</td><td><a href="viewacct?ACCTID='.$mid2.'"><i class="fa fa-eye text-green"></i></a> '.$mid3.'</td><td>'.$TDescr.'</td><td>'.number_format($DRD, 2).'</td><td>'.number_format($CRD, 2).'</td>
                <td>'.number_format($MTDR - $MTCR, 2).'</td></tr>';
            }
            else
            {
       ...
       // 
        // $RecChartMaster .= '<tr><td>-</td><td>-</td><td>-</td><td>-</td><td>'.$TD.'</td><td>-</td><td>-</td><td>-</td><td>-</td>
         //           <td>'.number_format($DIFFDRD, 2).'</td></tr>';
            ...
            if( $HaveRec == 1){
                $DIFFDRD = $MTCR - $MTDR;
           $RecChartMaster .= '<tr><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td>
                    <td style="border-top: double; color:green">'.number_format($DIFFDRD, 2).'</td></tr>';
            }
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Accounts - GL Yearly Report
            <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href=""><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">GL Yearly Report</li>
          </ol>
        </section>
           ...
           <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">GL Yearly Report</h3>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="rptGLY" method="POST" ><div class="form-group">
              ...
              <div class="box">
                ...
                <div class="box-body">
                   ...
                   <table id="userTab" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <th colspan="11"><center style="font-size:1.5em">GL Report</center></th>
                      </tr>
                      <tr>
