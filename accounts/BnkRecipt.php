...
$resultCustomers = mysql_query("SELECT * FROM customers ORDER BY CustormerNme");
  ...
  $resultInvoiceNum = mysql_query("SELECT * FROM salesinvoice WHERE Status=2  "); //WHERE cusid = '$CusID'
      ...
      <div class="form-group has-feedback col-md-12">
       <table class="table table-striped" >
        <thead style="background:#009900; color:#FFF">
          <tr><th>Invoice Number </th><th>Invoice Date </th><th>Term Day </th><th>Currency </th><th>NGN C. Rate </th></tr>
        </thead>
        <tbody id="CusInvss">
