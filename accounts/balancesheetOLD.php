...
////////////////////NON CURRENT ASSSTE
    $RecChartMaster .= '<tr><td><b>ASSETS</b></td><td>-</td><td>&nbsp;</td></tr>';
...
if ($NoRowClass > 0) {
  while ($row = mysql_fetch_array($ChartClassQ)) {
    ...
    if($DisAmt != 0 && $EXZ == 1)
    {
        ...
        $RecChartMaster .= '<tr><td><a href="viewacct?TID='.$cid.'" target="_blank"><i class="fa fa-eye"></i></a> <em>'.$AccTClass.'</em></td><td>-</td><td>'. number_format($DisAmt).'</td></tr>';
    }
    else if ( $EXZ == 0)
     {
 ...
 $RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>Total Current Assets</td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($T1).'</td></tr>';
...
if ($NoRowClass > 0) {
  ...
  $RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>Total Fixed Assets</td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($T9).'</td></tr>';
//////////////////////////////////////////
//////////////////////////////////////
$T2 = 0.0;
...
if ($NoRowClass > 0) {
  ...
  $RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>Total Non-current Assets</td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($T2).'</td></tr>';
//////////////////////////////////////////
//////////////////////////////////////
$T12 = 0.0;
...
if ($NoRowClass > 0) {
  ...
  $RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>Total Other Assets</td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($T12).'</td></tr>';
//////////////////////////////////////////
$T11 = 0.0;
...
if ($NoRowClass > 0) {
  ...
  $RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>Total Accumulated Depreciation</td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($T11).'</td></tr>';
...
$TOTALASSETS =  floatval($T1) + floatval($T9) + floatval($T12) + floatval($T2) + floatval($T11); //+ floatval($NETINCOME);
    ...
    $RecChartMaster .= '<tr style="border-bottom: 2px solid #000"><td><b>TOTAL NET ASSETS</b></td><td>-</td><td><b>'.number_format($TOTALASSETS, 2).'</b></td></tr>';
...
/////////////////////////////
    ////////////////////
    $RecChartMaster .= '<tr><td><b>EQUITY AND LIABILITY</b></td><td>-</td><td>&nbsp;</td></tr>';
$T10 = 0.0;
...
if ($NoRowClass > 0) {
  ...
  ///SUB TOTAL
   ...
   $RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>Total Equity</td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($T10) .'</td></tr>';
...
if ($NoRowClass > 0) {
  ...
  $RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>Total Non-current Liabilities</td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($T4).'</td></tr>';
  /////////////////Current Liabilities
...
if ($NoRowClass > 0) {
  ...
  $RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>Total Current Liabilities</td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($T3).'</td></tr>';
//$RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>INCOME </td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($INCOMEBAL,2).'</td></tr>';
//$RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>EXPENSES </td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($EXPBAL,2).'</td></tr>';
$RecChartMaster .= '<tr style="border-top: 2px solid #000"><td>NET INCOME  </td><td>-</td><td style="border-top: 2px solid #000; border-bottom: 2px solid #000;">'. number_format($NETINCOME,2).'</td></tr>';

$TOTALLIABILITY = floatval($T10) + floatval($T4) + floatval($T3) + floatval($NETINCOME);

    $RecChartMaster .= '<tr style="border-bottom: 2px solid #000"><td><b>TOTAL LIABILITIES & EQUITY</b></td><td>-</td><td><b>'.number_format($TOTALLIABILITY, 2).'</b></td></tr>';
                ...
                <div class="box-body">
                   <table id="userTab" class="table table-bordered table-striped">
                     <thead>
                      ...
                      <tr>
                        <th colspan="3"><center style="font-size:1.5em">Balance Sheet</center></th>
                      </tr>
                      <tr>
