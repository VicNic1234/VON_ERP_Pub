...
<?php
 ...
 $resultLI = mysql_query("SELECT *, COUNT(*) As ItemNum,
  SUM(poitems.unitprice * poitems.qty) As TotalMain,
 ...
 LEFT JOIN pomiscellaneous ON purchaseorders.cid = pomiscellaneous.PONo
  WHERE poitems.isActive=1 GROUP BY PONUM ORDER BY purchaseorders.cid
