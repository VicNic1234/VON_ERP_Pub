   ...
   //Let's Read ChartType
      ...
      if ($NoRowType > 0) {
        while ($row = mysql_fetch_array($ChartTypeQ)) {
          ...
          //////////////////////////////////////////////////////////////////////////
          $resultChartMaster = mysql_query("SELECT *, postings1.ChqNo As ChqNoM FROM postings1
             LEFT JOIN acc_chart_master ON postings1.GLImpacted = acc_chart_master.mid
             LEFT JOIN cheuqes ON postings1.ChqNo = cheuqes.chid
             WHERE acc_chart_master.account_type = $tid AND postings1.isActive=1
                ...
                <div class="box-header with-border">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="rptGLY1" method="POST" ><div class="form-group">
              ...
              <div class="box">
                ...
                <div class="box-body">
                   ...
                   <table id="userTab" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <th colspan="10"><center style="font-size:1.5em">GL Report</center></th>
                      </tr>
                      <tr>
