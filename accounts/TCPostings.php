...
$SuperDebit = 0.0;
  ...
  // acc_chart_master.account_type = $tid &&
          $resultChartMaster = mysql_query("SELECT *, postings.ChqNo As ChqNoM, postings.tncid As TNCID FROM postings
             ...
             WHERE postings.GLImpacted = '$TID' && postings.isActive=1
             AND (VendorID = '' )
                ...
                <div class="box-header with-border">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="TDPostings" method="GET" >
