...
if ($NoRowClass > 0) {
  ...
  $RecChartMaster .= '<tr><td>-</td><td>-</td><td style="border-top: double;  border-bottom: double ">'.number_format($SuperDebitA,2).'</td><td style="border-top: double; border-bottom: double ">'.number_format($SuperCreditA,2).'</td>
