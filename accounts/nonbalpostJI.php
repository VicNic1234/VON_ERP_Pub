            ...
            if ($NoRowChartMaster > 0) {
              while ($row = mysql_fetch_array($resultChartMaster)) {
                ...
                $mid = $row['tncid'];
                 ...
                 if (in_array($mid2, $TNCIDqueArray)) 
                 {
                 ...
                 array_push($TNCIDqueArray, $mid2);
                 //echo ChkIfBal($mid2) . " " . $mid2 ." </br>";
                 
                if($mid2 == 0) { $mid2 = $mid; }
                $mid3 = str_pad($mid2,6,"0",STR_PAD_LEFT);
                //Here we need to check if trans bal
                if(ChkIfBal($mid2) > 0.01) {
                $ChqNoM = $row['ChqNoM'];
    ...
    $resultChartMaster = mysql_query("SELECT *, postings.tncid As TNID  FROM postings
            ...
            if ($NoRowChartMaster > 0) {
              while ($row = mysql_fetch_array($resultChartMaster)) {
                ...
                if($TT =="CREDIT")  { $DRD = $TAmount; $TDRD = $TDRD + floatval($TAmount); $CHKBAL = $CHKBAL + $DRD; } else { $DRD = ''; }
                if($TT =="DEBIT") { $CRD = $TAmount; $TCRD = $TCRD + floatval($TAmount); $CHKBAL = $CHKBAL - $CRD; } else { $CRD = ''; }
                //$isActive = $row['MsIsActive'];
            /*   if($FromD == "")
            {
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Non-Balance Postings</li>
          </ol>
        </section>
                ...
                <div class="box-header with-border">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="nonbalpost" method="POST" ><div class="form-group">
