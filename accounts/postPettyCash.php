  ...
  else
  {
      ...
      for($i=0; $i < $N; $i++)
    {
      ...
      if($POSTType == "VENDINV")
      {
        ...
        $query1 = "INSERT INTO postings (VINVOICE, REQCODE, CHRID, ItemQty, BankAccount, ChqNo, ReceivedBy, GLImpacted, GLDescription, TransactionAmount, 
         TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, Currency, CRCenter, CounterTrans, VendorID, NGNTCURR, mItem, mJob) VALUES ('$CHRNum','$INVNUM', '$CHSItem', '$CHSItemQty', '$BANKGL','$ChqNo','$RECEIVER','$GLID','$GLDes','$GLAmt', 'DEBIT', '$trandate', '$CHSItemDesc', '$uid', '$TodayD', 'Imprest', '$TCurr', '$BusUnit',  '$RECCODE', '$VendCode', '$NGNTCURR', '$mItem', '$mJob');";
      ...
      else
      {
        $query1 = "INSERT INTO postings (REQCODE, CHRID, ItemQty, BankAccount, ChqNo, ReceivedBy, GLImpacted, GLDescription, TransactionAmount, 
         TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, Currency, CRCenter, CounterTrans, NGNTCURR, mItem, mJob) VALUES ('$CHRNum', '$CHSItem', '$CHSItemQty', '$BANKGL','$ChqNo','$RECEIVER','$GLID','$GLDes','$GLAmt', 'DEBIT', '$trandate', '$CHSItemDesc', '$uid', '$TodayD', 'Imprest', '$TCurr', '$BusUnit',  '$RECCODE', '$NGNTCURR', '$mItem', '$mJob');";
      ...
      for($i=0; $i < $N; $i++)
    {
      ...
      if($POSTType == "VENDINV")
      {
        ...
        $query1 = "INSERT INTO postings (VINVOICE, REQCODE, CHRID, ItemQty, BankAccount, ChqNo, ReceivedBy, GLImpacted, GLDescription, TransactionAmount, 
         TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, Currency, CRCenter, CounterTrans, VendorID, NGNTCURR, mItem, mJob) VALUES ('$CHRNum','$INVNUM', '$CHSItem', '$CHSItemQty', '$BANKGL','$ChqNo','$RECEIVER','$GLID','$GLDes','$GLAmt', 'CREDIT', '$trandate', '$CHSItemDesc', '$uid', '$TodayD', 'Imprest', '$TCurr', '$BusUnit',  '$RECCODE', '$VendCode', '$NGNTCURR', '$mItem', '$mJob');";
      ...
      {
        $query1 = "INSERT INTO postings (REQCODE, CHRID, ItemQty, BankAccount, ChqNo, ReceivedBy, GLImpacted, GLDescription, TransactionAmount, 
         TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, Currency, CRCenter, CounterTrans, NGNTCURR, mItem, mJob) VALUES ('$CHRNum', '$CHSItem', '$CHSItemQty', '$BANKGL','$ChqNo','$RECEIVER','$GLID','$GLDes','$GLAmt', 'CREDIT', '$trandate', '$CHSItemDesc', '$uid', '$TodayD', 'Imprest', '$TCurr', '$BusUnit',  '$RECCODE', '$NGNTCURR', '$mItem', '$mJob');";
...
*/   
   ...
   /*mysql_query("UPDATE cashreq SET Approved='17', LastActor='Account Officer', Status='Cash Paid Out', PostedBy='".$uid."', ApprovedBy='".$staffname."', PostedOn='".$TodayD."', PostID='".$RECCODE."' WHERE reqid = '$REQCODE'");*/
