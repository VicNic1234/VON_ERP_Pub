...
if(count($DrDesc) < 1) 
  ...
  else
  {
    ...
    $query = "INSERT INTO postings (REQCODE, BankAccount, ChqNo, ReceivedBy, GLImpacted, GLDescription, TransactionAmount, PostedAmount, 
         TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, CRCenter, CounterTrans, Currency, NGNTCURR, CusID, ENLINVOICE) VALUES ('','$BANKGL','$ChqNo','$RECEIVER','$CRDGLIDacctid','$payerDECV','$TAMT','$OLDTAMT', 'DEBIT', '$trandate', 'Bank to be Debited', '$uid', '$TodayD', 'Recivable', '$BusUnit', '0', '$TCurr', '$NGNTCURR', '$CusID', '$CusInv' );";
      ...
      for($i=0; $i < $N; $i++)
    {
      ...
      {
        $query1 = "INSERT INTO postings (ENLINVOICE, REQCODE, CHRID, ItemQty, BankAccount, ChqNo, ReceivedBy, GLImpacted, GLDescription, TransactionAmount, PostedAmount,
         TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, Currency, CRCenter, CounterTrans, NGNTCURR, mItem, mJob) VALUES ('$CHRNum', '$CHRNum', '$CHSItem', '$CHSItemQty', '$BANKGL','$ChqNo','$RECEIVER','$GLID','$GLDes','$GLAmt', '$OLDGLAmt', 'CREDIT', '$trandate', '$CHSItemDesc', '$uid', '$TodayD', 'Recivable', '$TCurr', '$BusUnit',  '$LastTranID1', '$NGNTCURR', '$ItemType', '$mJob');";
        ...
        if(count($CrDesc) > 0) 
          {
              ...
              for($i=0; $i < $N; $i++)
            {
              ...
              if($POSTType == "VENDINV")
              {
                ...
                $query1 = "INSERT INTO postings (ENLINVOICE, REQCODE, CHRID, ItemQty, BankAccount, ChqNo, ReceivedBy, GLImpacted, GLDescription, TransactionAmount, PostedAmount,
                 TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, Currency, CRCenter, CounterTrans, CusID, NGNTCURR, mItem, mJob) VALUES ('$CHRNum','$INVNUM', '$CHSItem', '$CHSItemQty', '$BANKGL','$ChqNo','$RECEIVER','$GLID','$GLDes','$GLAmt', '$OLDGLAmt', 'DEBIT', '$trandate', '$CHSItemDesc', '$uid', '$TodayD', 'Recivable', '$TCurr', '$BusUnit',  '$LastTranID1', '$CusSource', '$NGNTCURR', '$ItemType', '$mJob');";
              ...
              {
                $query1 = "INSERT INTO postings (ENLINVOICE, REQCODE, CHRID, ItemQty, BankAccount, ChqNo, ReceivedBy, GLImpacted, GLDescription, TransactionAmount, PostedAmount,
                 TransacType, TransactionDate, Remark, PostedBy, PostedOn, RptType, Currency, CRCenter, CounterTrans, NGNTCURR, mItem, mJob) VALUES ('$CHRNum','$CHRNum', '$CHSItem', '$CHSItemQty', '$BANKGL','$ChqNo','$RECEIVER','$GLID','$GLDes','$GLAmt','$OLDGLAmt', 'DEBIT', '$trandate', '$CHSItemDesc', '$uid', '$TodayD', 'Recivable', '$TCurr', '$BusUnit',  '$LastTranID1', '$NGNTCURR', '$ItemType', '$mJob');";
