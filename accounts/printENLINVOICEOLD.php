...
<div id="PrintArea">
          <div class="row">
            <div class="col-xs-12">
			  ...
			  <img src="../mBOOT/plant.png" width="70px" height="70px" alt="ENL logo"/>
         ...
         <!-- <small class="pull-right"><?php echo $IVNo; ?></small>-->
          <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col" style="font-size:0.8em">
              <b>Invoice Date:</b><br/> <?php echo $IVDate;?><br/>
              <b>Vendor Code: </b><br/> <?php echo $VenCode; ?><br/>
              <b>Service Entry No.:</b><br/> <?php echo $ServicENum;?><br/>
              <b>Invoice No.:</b><br/> <?php echo $IVNo;?><br/>
              <b>VAT No.:</b><br/> PHV. 05002158837<br/>
              <b>TIN:</b><br/> 00482825-0001<br/>
              <br/>
         ...
         <center>
          ...
          <div class="row">
            <div class="col-xs-12 table-responsive">
              <table class="table table-striped" style="border: 2px solid black; font-size:0.9em">
                 <tbody>
                      <tr>
          ...
          <div class="row">
            ...
            <div class="col-md-12"><b>AMOUNT IN WORDS : </b> <em><?php echo strtoupper(numberTowords($MainTotal)). " ".strtoupper($CurrNme); ?></em></div> 
            
          </div>
          <br/>
          <div class="col-md-12" style="width:90% !important">
          <div class="col-sm-4 invoice-col" style="font-size:0.9em">
             <address>
              <div class="col-md-12"><b>Please make payment in favour of: </b> <br/>
          ...
          <div class="row invoice-info" style="font-size:0.9em">
            <div class="col-md-12">
            <div class="col-sm-4 invoice-col">
              <address>
                ...
                <b style="color:#888888">FINANCE & ACCOUNTS MANAGER </b><br>
              </address>
            </div><!-- /.col -->
            <div class="col-sm-4 invoice-col">
             <strong> &nbsp; </strong>
            ...
            <div class="col-sm-4 invoice-col">
              ...
              <!--  <b style="color:#888888">GGM/FINANCE & ACCOUNTS</b><br> -->
                 <b style="color:#888888">GENERAL MANAGER, FINANCE & ACCOUNTS</b><br>
              </address>
            </div><!-- /.col -->
          </div>
          </div><!-- /.row -->
          ...
          <br/><br/>
              <div class="row invoice-info" style="font-size:0.9em; border: 2px solid #FF9900; border-radius: 15px; padding-top: 5px; margin: 5px">
