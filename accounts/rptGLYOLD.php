      ...
      if ($NoRowType > 0) {
        while ($row = mysql_fetch_array($ChartTypeQ)) {
          ...
          $resultChartMaster = mysql_query("SELECT *, postings.ChqNo As ChqNoM FROM postings
            ...
            {
                //$RecChartMaster .= '<tr><td>-</td><td>-</td><td>'.$acid.'</td><td><a href="viewacct?TID='.$cid.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td>'.$TD.'</td><td><a href="viewacct?ACCTID='.$mid2.'"><i class="fa fa-eye text-green"></i></a> '.$mid3.'</td><td>'.$TDescr.'</td><td>'.$DRD.'</td><td>'.$CRD.'</td>
                //<td>-</td></tr>';
                 /*//We need to get the opening Balance
                 if ($FromD > $TD)
                 {
                 // $RecChartMasterOB .= '<tr><td>-</td><td>-</td><td>'.$acid.'</td><td><a href="viewacct?TID='.$cid.'"><i class="fa fa-eye"></i></a> '.$name.'</td><td>'.$TD.'</td><td><a href="viewacct?ACCTID='.$mid2.'"><i class="fa fa-eye text-green"></i></a> '.$mid3.'</td><td>'.$TDescr.'</td><td>'.$DRD.'</td><td>'.$CRD.'</td>
                    //<td>-</td></tr>';
                ...
                <div class="box-header with-border">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action="rptGLYOLD" method="POST" ><div class="form-group">
