...
'<div class="alert alert-info alert-dismissable">' .
									...
									$_SESSION['ErrMsgB'] = "";}
?>
  <form id="postPetty" action="postPetty" method="POST">
          <div class="row">
            <div class="col-md-12">
         ...
         <script type="text/javascript">
          ...
          <input type="hidden" id="payerDECV" name="payerDECV" />
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <center><h4> CASH REQUITIONS AND OTHER PAYMENTS </h4></center> 
                   <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-6" style="background-color: #FFFFB7">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select class="srcselect3 form-control" style="width: 100%" id="mJob" name="mJob" ><option value=""> --- </option>
                          <?php echo $JobOpt; ?>
                          </select>
                        </div> 
                         <div class="form-group has-feedback col-md-6">
                          <label>Equipment:</label>
                          <select class="form-control srcselect3" id="EquipC" name="EquipC"  >
                          <option value="">-- </option>
                          <?php echo $EquipOpt; ?>
                          </select>
                        </div>
                    ...
                    <div class="col-md-12" style="background-color: #FFFFB7">
                        ...
                        <div class="form-group col-md-4">
                         <label>Crediting GL Account: </label>
                          <select class="srcselect3 form-control" style="width: 100%" id="DBGLV" name="DBGLV" required ><option value=""> --- </option><?php echo $GLOptV; ?></select>
                        </div> 
                        <!-- <div class="form-group col-md-6">
         ...
         // { alert('Debit Amount must balance on table'); return false; }
          ...
          var TRow =   '<tr>'+
                    ...
                    CHSItemDesc+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="DrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+CHSTotalPrice+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+CHRNum+'@&@'+CHSItem+'@&@CASHR@&@'+CHRID+'@&@'+mItem+'@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
        ...
        var CHSTotalPrice = $('#nTotalPrice').val(); if(CHSTotalPrice == "") { alert("Kindly enter Cash Amount"); return false; }
         ...
         // { alert('Debit Amount must balance on table'); return false; }
          ...
          var TRow =   '<tr>'+
                     ...
                     '<td class="receiveGL">'+
                      '<input type="hidden" name="CrDesc[]" value="'+DBGLt+'@&@'+DBGL+'@&@'+DBNUM+'@&@'+BusUnit+'@&@'+EquipC+'@&@'+CHSItemDesc+'@&@'+CHSUnitQty+'@&@'+CHRNum+'@&@'+CHRItem+'@&@JITEM@&@'+CHRID+'@&@'+mItem+'@&@'+mJob+'" />'+
                     DBGLt+
                     '</td>'+
