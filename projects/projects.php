...
<?php
 ...
 $resultLI = mysql_query("SELECT * FROM project 
...
//fetch tha data from the database
	 if ($NoRowLI > 0) 
   {
    ...
    if($FileLink != ""){
    $FileLinkn = '<a target="_blank" title="Download Project document" href="'.$FileLink.'"><i class="fa fa-link"></i></a>';
    }
    else
    {
      $FileLinkn = '';
    ...
    $ViewCon = '<a title="View full Project" href="viewproj?cnid='.$cid.'"><i class="fa fa-eye"></i></a>';
