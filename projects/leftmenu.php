          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li><a href="viewPO"><i class="fa fa-xing text-aqua"></i>
                ...
                <li><a href="newproj"><i class="fa fa-cog text-aqua"></i>
                   <span>New Project</span> <small class="label pull-right bg-green">On</small></a></li>

                <li><a href="projects"><i class="fa fa-cogs text-yellow"></i>
                   <span>Projects</span> <small class="label pull-right bg-green">On</small></a></li>
