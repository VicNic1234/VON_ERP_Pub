...
if ($NoRowContracts > 0) {
  while ($row = mysql_fetch_array($resultContracts)) 
  {
    ...
    $ConTNO = $row['ContractNo'];
     ...
     $ContractOpt .= '<option value="'.$cid.'">'.$ConTNO.'</option>';
...
?>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-8" style="background-color:#00C888; border-radius: 15px; padding-top:22px;">
                     ...
                     <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="regProj" method="post">
          <div class="form-group has-feedback col-md-12" >
                <label>Choose Main Customer/Client:</label>
       ...
       function setRFQNo(elem)
       {
         ...
         var RFQNum = "ENL/"+CusSplit[1]+"/PROJ/"+ year + "/" + month + "/"+RFQCount;
         $('#ProjNo').val(RFQNum);
		 ...
		 <div class="form-group has-feedback col-md-12">
		   <textarea rows="4" cols="50" placeholder=" Enter comment here..." id="Comment" name="Comment" style="width:100%; display: inline-block;"></textarea>
            ...
            <input type="text" class="form-control" readonly value="ENL/CUS/PROJ/<?php echo Date('y/m') ; ?>/<?php echo $CONTRNO; ?>" id="ProjNo" name="ProjNo" placeholder="ENL/C&P/PROJ/002"  required />
...
<br/>
      ...
      <div class="form-group has-feedback">
        ...
        <br/>
			...
			<p class="text-center">
                        <strong>Project Document (Optional)</strong>
                      </p>
			<div class="form-group has-feedback">
