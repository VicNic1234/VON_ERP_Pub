...
*/
 ...
 LEFT JOIN users ON vendorsinvoices.RaisedBy = users.uid
  ...
  WHERE vendorsinvoices.isActive=1  
 "); //WHERE isActive=1 ORDER BY cid //GROUP BY PONUM GROUP BY IVNo / // GROUP BY IVNo //AND  vendorsinvoices.COOAppDate = '' AND vendorsinvoices.MDOfficeOn = ''
