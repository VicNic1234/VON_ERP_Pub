    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <i class="fa fa-money text-green"></i> Cash Request
           <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Cash Request</li>
          </ol>
        </section>
...
<?php
 ...
 LEFT JOIN users ON cashreq.staffID = users.uid where cashreq.isActive=1"); //WHERE isActive=1 ORDER BY cid WHERE poreq.Approved = 11
...
if($Approved == 7)
{
  $Record .='
           <tr>
            ...
            <td>'.$LastTreated.'</td>
            <td>'.$ApprovedOpt.'</td>
            <td><a target="_blank" href="../requisition/cashmdppor?pdfid='.$RequestID.'"><i class="fa fa-eye"></i></a></td>
           '
            ;
}
/*
else
{
  $Record .='
           <tr>
            ...
            <td>'.$Statun.'</td>
            <td>'.$LastTreated.'</td>
            <td>'.$ApprovedOpt.' <a target="_blank" href="../requisition/cashmdppor?pdfid='.$RequestID.'"><i class="fa fa-eye"></i></a></td>
           '
            ;
}
*/
