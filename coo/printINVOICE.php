...
//fetch tha data from the database
  ...
  while ($row = mysql_fetch_array($resultLI)) {
    ...
    $COOAppComment = $row['COOAppComment'];
...
if ($NoRowSDoc > 0) {
  while ($row = mysql_fetch_array($resultSDoc)) 
  {
    ...
    if($addedby == $MYID)
    {
      $delDoc = '<a href="deldoc?id='.$sdid.'" target="_blank" ><i class="fa fa-trash"></i></a>';
    }
    $SupDocs .= '<tr>
                    <td>'.$SN.'</td>
                    <td>'.$title.'</td>
          ...
          <div class="row no-print">
            ...
            <div class="col-md-6">
              <div class="box box-info">
                ...
                <div class="box-body">
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                       ...
                       <a href="<?php echo $FileLink; ?>" target="_blank" ><center><strong>Main Invoice Document</strong></center></a>
                     <?php } ?></td></tr>
                    <?php echo $SupDocs; ?>
                    </tbody>
                  </table>
                ...
                <div class="box-header">
                 GM Co operate Services Comment
                </div><!-- /.box-header -->
                <div class="box-body">
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <form enctype="multipart/form-data"  method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  ...
                                  <textarea class="form-control" required name="DDcomment" rows="5"  disabled="" ><?php echo $GMCSAppComment; ?></textarea> 
                            </div>
                            ...
                            <div class="form-group has-feedback col-md-12" >
                              <?php if($GMCSAppDate == "") { ?>
                                  <label><input type="checkbox" name="DDapprove" disabled=""> &nbsp; &nbsp; Approved</label>
                              <?php } else { ?>
                                <label><input type="checkbox" checked name="DDapprove" disabled> &nbsp; &nbsp; Approved</label>
                              <?php } ?>
                   ...
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <form enctype="multipart/form-data" action="updateCONT" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $cid; ?>">
                                  <textarea class="form-control" required name="DDcomment" disabled="" rows="5" ><?php echo $DDOfficerComment; ?></textarea> 
                            </div>
                    ...
                    <div class="col-md-6">
                 <div class="box box-success" style="background:#cee1ff">
                <div class="box-header">
                 COO's Comment
                </div><!-- /.box-header -->
                <div class="box-body">
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <form enctype="multipart/form-data" action="updateCONTIVMD" id="FRMMD" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $cid; ?>">
                                  <textarea class="form-control" required name="MDcomment" id="MDcomment"  ><?php echo $MDOfficeComment; ?></textarea> 
                            </div>
                            ...
                            <div class="form-group has-feedback col-md-12" >
                                  <label>COO Approved On:</label>
                                <label> <?php echo $MDOfficeOn; ?></label>
                            </div>
                            
                            <input type="hidden" name="MDapprove" id="MDapprove" />
                       ...
                       <div class="col-md-6">
                          <div class="col-xs-12">
                              <button type="button" onclick="appMD();" class="btn btn-success btn-block btn-flat">Approve</button></button>
                            </div>
                      </div>
                      
                      <div class="col-md-6">
                          <div class="col-xs-12">
                              <button type="button" onclick="dpMD();" class="btn btn-danger btn-block btn-flat">Decline</button></button>
                            </div>
                      </div>
                    <script>
                        function appMD()
                        {
                            var MDComment = $('#MDcomment').val(); //alert(MDComment);
                            if(MDComment == "") 
                            { 
                                alert("Kindly enter a comment. Thanks"); return false; 
                        ...
                        function dpMD()
                        {
                            var MDComment = $('#COOcomment').val(); alert(MDComment);
                            if(MDComment == "") { alert("Kindly enter a comment. Thanks"); return false; }
