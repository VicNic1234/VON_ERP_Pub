...
$CONID = $_GET['cnid'];
 ...
 LEFT JOIN divisions ON contracts.conDiv = divisions.divid
...
?>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-8" style="background-color:#00C6C6; border-radius: 15px; padding-top:22px;">
                     ...
                     <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="updateCONT" method="post">
          <div class="form-group has-feedback col-md-12" >
                <label>Vendor:</label>
          		  <input type="text" readonly="" value="<?php echo $SupNme; ?>" class="form-control">  
		  ...
		  <div class="form-group has-feedback col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $conSDate; ?>" name="conSDate" readonly required />
                    </div><!-- /.input group -->
          </div>
         ...
         <div class="form-group has-feedback col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" readonly value="<?php echo $conEDate; ?>" name="conEDate" />
                    </div><!-- /.input group -->
          </div>

          <div class="form-group has-feedback col-md-6">
            <label>Division:</label>
            <input type="text" class="form-control" id="conDiv" name="conDiv" value="<?php echo $DivNME; ?>" readonly="" required >
            <span class="glyphicon glyphicon-download form-control-feedback"></span>
          </div>

          <div class="form-group has-feedback col-md-3">
            <label>Currency:</label>
           <input type="text" value="<?php echo $Currency; ?>" readonly class="form-control" >
          ...
          <div class="form-group has-feedback col-md-3">
           ...
           <input type="text" class="form-control" name="totalSum" value="<?php echo number_format($TotalSum); ?>" onKeyPress="return isNumber(event)" readonly />
            <span class="glyphicon glyphicon-cash form-control-feedback"></span>
          </div>
		 ...
		 <div class="form-group has-feedback col-md-12">
		   <textarea readonly rows="4" cols="50" placeholder=" Enter comment here..." id="Comment" name="Comment" style="width:100%; display: inline-block;" ><?php echo $Comment; ?></textarea>
		 </div>
		 ...
		 <br/>
          ...
          <div class="form-group has-feedback">
           <input type="text" value="<?php echo $PDFNUM; ?>" class="form-control" name="PDFNum" readonly >
            <span class="glyphicon glyphicon-barcode form-control-feedback"></span>
          </div>
<br/>
			<!--<p class="text-center">
                   ...
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <form enctype="multipart/form-data" action="updateCONTMD" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $cid; ?>">
                                  <textarea class="form-control" required name="MDcomment" ><?php echo $MDOfficeComment; ?></textarea> 
                            </div>
                            <div class="form-group has-feedback col-md-12" >
                              <?php if($MDOfficeOn == "") { ?>
                                  <label><input type="checkbox" name="MDapprove"> &nbsp; &nbsp; Approve</label>
                              <?php } else { ?>
                                <label><input type="checkbox" checked name="MDapprove"> &nbsp; &nbsp; Approve</label>
                              <?php } ?>
