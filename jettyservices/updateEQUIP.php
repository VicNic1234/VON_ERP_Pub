...
$UID = $_SESSION['uid'];
  ...
  $Today = date('Y/m/d h:i:s a'); 
	...
	$query1 = "UPDATE jettyequipments SET EquipNo='".$EquipFNo."', EquipNme='".$EquipNme."', EquipCode='".$EquipCode."', EquipLoc='".$EquipLoc."', EquipMan='".$EquipMan."', EquipYrMake='".$EquipYrMake."', EquipFNo='".$EquipFNo."', Comment='".$Comment."' WHERE cid='$EquipID'"; 
