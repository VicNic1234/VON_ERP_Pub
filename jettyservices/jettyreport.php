      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Jetty Reports</li>
          </ol>
        </section>
...
<?php
 ...
 $resultLI = mysql_query("SELECT * FROM jettyreport 
 LEFT JOIN users ON jettyreport.CreatedBy = users.uid
...
//fetch tha data from the database
    ...
    */
    ...
    $ViewCon = '<a title="View full details" href="viewreport?cnid='.$jid.'"><i class="fa fa-eye"></i></a>';
