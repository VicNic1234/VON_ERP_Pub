...
if ($NoRowChartMaster > 0) {
  while ($row = mysql_fetch_array($resultChartMaster)) {
    ...
    <td><a mid="'.$mid.'" id="'.$id.'" catname="'.$catname.'" catID="'.$catID.'"  Description="'.$Description.'" Station="'.$StationID.'" Storage="'.$Storage.'" Bin="'.$Bin.'" Bal="'.$Bal.'" Condi="'.$Condi.'" onclick="editStock(this)"  ><i class="fa fa-edit"></i></a></td>
    <td><a acctnme="'.$catname.'" accttype="'.$type_name.'" acctclass="'.$classID.'" acctid="'.$mid.'" acctcode="'.$id.'"  ><i class="fa fa-history"></i></a></td></tr>';
    }
