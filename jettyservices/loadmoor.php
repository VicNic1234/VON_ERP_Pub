    ...
    <?php include('leftmenu.php') ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Record Loading/Mooring Activity
            <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../jettyservices"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"></li>
          </ol>
        </section>
          ...
          <div class="row">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12" style="background-color:#DBB895; border-radius: 15px; padding-top:22px;">
                     ...
                     <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="regACT" method="post">
           ...
           <div class="form-group has-feedback col-md-4" >
                ...
                <select  class="form-control" id="ActivityType" name="ActivityType" required>
                  ...
                  <option value="WATER BULKING">WATER BULKING</option>
                </select>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
		      ...
		      <div class="form-group has-feedback col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control datep" name="ActivityStartDate" readonly="" required />
                    </div><!-- /.input group -->
          </div>

          <div class="form-group has-feedback col-md-4" >
                <label>Equipment Used:</label>
                <input type="text"  class="form-control" id="EquipUsed" name="EquipUsed" required>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>

    <div class="form-group has-feedback col-md-12">
      <label>Activities:</label>
       <textarea rows="4" cols="50" placeholder=" Enter Activities here..." id="Activities" name="Activities" style="width:100%; display: inline-block;"></textarea>
     </div>
        ...
        <div class="form-group has-feedback col-md-4" >
          ...
          <div class="form-group has-feedback col-md-4" >
                <label>EDA/ETA/ START TIME:</label>
                <input type="text"  class="form-control" id="EDA" name="EDA" required>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>

            <div class="form-group has-feedback col-md-4" >
                <label>EDD/ETD/ END TIME:</label>
                <input type="text"  class="form-control" id="EDD" name="EDD" required>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
            ...
            <div class="form-group has-feedback col-md-4" >
                ...
                <input type="text"  class="form-control" id="TDays" name="TDays" required>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
		   ...
		   <div class="row">
            ...
            <div class="col-xs-4 pull-right">
              <button type="submit" class="btn btn-success btn-block btn-flat">Add Activity</button>
            </div><!-- /.col -->
          </div>
  </div><!-- /.col -->
