...
if ($NoRowCN > 0) 
{
	...
	while ($row = mysql_fetch_array($resultCN)) {
        ...
        if($Country1 == $conNME) { $CountryR .='<option value="'.$conNME.'" selected >'.$conNME.'</option>'; }
        else{
...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $_SESSION['CompanyAbbr']; ?> ERP | Register New Currency</title>
...
?>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Currency On ERP</h3>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-8" style="background: #CCC; border-radius: 23px;">
                      <p class="text-center">
       ...
       <input type="text" class="form-control" id="curhnme" name="curhnme" placeholder="Hunderth Name" value="<?php echo $HunderthName1; ?>" required />
         ...
         <div class="form-group has-feedback" style="width:40%; display: inline-block; margin:12px;">
            <label>Ex Rate To USD</label>
            
            <input type="text" class="form-control" id="curexUSD" name="curexUSD" placeholder="ExRate To USD" onKeyPress="return isNumber(event)" value="<?php echo $ExRateToUSD1; ?>" />
           </div>
