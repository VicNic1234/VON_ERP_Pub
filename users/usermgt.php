...
} else { $BUopt .= '<option value="" > No Business Unit </option>'; }
...
$Record = ""; $snid = 0;
$UsersUt = mysql_query("SELECT * FROM users ORDER BY uid DESC");
...
?>
          ...
          <select class="form-control"  id="jbtitle" name="jbtitle" onchange="setJobPosition(this)" required>
          <option value=""> -- </option>
          <?php echo $JBTopt; ?>
          </select>
          </div>
          ...
          <div class="form-group has-feedback col-md-4">
          <label>Position <span style="color:red">*<span> <span class="addbtn"> Add New </span></label>
          <select class="form-control"  id="posti" name="posti" required>
          <option value=""> -- </option>
          ...
          <select class="form-control"  id="rptmgr" name="rptmgr" required>
          <option value=""> -- </option>
          <?php echo $RptMgropt; ?>
          </select>
          </div>
          ...
          <input type="text" class="form-control" id="DOJ" name="DOJ" placeholder="Date of Joining" required />
          </div>

          <div class="form-group has-feedback col-md-3">
          <label>Years of Experience <span style="color:red">*<span></label>
          <input type="text" class="form-control" id="YOEx" name="YOEx" placeholder="Years of Experience" required />
          </div>
          ...
          <input type="text" class="form-control" id="WkPhn" name="WkPhn" placeholder="Work Phone No." />
          </div>
          ...
          <input type="text" class="form-control" id="WkEx" name="WkEx" placeholder="Extension" />
          </div>
          ...
          <div class="form-group has-feedback col-md-4">
          <label>First Password <span style="color:red">*<span></label>
