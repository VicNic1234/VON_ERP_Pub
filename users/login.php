...
<body>
    <div class="b-con">
        ...
        <div class="content-agile">
            <div class="social-left-agileits" style="background:#3D4D6A; border-radius: 20px;">
                <ul>
                    <li><a></a></li>
                    <li><a></a></li>
                    <li><a></a></li>
                                ...
                                <div class="body bg-gray">
                                    <div class="form-group">
                                        <input type="text" name="Uname" class="form-control"
                                            placeholder="Staff ID / E-mail" required />
                                    </div>
                                    <div class="form-group">
            ...
            <div class="social-right-w3-agile" style="background:#3D4D6A; border-radius: 20px;">
                <ul>
                    <li><a></a></li>
                    <li><a></a></li>
                    <li><a></a></li>
