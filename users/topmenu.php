      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><img src="../mBOOT/splant.png" style ="width:30px; height:30px;"/><strong>PEEL</strong> ERP</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="../mBOOT/splant.png" style ="width:30px; height:30px;"/> <strong>PEEL</strong> ERP</span>
        </a>
