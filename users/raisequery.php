...
$UserQ = mysql_query("SELECT * FROM users WHERE uid ='$sento'");

  //fetch tha data from the database
  while ($row = mysql_fetch_array($UserQ)) {
     $SentToName = $row['Firstname']. " ".$row['Surname'];
 }
	    ...
	    $Record .='
            ...
            <td>'.$nreplyon.'</td>
						<td>'.$nreply.'</td>
            <td> <a href="querydetails?lid='.$queryid.'" target="_blank"><i class="fa fa-trash"></i></a></td>
					 </tr>
...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $_SESSION['CompanyAbbr']; ?> ERP | My Raised Query</title>
...
?>
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="box collapsed-box">
                <div class="box-header with-border">
                  <h3 class="box-title">Raise Query &nbsp;&nbsp; <i class="fa fa-question"></i></h3>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Query Personel</h3>
                  <div class="box-tools pull-right">
                    <!-- <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                ...
                <div class="box-body">
                  <div class="col-md-12">
                    <form enctype="multipart/form-data" action="" method="post" style="font-size:13px;">
                      ...
                      <label>Staff To Query <span style="color:red">*<span></label>
                      <select class="form-control" id="StaffToQ" name="StaffToQ" required >
                        <option value=""> -- </option>
                        <?php echo $StaffOpt; ?>
                      </select>
                      </div>
                       <div class="form-group col-md-2 pull-right" style="padding-top:20px;">
                      <button type="submit" name="queryapply" value="<?php echo $StaffID; ?>" class="btn btn-primary"><i class="fa fa-send"></i> Send Query</button>
                      </div>

                      <div class="form-group col-md-12">
                      <label>Query</label>
                      <textarea name="thequery" id="thequery" class="form-control" placeholder="The Query" required></textarea>
                      <!--<input type="text" class="form-control" id="thequery" name="thequery" placeholder="The Query" required />-->
                      </div>
	...
	<div class="row">
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">My raised query on ERP</h3>
                  <div class="box-tools pull-right">
                  </div>
                </div><!-- /.box-header -->
              <div class="box">
