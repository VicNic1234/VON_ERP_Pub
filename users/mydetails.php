...
<html>
  <head>
    ...
    <title><?php echo $_SESSION['CompanyAbbr']; ?> ERP | My Details</title>
                    ...
                    <div class="tabbable tabs-left">
                      <ul class="nav nav-tabs">
                        ...
                        <li><a href="#travels" data-toggle="tab"><i class='fa fa-car'></i> Travels</a></li>
                          ...
                          <li><a href="#payslips" data-toggle="tab"><i class='fa fa-circle-o'></i> Pay Slips</a></li>
                          ...
                          <div class="col-md-7" style="background-color:#FBFBFB; border-radius: 25px;">
                            <form enctype="multipart/form-data" action="upstaffinfo" method="post" style="font-size:13px;">
                              <div class="form-group has-feedback col-md-4">
                                <input type="hidden" name="indivall" id="indivall" value="YES" />
                              ...
                              <div class="form-group has-feedback col-md-4">
                              <label>Job Title <span class="addbtn"> Add New </span></label>
                              <select class="form-control"  id="jbtitle" name="jbtitle">
                              <option value=""> -- </option>
                              <?php echo $JBTopt; ?>
                              </select>
                              </div>-->
      ...
      function addDoc(uid)
        {
          ...
          '<input type="hidden" name="indiv" class="form-control" id="indiv" value="YES" />' +
          '</div>'+
