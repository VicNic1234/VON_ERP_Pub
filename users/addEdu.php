...
$queryNewEdu = "INSERT INTO empeducation (user_id, eduInstitue, eduYearFrom, eduYearTo, eduTitle, eduCert, createdby, isactive) 
VALUES ('$uid','$eduInstitue','$eduYearFrom','$eduYearTo','$eduTitle','$doclink','$CreatedBy','1');";
     ...
     {
        $_SESSION['ErrMsgB'] = "Education info. have been added!";
