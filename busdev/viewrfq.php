...
?>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-8" style="background-color:#00C888; border-radius: 15px; padding-top:22px;">
                     ...
                     <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="updateRFQ" method="post">
          <div class="form-group has-feedback col-md-12" >
                ...
                <input type="hidden" name="RFQIDn" value="<?php echo $CONID; ?>">
     ...
     <div class="form-group has-feedback col-md-12">
       <textarea rows="4" cols="50" placeholder=" Enter comment here..." id="Comment" name="Comment" style="width:100%; display: inline-block;"><?php echo $Comment; ?></textarea>
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" readonly value="<?php echo $RFQNo; ?>" id="RFQNo" name="RFQNo" placeholder="ENL/C&P/CONTR/002"  required />
...
<br/>
     ...
     <?php if($FileLink != "") { ?>
                    <center><strong><a href="<?php echo $FileLink; ?>"> RFQ Master Document </a></strong></center>
                    <?php } ?>
                    <br/>


      <p class="text-center">
                        <strong>Upload RFQ Document To Overwrite Previous (Optional)</strong>
                      </p>
