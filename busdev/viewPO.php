      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Customer's POs</li>
          </ol>
        </section>
...
<?php
 ...
 $resultLI = mysql_query("SELECT * FROM cuspo 
...
//fetch tha data from the database
	 if ($NoRowLI > 0) 
   {
    ...
    $PONum = $row['PONum'];
	  ...
	  $Span = $row['DateStart'] . " - " . $row['DateStart'];
    $RaisedBy = $row['Firstname'] . " " . $row['Surname'];//$row['RaisedBy'];
	  $FileLink = $row['Attachment'];
   

    if($FileLink != ""){
    $FileLinkn = '<a target="_blank" title="Download Customer PO document" href="'.$FileLink.'"><i class="fa fa-link"></i></a>';
    }
    else
    {
      $FileLinkn = '';
    ...
    $ViewCon = '<a title="View full Customer PO" href="viewcuspo?cnid='.$cid.'"><i class="fa fa-eye"></i></a>';
