...
function editAcc(elem)
{
 ...
 //var ShortCode = $(elem).attr("ShortCode"); 
    var size='standart';
            var content = '<form role="form" action="" method="POST" ><div class="form-group">' +
             '<input type="hidden" value="'+acctid+'" id="idClass" name="idClass" />'+
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Comment: </label><input type="text" class="form-control" id="nmeClass" name="nmeClass" value="'+acctnme+'" placeholder="" required ></div>' +

              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label> Open: <input type="radio" name="rstate" ></label> <br/> <label> Closed: <input type="radio" name="rstate" ></label> <br/>  <label> Cancelled: <input type="radio" name="rstate"></label></div>' +
