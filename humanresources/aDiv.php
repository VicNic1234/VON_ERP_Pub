...
$UsersUt = mysql_query("SELECT * FROM divisions ORDER BY DivisionName");
    ...
    $DH = getUserinfo($DHn);
      ...
      $Record .='
           <tr>
            ...
            <td><a '.  'onclick="open_container('.$uid.',\''.$DivisionName.'\',\''.$GMn.'\',\''.$DHn.'\');">'. '<span class="glyphicon glyphicon-edit"></span></a></td>
...
<html>
  <head>
    ...
    <title><?php echo $_SESSION['CompanyAbbr'] ?> ERP | Divisions</title>
...
?>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">New Division Details</h3>
          ...
          <form enctype="multipart/form-data" action="regDiv" method="post" style="font-size:13px;">
       
          <div class="form-group has-feedback col-md-12">
          <label>Division Name <span style="color:red">*<span></label>
          <input type="text" class="form-control" id="Bname" name="Bname" placeholder="Division name" required />
          </div>
	  ...
	  <script language="javascript">
        ...
        function open_container(uid, businessunit, gm, dh)
		
        { 

        var UserOpt = '<?php echo $UserOpt; ?>'; 
			var title = 'Edit <strong>'+ businessunit + '</strong> Division Info.';
            var size='standart';
						
            var content = '<form role="form" method="post" action="upDiv" ><div class="form-group">' +

			'<div class="form-group has-feedback" style="width:100%;">' +
		    '<label>Division Name: </label>' +
            '<input type="text" class="form-control" id="Bnme" name="Bnme" placeholder="Division" value="'+ businessunit +'" required ></input>' +
            '<span class="glyphicon glyphicon-user form-control-feedback"></span>' +
			'</div>' +'<input type="hidden" name="uID" value="'+ uid +'" ></input>' +

      '<div class="form-group has-feedback" style="width:100%;">' +
        '<label>Head of this Division: </label>' +
            '<select class="form-control" id="HDiv" name="HDiv"  ><option value="">---</option>'+ UserOpt +'</select>' +
            '<span class="glyphicon glyphicon-user form-control-feedback"></span>' +
      '</div>' +

      '<div class="form-group has-feedback" style="width:100%;">' +
        '<label>GM for this Division: </label>' +
            '<select class="form-control" id="GMDiv" name="GMDiv"  ><option value="">---</option>'+ UserOpt +'</select>' +
            '<span class="glyphicon glyphicon-user form-control-feedback"></span>' +
      '</div>' +
