...
$CONID = $_GET['cnid']; //exit;
 $resultLI = mysql_query("SELECT * FROM vehicles 
 LEFT JOIN users ON vehicles.RaisedBy = users.uid
 WHERE vehicles.cid='".$CONID."'
...
if ($NoRowSDoc > 0) {
 ...
 /*GET MAINTENANCE ACTIVITIES*/
        /*Get Supporting Docs*/
$resultMAct = mysql_query("SELECT * FROM vmaintain_activities
 LEFT JOIN users ON vmaintain_activities.raisedby = users.uid
 Where equipid='".$CONID."' AND vmaintain_activities.isActive=1");
    ...
    <?php include('leftmenu.php') ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             Vehicle : <?php echo $EquipCode; ?>
            <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active"><?php echo $EquipCode; ?></li>
          </ol>
        </section>
      ...
      <label>Description:</label>
       ...
       <div class="row">
            ...
            <div class="col-xs-4 pull-right">
              <button type="submit" class="btn btn-success btn-block btn-flat">Update Vehicle</button>
            </div><!-- /.col -->
          </div>
  </div><!-- /.col -->
                  ...
                  <table class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Activity </th>
                        <th>Parts Replacement/Repair</th>
                        <th>Due Date</th>
                        <th>Remarks</th>
                        <th>Signature</th>
                      </tr>
          ...
          var size='standart';
                  var content = '<form role="form" action="addActivity" method="POST" enctype="multipart/form-data" ><div class="form-group">' +
                   ...
                   '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Activity: </label><input type="text" class="form-control"  name="Activity" required ></div>' +
                    ...
                    '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Parts Replacement/Repair: </label><textarea class="form-control"  name="PartsReplaces" required ></textarea></div>' +
                   ...
                   '<button type="submit" class="btn btn-success pull-right">Send Request</button><br/></form>';
                  var title = 'New Maintenance Request';
                  var footer = '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
