...
?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  ...
                  <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="regVEHI" method="post">
                  ...
                  <div class="row">
                    <div class="col-md-12" style="background-color:#DBB895; border-radius: 15px; padding-top:22px;">
                       ...
                       <div class="form-group has-feedback col-md-4" >
                            ...
                            <input type="text"  class="form-control" id="VehicleNme" name="VehicleNme" required>
                        ...
                        <span class="glyphicon glyphicon-barcode form-control-feedback"></span>
            		      ...
            		      <div class="form-group has-feedback col-md-4">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control datep" name="VehicleYrMake" readonly="" required />
                                </div><!-- /.input group -->
                      </div>
            ...
            <div class="col-xs-4 pull-right">
              ...
              <button type="submit" class="btn btn-success btn-block btn-flat">Add Vehicle</button>
