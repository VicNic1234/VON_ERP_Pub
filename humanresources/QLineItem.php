...
$LIRFQ = mysql_real_escape_string(trim(strip_tags($_POST['LIRFQ'])));
$LIID = mysql_real_escape_string(trim(strip_tags($_POST['LIID'])));
$query = "UPDATE lineitems SET Status='QUOTED', Price='".$UnitCost."', EXPPrice='".$EXPPrice."', CIFPPrice='".$CIFPPrice."', UnitCost='".$UnitCost."', Currency='".$Cur."', ExtendedCost='".$ExCost."'
...
, UnitDDPrice='".$UnitDDPrice."', DELIVERY='".$DCUSL."', WorkLocation='".$DEXL."', DeliveryToWrkLocation='".$DEX."', pLocalHandling='".$pLocHand."', MarkUpDirect='".$Hmkupchk."', FreightDirect='".$Hfrchk."'  WHERE LitID='".$LIID."'"; 
...
$query1 = "UPDATE polineitems SET Status='QUOTED', Price='".$UnitCost."', EXPPrice='".$EXPPrice."', CIFPPrice='".$CIFPPrice."', UnitCost='".$UnitCost."', Currency='".$Cur."', ExtendedCost='".$ExCost."'
, Discount='".$Disc."', DiscountAmt='".$DiscAmt."', UnitWeight='".$UnitWeight."', ExWeight='".$ExWeight."', FOBExWorks='".$FOB."', ExportPackaging='".$PackA."', Currency='".$Cur."'
, PackingPercent='".$PackP."', InsurePercent='".$InsurP."', Insurance='".$InsurA."', FreightPercent='".$FreightP."', Freight='".$FreightA."', ForeignCost='".$CIF."', HsTarrif='".$HSTariff."' 
, HScode='".$HSCODE."', CustomDuty='".$CustomDuty."', CustomVat='".$CustomVat."', SupDetail='".$SupDetails."', PreShipmentInspect='".$PreShip."', MarkUp='".$markupCos."'
, CustomSubCharge ='".$CusSub."', ETLSCharge='".$ETLS."', LocalHandling='".$LocHand."', LocalCost='".$LocCos."', DPPPrice='".$DPPPrice."', markupperc='".$markupperc."'
, UnitDDPrice='".$UnitDDPrice."', DELIVERY='".$DCUSL."', WorkLocation='".$DEXL."', DeliveryToWrkLocation='".$DEX."', pLocalHandling='".$pLocHand."', MarkUpDirect='".$Hmkupchk."', FreightDirect='".$Hfrchk."' WHERE LitID='".$LIID."' AND ProjectControl='0'"; 
