...
$Record = ""; $snid = 0;
$UsersUt = mysql_query("SELECT * FROM leavemgt LEFT JOIN department ON leavemgt.DeptmentID = department.id ORDER BY DateCreated");
    ...
    $Department = $row['DeptmentName'];
      ...
      $Record .='
           <tr>
            ...
            <td><a '.  'onclick="open_container('.$uid.',\''.$BusYear.'\',\''.$LeaveTitle.'\',\''.$Department.'\',\''.$NWkDays.'\');">'. '<span class="glyphicon glyphicon-edit"></span></a></td>
...
?>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">New Leave Group</h3>
          ...
          <form enctype="multipart/form-data" action="regLeave" method="post" style="font-size:13px;">
          ...
          <label>No. of Wrk Days</label>
          <input type="number" class="form-control" id="WkDays" name="WkDays" placeholder="Day(s)" />
          </div>

          <div class="form-group col-md-4">
          <label>Leave Title</label>
          <input type="text" class="form-control" id="LvTl" name="LvTl" placeholder="Leave Title" />
          </div>
         ...
         <button type="submit" class="btn btn-primary">Add Leave Group</button>
          </div>
	  ...
	  <script language="javascript">
        ...
        function open_container(uid, busyr, lvti, dept, nwkdays) 
		
        {  
			var title = 'Edit '+ lvti + ' Leave Info.';
			var DeptJUnit = '<?php echo $DepUtOpt;  ?>';
            var size='standart';
						
            var content = '<form role="form" method="post" action="upLeavemgt" ><div class="form-group">' +
        ...
        '</div>'+
			...
			'<label>No. of Wrk Days </label>' +
			'<div class="form-group"><input type="text" class="form-control" id="WkDays" name="WkDays" value="'+ nwkdays +'" placeholder="No of Wrk Day"></div>' +
			
      '<label>Leave Title </label>' +
      '<div class="form-group"><input type="text" class="form-control" id="LvTl" name="LvTl" value="'+ lvti +'" placeholder="Leave Mgt. Title"></div>' +
	...
	<div class="row">
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Leave Group List</h3>
                  <div class="box-tools pull-right">
