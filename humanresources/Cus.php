...
?>
          ...
          <div class="form-group has-feedback" style="width:40%; display: inline-block;">
		   <input type="text" class="form-control" id="cusnme" name="cusnme" placeholder="Customer's Name" value="<?php echo $CustormerNme1; ?>" />
		   ...
		   <input type="text" class="form-control" id="cusrefn" name="cusrefn" placeholder="Customer's ref. No." value="<?php echo $CusRefNo1; ?>" />
          </div>
       
		   <div class="form-group has-feedback" style="width:40%; display: inline-block; margin:0px;">
            <input type="text" class="form-control" id="cusphn1" name="cusphn1" placeholder="Customer's contact 1" value="<?php echo $CusPhone11; ?>" />
           </div>
		   ...
		   <div class="form-group has-feedback" style="width:40%; display: inline-block; margin:12px;">
            ...
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
		     ...
		     <div class="form-group has-feedback" style="width:40%; display: inline-block; margin:0px;">
			 <textarea style="width:100%" name="cusadd" placeholder="Customer's Address" ><?php echo $CusAddress1; ?></textarea>
		   </div>
		
     <div class="form-group has-feedback" style="width:40%; display: inline-block; margin:12px;">
            <input type="text" maxlength = 4 class="form-control" id="cussnme" name="cussnme" placeholder="SHORT NAME" value="<?php echo $cussnme; ?>"  />
