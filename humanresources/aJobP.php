...
$Record = ""; $snid = 0;
$UsersUt = mysql_query("SELECT * FROM jobposition ORDER BY JobPosition");
    ...
    $Description = $row {'Description'};
      ...
      $Record .='
           <tr>
            ...
            <td><a '.  'onclick="open_container('.$uid.',\''.$JobPosition.'\',\''.$Description.'\');">'. '<span class="glyphicon glyphicon-edit"></span></a></td>
...
<html>
  <head>
    ...
    <title><?php echo $_SESSION['CompanyAbbr'] ?> ERP | Designation</title>
...
?>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">New Designation Details</h3>
                ...
                <div class="box-body">
                  ...
                  <form enctype="multipart/form-data" action="regJobP" method="post" style="font-size:13px;">
         

          <div class="form-group has-feedback col-md-3">
          <label>Designation <span style="color:red">*<span></label>
          <input type="text" class="form-control" id="Jname" name="Jname" placeholder="Designation"required />
          </div>

          <div class="form-group col-md-3">
          <label>Description</label>
          <input type="text" class="form-control" id="JDes" name="JDes" placeholder="Designation Description" />
          </div>
	  ...
	  <script language="javascript">
        ...
        {  
			var title = 'Edit '+ deptname + ' Designation Info.';
            var size='standart';
						
            var content = '<form role="form" method="post" action="upJobP" enctype="multipart/form-data" ><div class="form-group">' +
			'<div class="form-group has-feedback" style="width:100%;">' +
		    '<label>Designation: </label>' +
            '<input type="text" class="form-control" id="Jnme" name="Jnme" placeholder="Designation" value="'+ deptname +'" required ></input>' +
