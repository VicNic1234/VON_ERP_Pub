...
//Let's read all Options now
  ...
  $PRSettings = mysql_query("SELECT * FROM payrollsettings");
$NoRowPRSettings = mysql_num_rows($PRSettings);
if ($NoRowPRSettings > 0) {
  while ($row = mysql_fetch_array($PRSettings)) {
   
    $CompanyRegNo = $row['CompanyRegNo'];
    $NHISNo = $row['NHISNo'];
    $TAXTINNo = $row['TAXTINNo'];
    $ITFLevyNo = $row['ITFLevyNo'];
    $NHFNo = $row['NHFNo'];
    $NSITFNo = $row['NSITFNo']; 
    $ProRataCal = $row['ProRataCal']; 
...
//Let's Read Earnings
$RecAccSet = "";
$resultAccSet = mysql_query("SELECT *, compcontri_settings.id AS EnrsID,
  compcontri_settings.Description AS ErnDes,
  opt_cal_method.Description AS CalMedDes,
  opt_employee_group.Description AS EmpGrp,
  acc_chart_master.account_name AS GLNME,
  compcontri_settings.isActive As EnrsStatus FROM compcontri_settings
  INNER JOIN acc_chart_master ON compcontri_settings.GLMaster = acc_chart_master.mid
  INNER JOIN opt_cal_method ON compcontri_settings.CalMethod = opt_cal_method.calid
  INNER JOIN opt_earning_freq ON compcontri_settings.EarningFrequ = opt_earning_freq.enfreqid 
  INNER JOIN opt_employee_group ON compcontri_settings.AppliedToStaffGroup = opt_employee_group.empgid 
  ");
...
function addAcc(elem)
{
    ...
    var size='standart';
            ...
            '<div class="col-md-12">' +
            '<form role="form" action="addCompcontri" method="POST" ><div class="form-group">' +
              '<div class="form-group col-md-6"><label>Description: </label><input type="text" class="form-control" name="newCompcontri" placeholder="Enter Company Contribution Description"></div>' +
              ...
              '<div class="form-group col-md-6"><label>Contribution Frequency: </label><select class="form-control" name="newEarnFreq">'+ OptEarningFrequ +'</select></div>' +
              ...
              '<button type="submit" class="btn btn-primary pull-right">Add Company Contribution</button><br/></form>'+
              '</div></div>';
            var title = 'New Company Contribution';
            var footer = '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
...
?>
           ...
           <div class="col-md-12">
              ...
              <div class="box">
                <div class="box-header">
                   <!-- <h4> -- </h4>
               <button class="btn btn-success pull-right" id="addAcct" onclick="addAcc(this)" > Add Company Contribution</button>-->
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
    ...
    $ProRataCal = $row['ProRataCal']; -->
                     <!-- form start -->
                                    <form action="updatepayrollsettings" method="post" role="form">
                    <div class="col-md-12">
                             <div class="box box-primary" style="background:#99CCFF;">
                                    <div class="box-header">
                                      <h3 class="box-title"> Statutory Company Info. </h3> &nbsp;<i class="fa fa-cogs"></i>
                                    </div><!-- /.box-header -->
                                      ...
                                      <div class="box-body">
                                        <div class="col-md-6">
                                          ...
                                          <input type="text" class="form-control" name="CompanyRegNo" id="CompanyRegNo" value="<?php echo $CompanyRegNo; ?>" placeholder="Company Reg. No.">
                                          </div>
                                          <div class="form-group col-md-12">
                                            <label>Tax/PIN Registration Number</label>
                                          <input type="text" class="form-control" name="TAXTINNo" id="TAXTINRegNo" value="<?php echo $TAXTINNo; ?>" placeholder="Tax/PIN Reg. No.">
                                          </div>
                                          <div class="form-group col-md-12">
                                            <label>Company N. Housing Fund Number</label>
                                          <input type="text" class="form-control" name="NHFNo" id="NHFRegNo" value="<?php echo $NHFNo; ?>" placeholder="N. Housing Fund Number">
                                          </div>
                                        </div>
                                        <div class="col-md-6">
                                          <div class="form-group col-md-12">
                                            <label>Company N. Health Issurance Scheme</label>
                                          <input type="text" class="form-control" name="NHISNo" id="NHISRegNo" value="<?php echo $NHISNo; ?>" placeholder="N. Health Issu. Schem. Number">
                                          </div>
                                          <div class="form-group col-md-12">
                                            <label>Company ITF Levy Number</label>
                                          <input type="text" class="form-control" name="ITFLevyNo" id="ITFRegNo" value="<?php echo $ITFLevyNo; ?>" placeholder="ITF Levy Number">
                                          </div>
                                          <div class="form-group col-md-12">
                                            <label>Company NSITF Number</label>
                                          <input type="text" class="form-control" name="NSITFNo" id="NSITFRegNo" value="<?php echo $NSITFNo; ?>" placeholder="NSITF Number">
                                          </div>
                    ...
                    <div class="col-md-6">
                              <div class="box box-primary" style="background:#CCFF99;">
                                    <div class="box-header">
                                      <h3 class="box-title"> Pro-Rata Calculation </h3> &nbsp;<i class="fa fa-cogs"></i>
                                    </div><!-- /.box-header -->
                                    <!-- form start -->
                                    
                                      <div class="box-body">  
                                        <div class="form-group col-md-12">
                                           <label>Calendar Days <input type="radio" name="commtype1" value="Calendar Days" <?php if($ProRataCal == "Calendar Days") { echo "checked"; }  ?>  /> </label>
                                           &nbsp; &nbsp; &nbsp; &nbsp;
                                           <label>30 Days <input type="radio" name="commtype1" value="30 Days" <?php if($ProRataCal == "30 Days") { echo "checked"; }  ?>  /> </label>
