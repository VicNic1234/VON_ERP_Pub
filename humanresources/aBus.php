...
$RptMgropt = "";
$RptMgrUt = mysql_query("SELECT * FROM users WHERE porApproval='1' ORDER BY Surname");
...
$Record = ""; $snid = 0;
//$UsersUt = mysql_query("SELECT * FROM businessunit LEFT JOIN department ON businessunit.DeptID = department.id ORDER BY BussinessUnit");
$UsersUt = mysql_query("SELECT * FROM businessunit ORDER BY BussinessUnit");
    ...
    $Description = $row {'Descript'};
      ...
      $Record .='
           <tr>
            ...
            <td><a '.  'onclick="open_container('.$uid.',\''.$BussinessUnit.'\',\''.$Description.'\');">'. '<span class="glyphicon glyphicon-edit"></span></a></td>
...
<html>
  <head>
    ...
    <title><?php echo $_SESSION['CompanyAbbr'] ?> ERP | Business Unit</title>
...
?>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">New Business Unit Details</h3>
          ...
          <form enctype="multipart/form-data" action="regBus" method="post" style="font-size:13px;">
       
          <div class="form-group has-feedback col-md-4">
          <label>Business Unit Name <span style="color:red">*<span></label>
          <input type="text" class="form-control" id="Bname" name="Bname" placeholder="Business Unit name" required />
          </div>


          <div class="form-group col-md-4">
          <label>Description</label>
          <input type="text" class="form-control" id="BDes" name="BDes" placeholder="Department Description" />
          </div>
	  ...
	  <script language="javascript">
        ...
        function open_container(uid, businessunit, despcription)
		
        {  
			var title = 'Edit '+ businessunit + ' Business Unit Info.';
            var size='standart';
						
            var content = '<form role="form" method="post" action="upBus" ><div class="form-group">' +

			'<div class="form-group has-feedback" style="width:100%;">' +
		    '<label>Business Unit Name: </label>' +
            '<input type="text" class="form-control" id="Bnme" name="Bnme" placeholder="Business Unit" value="'+ businessunit +'" required ></input>' +
            '<span class="glyphicon glyphicon-user form-control-feedback"></span>' +
			'</div>' +'<input type="hidden" name="uID" value="'+ uid +'" ></input>' +
			
		
			'<label>Description </label>' +
			'<div class="form-group"><input type="text" class="form-control" id="BDes" name="BDes" value="'+ despcription +'" placeholder="Description"></div>' +
	...
	<div class="row">
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Business Unit List</h3>
                  <div class="box-tools pull-right">
                ...
                <div class="box-body">
                  <table id="userTab" class="table table-bordered table-striped" style="">
                    <thead>
                      <tr>
                        <th>S/N</th>
