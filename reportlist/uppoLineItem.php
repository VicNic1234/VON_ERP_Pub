...
$query = "UPDATE purchaselineitems SET Description='".$ItDes."', Status='OPEN', Qty='".$LIQty."', EXPPrice='".$EXPPrice."', CIFPPrice='".$CIFPPrice."', Price='".$UnitCost."', UnitCost='".$UnitCost."', Currency='".$Cur."', ExtendedCost='".$ExCost."'
...
, UnitDDPrice='".$UnitDDPrice."', DELIVERY='".$DCUSL."', WorkLocation='".$DEXL."', DeliveryToWrkLocation='".$DEX."', pLocalHandling='".$pLocHand."', MarkUpDirect='".$Hmkupchk."', FreightDirect='".$Hfrchk."', MatSer='".$mart."', UOM='".$UOM."', incoterm='".$IncoTerm."', doincoterm='".$DONT."', applydoincoterm='".$applyDONT."', Division='".$Divs."'  WHERE LitID='".$LIID."'"; 
////////////////////////
/////////////
