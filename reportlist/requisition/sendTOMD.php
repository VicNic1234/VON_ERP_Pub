...
//Update the rpo table
    mysql_query("UPDATE poreq SET Approved='9', LastActor='GM of Due Dilligence', Status='Approved', MDApp='".$MDID."', DDApp='".$uid."', ApprovedBy='".$staffname."', DDAppDate='".$TodayD."',  DDAppComment='".$hodMSG."' WHERE RequestID = '$ReqCode'");
