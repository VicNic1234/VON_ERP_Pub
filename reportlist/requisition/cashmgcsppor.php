...
////////////////////////////////////
$resultStaff = mysql_query("SELECT * FROM divisions where GM='".$HODID."'"); 
   ...
   <script type="text/javascript">
      ...
      function sendTOGMDD()
      {
        ...
        var DivisonName = '<?php echo $DivisonName ?>';
          ...
          var size='standart';
                  var content = '<form role="form" action="cashsendTOGMDDcs" method="POST" >'+
    ...
    <script type="text/javascript">
       function sendTOMD()
      {
        ...
        var DivisonName = '<?php echo $DivisonName ?>';
          ...
          var size='standart';
                  var content = '<form role="form" action="cashsendTOMDcs" method="POST" >'+
                  '<div class="form-group">' +
                   '<input type="hidden" value="" id="accID" name="accID" />'+
                   '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Cash Request Code: </label><input type="text" class="form-control"  name="ReqCode" value="'+ sReqID +'"  readonly ></div>' +
...
function ReadLineItem(elem)
    {
     ...
     if (hhh != "")
     {     
    window.location.href ="cashmgcsppor?pdfid=" + hhh;
    //window.alert("JKJ");
     }
