...
function printDiv(divName) {
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"> <strong>MD's Office</strong> Pending Approval</h3>
   ...
   <div class="form-group has-feedback" style="width:90%; display: inline-block; margin:12px; ">
		    <select class="form-control selectn" id="LIRFQ" name="LIRFQ" onChange="LoadCODE(this)">
...
function MDAction(elem)
    {
     ...
     if (ActionOfMD != "")
     {     
    window.location.href ="mdaction?pdfid=" + ReQID + "&ActionOfMD="+ActionOfMD;
    //window.alert("JKJ");
     }
