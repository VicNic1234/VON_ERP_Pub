...
function printDiv(divName) {
   ...
   <div class="form-group has-feedback" style="width:90%; display: inline-block; margin:12px; ">
    ...
    <div class="form-group has-feedback">
     ...
     <?php } ?>
         <button class="btn btn-warning pull-left" onclick="sendTOBDDOfficer()" type="button"> Send back to DD Officer | <i class="fa fa-send"></i></button>
     <?php } ?>
      </div>
    </div>
   <script type="text/javascript">
       ...
       function sendTOBDDOfficer()
      {
        ...
        var sReqID = '<?php echo $sReqID ?>';
          ...
          var size='standart';
                  ...
                  ;
                  var title = 'Send Back To DD Officer';
                  var footer = '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
