	...
	while ($row = mysql_fetch_array($resultLeave)) {
     ...
     $Approved = $row['Status'];
      ...
      else if ($Approved == 3)
      {
        ...
        $Approved = '<a href="BackToHDiv?id='.$reqid.'"><button title="By Clicking, you send back to Head of Division" class="btn btn-warning"><i class="fa fa-undo"></i> Send To Head of Division</button></a> &nbsp; <a href="SendToHR?id='.$reqid.'"><button title="By Clicking, you send to HR" class="btn btn-success"><i class="fa fa-send"></i> Send to HR</button></a>';
      }
      else if ($Approved == 4)
      {
