...
/////////////////////////////// 
$resultStaff = mysql_query("SELECT * FROM department where supervisor='".$SupervisorID."'"); 
    ...
    <div class="form-group has-feedback">
      <div>
        ...
        <?php
             ...
             $Apprs = getDeptApprovals($DeptIDn,$SupervisorID,$Approved);

             if($sReqID != "" AND $ApprovedCHK == 1) 
              { 
                
               echo SupervisorNextApproval($SupervisorID, $Apprs['supervisor'], $Apprs['hod'], $Apprs['DH'], $Apprs['CPHOD'], $Apprs['GM'], $Apprs['GMCS'], $Apprs['GMDD']);
              }   
...
function ReadLineItem(elem)
    {
     ...
     if (hhh != "")
     {     
    window.location.href ="supervisorppor?pdfid=" + hhh;
    //window.alert("JKJ");
     }
