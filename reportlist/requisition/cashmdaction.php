...
//FOR APPROV
   mysql_query("UPDATE cashreq SET Approved='".$Apn."', LastActor='MD\'s Office', Status='".$ReqMSG."', MDApp='".$uid."', ApprovedBy='".$staffname."', MDAppDate='".$TodayD."',  MDComment='".$Mgs."' WHERE RequestID = '$ReqCode'");
