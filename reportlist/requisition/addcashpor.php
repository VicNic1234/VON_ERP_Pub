...
//Let's just Update
if($DocLink != ""){
$query = "INSERT INTO cashreq (staffID, staffName, ItemDes, Purpose, Amount, Qty, relatedPDF, RequestID, Deparment, RequestDate, attachment) VALUES ('$uid','$staffname','$desp','$ppor','$amt','$qnt','$rPDF', '$rqid', '$Dept', '$TodayD', '$DocLink' );";
}
else{
  $query = "INSERT INTO cashreq (staffID, staffName, ItemDes, Purpose, Amount, Qty, relatedPDF, RequestID, Deparment, RequestDate) VALUES ('$uid','$staffname','$desp','$ppor','$amt','$qnt','$rPDF', '$rqid', '$Dept', '$TodayD' );";
} 
