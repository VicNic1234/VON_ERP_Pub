...
elseif($ActorRole==6)
{
	$sql_res=mysql_query("UPDATE cashreq SET Approved='$ActorRole', LastActor='System Admin', CSApp='$ActorID', Status='Re-Routed To GM of CS.', ApprovedBy='$uid' WHERE RequestID='$ReqCode'");
    $result = mysql_query($sql_res, $dbhandle);
}
elseif($ActorRole==7)
{
