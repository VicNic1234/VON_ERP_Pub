	...
	while ($row = mysql_fetch_array($resultLeave)) {
     ...
     $Approved = $row['Status'];
      ...
      else if ($Approved == 2)
      {
        ...
        $Approved = '<a href="BackToHDept?id='.$reqid.'"><button title="By Clicking, you send back to Head of Department" class="btn btn-warning"><i class="fa fa-undo"></i> Send To Head of Dept</button></a> &nbsp; <a href="SendToDivGM?id='.$reqid.'"><button title="By Clicking, you send to GM of Division" class="btn btn-success"><i class="fa fa-send"></i> Send to GM of Division</button></a>';
      }
      else if ($Approved == 3)
      {
