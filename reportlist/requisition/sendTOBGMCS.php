...
//Update the rpo table
   mysql_query("UPDATE poreq SET Approved='4', LastActor='GM of Due Dilligence', Status='Sent Back', DDApp='".$uid."', ApprovedBy='".$staffname."', DDAppDate='".$TodayD."',  DDAppComment='".$ReqMSG."' WHERE RequestID = '$ReqCode'");
