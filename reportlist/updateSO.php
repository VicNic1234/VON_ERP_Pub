...
$Divs = mysql_real_escape_string(trim(strip_tags($_POST['Divs'])));
...
$query = "UPDATE purchaselineitems SET Description='".$EditDes."', Division='".$Divs."',  Remark='".$EditRemark."', Discount='".$EditDisc."', DiscountAmt='".$DisAmt."', DueDate='".$EditDueDate."', ExtendedCost='".$ExPrice."', Qty='".$EditQty."', UOM='".$EditPer."', UnitCost='".$EditURate."', Currency='".$EditCurr."' WHERE LitID='".$LitIDm."'"; 
