...
$q = mysql_real_escape_string(trim(strip_tags($_POST['rfqID']))); //rfqMUN
$p = mysql_real_escape_string(trim(strip_tags($_POST['rfqMUN']))); //rfqMUN
$p1 = mysql_real_escape_string(trim(strip_tags($_POST['rfqNewMUN']))); //rfqMUN
//////////////////////////////////////////////////////////
...
$sql_res=mysql_query("UPDATE rfq SET RFQUpdate='$RFQUpdate', RFQNum='$p1' WHERE RFQid = '$q'");

//$result = mysql_query($sql_res, $dbhandle);
if ($p != $p1)
{
  //We have to update other tables
  mysql_query("UPDATE lineitems SET RFQCode='$p1' WHERE  RFQCode='$p'");
  mysql_query("UPDATE polineitems SET RFQCode='$p1' WHERE  RFQCode='$p'");
}
