...
$aCus = mysql_real_escape_string(trim(strip_tags($_POST['aCus'])));
$aVal = mysql_real_escape_string(trim(strip_tags($_POST['aVal'])));
$aProd = mysql_real_escape_string(trim(strip_tags($_POST['aProd'])));
$aStatus = mysql_real_escape_string(trim(strip_tags($_POST['aStatus'])));
...
//Let's just Update
$query = "INSERT INTO qmi_riskinq1q4 (ProductID, Product, Customer, rValue, Status, CreatedBy, Wk, Qtr, FirstDayOfWeek, DaysOfWeek, arm) 
