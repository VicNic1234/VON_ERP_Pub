        ...
        <a class="logo">
          ...
          <span class="logo-lg"> <img src="../mBOOT/plant.png" style ="width:40px; height:40px;"/></span>-->
                  ...
                  <div class="box-tools pull-right">
                   <a href="../"><i class="fa fa-home" style="font-size:50px; color:#FF6600;"></i></a>
                  </div>
             ...
             <div class="col-md-12" style="font-size:6px">
              ...
              <div class="box" style="background:#FFF; font-size:13px; border-width:2px; border-style:solid; border-color:#388B66" >
                <div class="box-header">
                  ...
                  <div class="box-body">
                  <div class="col-md-12">
                    <div class="ballboard col-md-6" style="background:linear-gradient(to right, #006666 0%, #009999 100%);"><i class="fa fa-edit"></i> POs No.  <span class="pull-right" id="PONOs">--</span></div>
                    <div class="ballboard col-md-6" style="background:linear-gradient(to right, #006633 0%, #003300 100%);"><i class="fa fa-edit"></i> PO Value <span class="pull-right" id="POVAL">--</span></div>
                  </div>
