                ...
                <form role="form">
                  <div class="box-body">
                    ...
                    function reportMPS()
                    {
                      ...
                      var formData = { sProduct:sProduct, ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, OP:OP, EAOP:EAOP, OB:OB, OBN:OBN, ARM:"externalsales" };
                        $.ajax({
                            type:"POST",
                            url: "addmps",
                            data: formData,
                ...
                <form role="form">
                  <div class="box-body">
                    ...
                    function reportKOP()
                    {
                      ...
                      var formData = { sProduct:sProduct, ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, CusProj:CusProj, ProdRef:ProdRef, ProdLine:ProdLine, ValueEst:ValueEst, KOStatus:KOStatus, KOclose:KOclose, ARM:"externalsales" };
                        $.ajax({
                            type:"POST",
                            url: "addkop",
                            data: formData,
                   ...
                   <script>
                    function reportBKPSW()
                    {
                      ...
                      var formData = { sProduct:sProduct, ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, 
                        ...
                        SSEstVal:SSEstVal, BOEstVal:BOEstVal, FOEstVal:FOEstVal, APEstVal:APEstVal, ReEstVal:ReEstVal, ARM:"externalsales" };
                        $.ajax({
                            type:"POST",
                            url: "addbkpsw",
                            data: formData,
                  ...
                  <div class="box-body">
                   ...
                   <script>
                    function reportRiskIn()
                    {
                      ...
                      var formData = { sProduct:sProduct, ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, 
                        aCus:aCus, aProd:aProd, aVal:aVal, aStatus:aStatus, ARM:"externalsales"};
                        $.ajax({
                            type:"POST",
                            url: "addrskinq1",
                            data: formData,
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    function ReportGapCLose()
                    {
                      ...
                      var formData = { sProduct:sProduct, ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, 
                        bCus:bCus, bProd:bProd, bVal:bVal, bStatus:bStatus, ARM:"externalsales"};
                        $.ajax({
                            type:"POST",
                            url: "addgapclose",
                            data: formData,
                ...
                <form role="form">
                  ...
                  <script>
                    function ReportSynergyOP()
                    {
                      ...
                      var formData = { sProduct:sProduct, ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, 
                        cCus:cCus, cProd:cProd, cVal:cVal, cStatus:cStatus, ARM:"externalsales"};
                        $.ajax({
                            type:"POST",
                            url: "addsynergyop",
                            data: formData,
                ...
                <form role="form">
                  <div class="box-body">
                    ...
                    function ReportAction()
                    {
                      ...
                      var formData = { sProduct:sProduct, ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, 
                        aAction:aAction, ARM:"externalsales"};
                        $.ajax({
                            type:"POST",
                            url: "addaction",
                            data: formData,
                ...
                <form role="form">
                  <div class="box-body">
                    ...
                    function ReportIssues()
                    {
                      ...
                      var formData = { sProduct:sProduct, ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, 
                        aIssues:aIssues, aParty:aParty, iStatus:iStatus, ARM:"externalsales"};
                        $.ajax({
                            type:"POST",
                            url: "addissues",
                            data: formData,
                  ...
                  <div class="box-body">
                    ...
                    function ReportActionForcast()
                    {
                      ...
                      var formData = { ReportWeek:ReportWeek, ReportQtr:ReportQtr, FirstWeekDay:FirstWeekDay, DaysOfRtpWeek:DaysOfRtpWeek, 
                        ActionI:ActionI, ActionP:ActionP, ActionS:ActionS, ActionC:ActionC, ARM:"externalsales"};
                        $.ajax({
                            type:"POST",
