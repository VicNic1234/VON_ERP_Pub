...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $_SESSION['CompanyAbbr']; ?> ERP | CEO DashBoard Internal Sales </title>
    ...
    document.body.innerHTML = originalContents;
        ...
        <a class="logo">
          ...
          <span class="logo-lg"> <img src="../mBOOT/plant.png" style ="width:40px; height:40px;"/></span>-->
                  ...
                  <h3 class="box-title"> [Internal Sales] Quick Market Intelligence Report </h3>
                  
                  <div class="box-tools pull-right">
                  <!--<button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>-->
                  <a href="../CEOD"><i class="fa fa-home" style="font-size:50px; color:#336633;"></i></a>
                  </div>
  ...
  <div id="PrintArea" class="row" style="margin-top: 170px">
    ...
    */
    ...
    function loadSummary() {
      ...
      $('#HITRTn').html(dVal1); $('#TRFQOPNn').html(dVal1); $('#POSRVn').html(dVal1); $('#POSVALn').html(dVal1);
