...
/////////////////////////////////////////////////////////////// Let's Report all the QMIs ////////
  //Product Sales
          //qmi_mkvps
    $ProdSales = mysql_query("SELECT * FROM qmi_mkvps Order By Wk");
...
//Key Opp
//qmi_kops
$Kops = mysql_query("SELECT * FROM qmi_kops Order By Wk");
...
//Key Opp
//qmi_kops
$BDiS = mysql_query("SELECT * FROM qmi_breakdowninsales Order By Wk");
...
$riskinq1q4 = mysql_query("SELECT * FROM qmi_riskinq1q4 
  ...
  LEFT JOIN product ON qmi_riskinq1q4.product = product.pid  Order By Wk");
...
$gapclose = mysql_query("SELECT * FROM qmi_gapclose 
  ...
  LEFT JOIN product ON qmi_gapclose.product = product.pid  Order By Wk");
