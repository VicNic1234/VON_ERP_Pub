...
/////////////////////////////////////////////////////////////// Let's Report all the QMIs ////////
  //Product Sales
          //qmi_mkvps
    $ProdSales = mysql_query("SELECT * FROM qmi_mkvps WHERE arm='externalsales' Order By Wk");
...
//Key Opp
//qmi_kops
$Kops = mysql_query("SELECT * FROM qmi_kops WHERE arm='externalsales' Order By Wk");
...
//Key Opp
//qmi_kops
$BDiS = mysql_query("SELECT * FROM qmi_breakdowninsales WHERE arm='externalsales' Order By Wk");
...
$riskinq1q4 = mysql_query("SELECT * FROM qmi_riskinq1q4 
  ...
  LEFT JOIN product ON qmi_riskinq1q4.product = product.pid WHERE arm='externalsales'  Order By Wk");
...
$gapclose = mysql_query("SELECT * FROM qmi_gapclose 
  ...
  LEFT JOIN product ON qmi_gapclose.product = product.pid WHERE arm='externalsales'  Order By Wk");
