...
//Let's just Update
$query = "INSERT INTO qmi_action ( ProductID, Action, CreatedBy, Wk, Qtr, FirstDayOfWeek, DaysOfWeek) 
VALUES ('$sProduct', '$aAction','$uid','$ReportWeek', '$ReportQtr', '$FirstWeekDay', '$DaysOfRtpWeek' );"; 
