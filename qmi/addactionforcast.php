...
//Let's just Update
$query = "INSERT INTO qmi_actionforcast ( ProductID, ActionItem, ActionParty, ActionStatus, ActionComments, CreatedBy, Wk, Qtr, FirstDayOfWeek, DaysOfWeek) 
VALUES ('$sProduct', '$ActionI','$ActionP','$ActionS','$ActionC','$uid','$ReportWeek', '$ReportQtr', '$FirstWeekDay', '$DaysOfRtpWeek' );"; 
