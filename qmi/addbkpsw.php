...
//Let's just Update
$query = "INSERT INTO qmi_breakdowninsales ( ProductID, SourcingStageNOP, SourcingStageEstValue, BudgetaryOfferNOP, BudgetaryOfferEstValue, FirmOfferNOP, FirmOfferEstValue, AnticipatingPOsNOP, AnticipatingPOsEstValue, ReceivedPOsNOP, ReceivedPOsEstValue, CreatedBy, Wk, Qtr, FirstDayOfWeek, DaysOfWeek, arm) 
VALUES ('$sProduct', '$SSOP', '$SSEstVal','$BOOP','$BOEstVal','$FOOP','$FOEstVal','$APOP','$APEstVal', '$RePO','$ReEstVal', '$uid','$ReportWeek', '$ReportQtr', '$FirstWeekDay', '$DaysOfRtpWeek', '$ARM' );"; 
