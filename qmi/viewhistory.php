...
$resultHI = mysql_query("SELECT * FROM genlineitems");
$NoRowHI = mysql_num_rows($resultHI);
$sHISN = 0;
while ($row = mysql_fetch_array($resultHI)) {
                          $sHISN = $sHISN + 1;
                           $id = $row['hlID'];
                           $itno = $row['itno'];
                           $martno = $row['martno'];
                           ...
                           $CusPO = $row['CusPO'];
                           $OEM = $row['OEM'];
                        $recordHI .= '<tr><td>'.$sHISN.'</td><td>'.$itno.'</td><td>'.$martno.'</td><td>'.$desp.'</td><td>'.$qty.'</td><td>'.$uom.'</td><td>'.$OEMPrice.'</td><td>'.$FinalPRice.'</td><td>'.$CusPO.'</td><td>'.$OEM.'</td></tr>';
...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $_SESSION['CompanyAbbr']; ?> ERP | Data History</title>
              ...
              <div class="box box-primary" style="background:#31FB82;">
                ...
                <form role="form">
                  <div class="box-body">
                   ...
                   <table class="table table-bordered table-striped" id="userTab" style="font-size:11px;">
                    <thead>
                      <tr>
                        <th>SN</th>
                        <th>Item Number</th>
