...
//check if user exist
 ...
 $resultLI = mysql_query("SELECT * FROM logistics WHERE POID='".$_GET['sPO']."' Order By lineItID");
//check if user exist
...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $_SESSION['CompanyAbbr']; ?> PURCHASE ORDER</title>
...
function editLIT(elem)
{
  ...
  //alert(LinIT);
     ...
     '<div class="form-group" style="width:100%; display: inline-block;"><label>Description: </label><input type="text" class="form-control" id="CommTitle" name="CommTitle" placeholder="Enter Title" required ></div>' +
      ...
      '<div class="form-group" style="width:100%; display: inline-block;"><label>Quantity: </label><input type="text" class="form-control" id="CommAmt" name="CommAmt" placeholder="Amount" onKeyPress="return isNumber(event)" required ></div>' +
...
<div class="col-sm-4 invoice-col" >
 <b> Special Note: </b> <br/>
<textarea id="specialnote" name="specialnote" style="border: none; min-height: 419px; min-width: 321px;" readonly><?php echo $SpecialNote; ?> </textarea>
