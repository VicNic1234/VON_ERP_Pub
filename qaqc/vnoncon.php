            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">List of Non-Conformance</h3>
...
<?php
 ...
 $resultLI = mysql_query("SELECT * FROM noncon 
 LEFT JOIN users ON noncon.CreatedBy = users.uid WHERE noncon.isActive =1 "); //WHERE isActive=1 ORDER BY cid
...
//fetch tha data from the database
	 if ($NoRowLI > 0) 
   {
    ...
    $CreatedBy = $row['Firstname'] . " " . $row['Surname'];//$row['RaisedBy'];
    ...
    $ViewCon = '<a title="View Set Line Items" href="viewpo?poid='.$cid.'"><i class="fa fa-edit"></i></a>';
