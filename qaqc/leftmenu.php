        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li><a href="calilog"><i class="fa fa-magic text-yellow"></i>
                   <span>Callibration Log</span> <small class="label pull-right bg-green">On</small></a></li>

             <li><a href="newnoncon"><i class="fa fa-legal text-aqua"></i> 
                   <span>Non Conformance</span> <small class="label pull-right bg-green">On</small></a></li>
