...
if ($NoRow > 0) {
  while ($row = mysql_fetch_array($result)) {
    $nuid = $row['uid'];
    $UserFullName = $row['Firstname'] . " " . $row['Middlename'] . " ". $row['Surname'];
    
    $OptStaff .= '<option value="'.$nuid.'">'.$UserFullName.'</option>';
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">New Non-Conformance Report</li>
          </ol>
        </section>
...
?>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Non-Conformance Report Details</h3>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12" style="background-color:#FFF888; border-radius: 15px; padding-top:22px; border: 2px solid #888;">
                    
                     <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="regNCON" method="post">

           <div class="form-group has-feedback col-md-4" >
                <label>NCR Category:</label>
                <select class="form-control" id="NCRCategory" name="NCRCategory" required >
                  <option value=""> -- </option>
      ...
      <label>Audit Area/Department</label>
		   <textarea rows="4" cols="50" id="AAD" name="AAD" style="width:100%; display: inline-block;" required ></textarea>
		 </div>
     ...
     <div class="form-group has-feedback col-md-6">
      <label>Description of Non-Conformance</label>
       <textarea rows="4" cols="50" placeholder=" Enter here..." id="Des" name="Des" style="width:100%; display: inline-block;" required ></textarea>
     </div>

     <div class="form-group has-feedback col-md-6">
      <label>Root Cause Analysis</label>
       <textarea rows="4" cols="50" placeholder=" Enter here..." id="RootC" name="RootC" style="width:100%; display: inline-block;" required ></textarea>
     </div>

      <div class="form-group has-feedback col-md-6">
      <label>Corrective Action</label>
       <textarea rows="4" cols="50" placeholder=" Enter here..." id="CorAct" name="CorAct" style="width:100%; display: inline-block;" required ></textarea>
     </div>

      <div class="form-group has-feedback col-md-6">
                    <label>Agreed Close Out Date:</label>
                    <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <input type="text" class="form-control datep" name="AgrDate" required readonly />
                    </div><!-- /.input group -->
          </div>


      <div class="form-group has-feedback col-md-12">
      <label>Preventive Action (for potential nonconformities only)</label>
       <textarea rows="4" cols="50" placeholder=" Enter here..." id="PrvAct" name="PrvAct" style="width:100%; display: inline-block;" required ></textarea>
     </div>
   

   <div class="form-group has-feedback col-md-12" style="border-radius: 15px; border: 2px solid #767">
            <p class="text-center">
                        <strong>Verification:</strong>
                      </p>
             <label><input type="radio" name="Verification" value="Accepted" /> Accepted </label> &nbsp; &nbsp;
            <label><input type="radio" name="Verification" value="Not Accepted" /> Not Accepted </label> &nbsp; &nbsp;
            <label><input type="radio" name="Verification" value="Accepted with comments" /> Accepted with comments  </label> &nbsp; &nbsp;
          
          </div>

    <div class="form-group has-feedback col-md-6">
      <label>Person Responsible for Disposition</label>
     <input class="form-control" id="PersonResp" name="PersonResp" required >
     </div>


     <div class="form-group has-feedback col-md-6">
      <label>Auditor</label>
     <select class="form-control" id="AuditorResp" name="AuditorResp" required >
