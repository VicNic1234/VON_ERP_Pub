...
//echo $DocLink; exit;
if($DocLink == ""){
	$query1 = "INSERT INTO internalauditactivities (subid, title, description, CreatedBy, CreatedOn, Type) 
	VALUES ('".$conID."','".$ActTitle."','".$ActDescr."','".$UID."','".$Today."', 'Subject');";
}
else{
  $query1 = "INSERT INTO internalauditactivities (subid, title, description, CreatedBy, CreatedOn, FileLink, Type) 
