...
$resultRFQ = mysqli_query($dbhandle, "SELECT * FROM enlinvoices LEFT JOIN customers ON enlinvoices.CusSource = customers.cusid  WHERE LEFT(IVDate,4) = '$BusinessYr' GROUP BY CusSource ");
//$NoRowRFQ = mysqli_num_rows($resultRFQ);
$NoRowRFQ = 0;
while ($rowd = mysqli_fetch_array($resultRFQ, MYSQLI_ASSOC)) {
        //Get Month
       //$month = date("m",strtotime($row['IVDate']));
        $cid = $rowd['cid']; 
      }

//We need to Get Sales Order
$resultSO = mysqli_query($dbhandle, "SELECT * FROM enlinvoices WHERE LEFT(IVDate,4) = '$BusinessYr'");
...
while ($row = mysqli_fetch_array($resultSO, MYSQLI_ASSOC)) {
        ...
        if($month == '01'){ 
          ...
          if($rptMonth == "01")
          {
            ...
            $NoRowSO = $NoRowSO + 1;
            $TotalRevenue = $TotalRevenue + $sTotal;
          }

        }
        if($month == '02'){ $RFQFeb = $RFQFeb + $sTotal; 
        if($rptMonth == "02")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '03'){ $RFQMar = $RFQMar + $sTotal; 
        if($rptMonth == "03")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '04'){ $RFQApr = $RFQApr + $sTotal; 
          if($rptMonth == "04")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '05'){ $RFQMay = $RFQMay + $sTotal; 
          if($rptMonth == "05")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '06'){ $RFQJun = $RFQJun + $sTotal; 
          if($rptMonth == "06")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '07'){ $RFQJul = $RFQJul + $sTotal; 
          if($rptMonth == "07")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '08'){ $RFQAug = $RFQAug + $sTotal; 
          if($rptMonth == "08")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '09'){ $RFQSep = $RFQSep + $sTotal; 
          if($rptMonth == "09")
          {
                $mthsales .= "{
                y: ".$sTotal.",
         ...
         if($month == '10'){ $RFQOct = $RFQOct + $sTotal; 
          if($rptMonth == "10")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '11'){ $RFQNov = $RFQNov + $sTotal; 
          if($rptMonth == "11")
          {
                $mthsales .= "{
                y: ".$sTotal.",
        ...
        if($month == '12'){ $RFQDec = $RFQDec + $sTotal; 
          if($rptMonth == "12")
          {
                $mthsales .= "{
                y: ".$sTotal.",
...
$resultPO = mysqli_query($dbhandle, "SELECT * FROM acct_vendorsinvoices WHERE LEFT(IVDate,4) = '$BusinessYr'");
...
while ($row = mysqli_fetch_array($resultPO, MYSQLI_ASSOC)) {
      ...
      $month = date("m",strtotime($row['IVDate']));
       ...
       while ($rowd = mysql_fetch_array($ItemQW)) {
              ...
              $sTotal = $convTotal + ($rowd['unitprice'] * $rowd['qty']);
       }
