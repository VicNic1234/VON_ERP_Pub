...
if ($NoRowCurr > 0) {
  while ($row = mysql_fetch_array($resultCurr)) 
  {
    ...
    /*Get PDF*/
$resultREQ = mysql_query("SELECT DISTINCT RequestID FROM poreq WHERE isActive=1 AND Approved=13 ");
...
?>
          ...
          <div class="form-group has-feedback col-md-12" >
                <label>Choose Vendor:</label>
          		  <select class="form-control" id="VendSource" name="VendSource" onchange="setVend(this)" required>
		  ...
		  <div class="form-group has-feedback col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control datep" name="PODate" readonly="" required />
                    </div><!-- /.input group -->
          </div>
       ...
       <textarea rows="4" cols="50" placeholder=" Enter scope here..." id="Scope" name="Scope" style="width:100%; display: inline-block;"></textarea>
     </div>
     ...
     <div class="form-group has-feedback col-md-12">
       ...
       <textarea rows="4" cols="50" placeholder=" Enter comment here..." id="Comment" name="Comment" style="width:100%; display: inline-block;"></textarea>
            ...
            <input type="text" class="form-control" readonly value="ENL/CUSN/C&P/PO/<?php echo $CONTRNO; ?>" id="ContractNo" name="ContractNo" placeholder="ENL/CUSN/C&P/PO/002"  required />
...
<br/>
			...
			<p class="text-center">
                        <strong>Purchase Order Document (Optional)</strong>
                      </p>
			<div class="form-group has-feedback">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Create PO</button>
            </div><!-- /.col -->
          </div>
                      </form> 
                    </div><!-- /.col -->
