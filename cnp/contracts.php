...
//fetch tha data from the database
	 if ($NoRowLI > 0) 
   {
    ...
    if($LegalApproved != "")
    {
      $LegalA = '<i class="fa fa-legal text-green"></i>';
    }
   
   if($AllowMD == 1)
    {
        $AccessState = '<input type="checkbox" checked id=sr"'.$cid.'" sr="'.$cid.'" onclick="setR(this)" title="tick to allow MD have access to this Contract" >';
    }
    else
    {
       $AccessState = '<input type="checkbox" id=sr"'.$cid.'" sr="'.$cid.'" onclick="setR(this)" title="tick to allow DM have access to this Contract" >';
    }
