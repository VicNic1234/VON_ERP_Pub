...
//fetch tha data from the database
  ...
  while ($row = mysql_fetch_array($resultLI)) {
    ...
    $DDAOfficer = getUserinfo($row['DDAOfficer']); $DDAOfficerComment = $row['DDAOfficerComment']; 
...
if ($NoRowSDoc > 0) {
  while ($row = mysql_fetch_array($resultSDoc)) 
  {
    ...
    $title = $row['title'];
    $delDoc = "";
    if($addedby == $MYID && ($DDAOfficerOn == "" || $DDOfficerOn == "") )
    {
...
if ($NoRowPOIt > 0) {
  while ($row = mysql_fetch_array($resultPOIt)) 
  {
    ...
    $delDoc = "";
  if($DDAOfficerOn == "" || $DDOfficerOn == "")
  {
      $delDoc = '<form action="delIVItem" method="POST">
...
if ($NoRowPOM > 0) {
  while ($row = mysql_fetch_array($resultPOM)) 
  {
    ...
    if($DDAOfficerOn == "" || $DDOfficerOn == "")
    {
      $delM = '<form action="delIVMItem" method="POST">
      <input type="hidden" name="id" value="'.$sdid.'" />
      <input type="hidden" name="poid" value="'.$CONID.'" />
      <button type="submit" class="btn btn-success"><i class="fa fa-trash"></i></button>
      </form>';
...
?>
		  ...
		  <div class="form-group has-feedback col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control datep" value="<?php echo $IVDate; ?>" name="IVDate" required />
                    </div><!-- /.input group -->
          </div>
		 ...
		 <br/>
          ...
          <div class="form-group has-feedback">
           <select class="form-control" name="PONum">
            <option value="">--</option>
            <?php echo $POOpt; ?>
           </select>
            <span class="glyphicon glyphicon-barcode form-control-feedback"></span>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-success">
                <div class="box-header">
                 ...
                 <?php if($DDAOfficerOn == "" || $DDOfficerOn == "") { ?>
...
<!--
   <div class="col-md-6">
                 <div class="box box-success">
                <div class="box-header">
                 Coporate Service GM's Comment
                </div>
                <div class="box-body">
                   <div class="row">
                    <div class="col-md-12">

                       <form enctype="multipart/form-data" action="updateCONTIVCS" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $cid; ?>">
                                  <textarea class="form-control" required name="DDcomment" disabled="" ><?php echo $GMCSAppComment; ?></textarea> 
                            </div>
                ...
                <div class="box-body">
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <form enctype="multipart/form-data" action="updateACONTIV" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $cid; ?>">
                                  <textarea class="form-control" required name="DDcomment" disabled="" ><?php echo $DDAOfficerComment; ?></textarea> 
                            </div>
                ...
                <div class="box-body">
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <form enctype="multipart/form-data" action="updateCONTIV" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $cid; ?>">
                                  <textarea class="form-control" required name="DDcomment" disabled="" ><?php echo $DDOfficerComment; ?></textarea> 
                            </div>
                            ...
                            <div class="form-group has-feedback col-md-12" >
                                  <label>Due Dilligence Approved On:</label>
