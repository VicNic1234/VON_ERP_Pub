...
//Update the rpo table
   mysql_query("UPDATE poreq SET Approved='3', LastActor='Contracts and Procurment', Status='Sent Back', CPApp='".$uid."', ApprovedBy='".$staffname."', CPAppDate='".$TodayD."',  CPAppComment='".$ReqMSG."' WHERE RequestID = '$ReqCode'");
...
function require_approval_action_notification ($email, $fullnme, $pdfid, $role, $msg)
{
        ...
        $msgLink = 'https://elshcon.space/requisition/divppor?pdfid='.$pdfid;
