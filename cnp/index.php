...
//Let's Read all rfq
$resultrfq = mysql_query("SELECT * FROM purchaseorders WHERE RIGHT(PODate,4) = '$BusinessYr'");
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Contracts and Procurements Dashboard
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">ENL's PO</span>
                  <span class="info-box-number"><?php echo $NoRowrfq; ?><small> for <?php echo $BusinessYr; ?></small></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
             <a title="Add Vendor" href="../utility/aSup" target="_blank" >
              <div class="info-box">
