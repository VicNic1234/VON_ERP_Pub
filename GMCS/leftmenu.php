          ...
          <ul class="sidebar-menu">
            ...
            -->
                 ...
                 <!-- <li><a href="contracts"><i class="fa fa-anchor text-blue"></i> <span>View Contracts</span> <small class="label pull-right bg-green">On</small></a></li>
                  ...
                  <li><a href="purchaseorders"><i class="fa fa-eye text-yellow"></i> <span>ENL Purchase Orders</span> <small class="label pull-right bg-green">On</small></a></li>-->

                  <li><a href="invoices"><i class="fa fa-eye text-green"></i> <span>Vendor Invoices</span> <small class="label pull-right bg-green">On</small></a></li>
                  
                  <li><a href="invoicestatus"><i class="fa fa-eye text-yellow"></i> <span>Ven. Invoices Status</span> <small class="label pull-right bg-green">On</small></a></li>
