         ...
         <center>
          ...
          <div class="row no-print">
            ...
            <div class="col-md-6">
                ...
                <div class="box-body">
                   <div class="row">
                    <div class="col-md-12">
                       ...
                       <form id="INUPDATE" enctype="multipart/form-data" action="updateCONTIVCS" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  <input type="hidden" name="conID" value="<?php echo $cid; ?>">
                                   ...
                                   <?php if($IVSTATUS == 1) { ?> 
                                  <textarea class="form-control" required name="GMCScomment" id="GMCScomment" ></textarea> 
                                  <?php } ?>
                            </div>
                            ...
                            <div class="form-group has-feedback col-md-12" >
                                  <label>GM CS Last Acted On:</label>
                                <label> <?php echo $GMCSAppDate; ?></label>
                            </div>
                            <input type="hidden" name="GMCSapprove" id="GMCSapprove" />
                            
                            <!--
                            <div class="form-group has-feedback col-md-12" >
                             <?php if($GMCSAppStatus == 1) { ?>
                                  <label><input type="checkbox" checked name="DDapprove" > &nbsp; &nbsp; Approved</label>
                              <?php } else { ?>
                                <label><input type="checkbox"  name="DDapprove" > &nbsp; &nbsp; Approved</label>
                              <?php } ?>
                            ...
                            <div class="col-md-12">
                                 <?php if($IVSTATUS == 1) { ?> 
                            <div class="col-md-6">
                              <button type="button" rs="Decline" onclick="pushover(this)" class="btn btn-warning btn-block btn-flat">Decline</button>
                            </div>
                            <div class="col-md-6">
                              <button type="button" rs="Approve" onclick="pushover(this)" class="btn btn-success btn-block btn-flat">Approve</button>
                            </div>
                            <?php } ?>
                              <br/> <br/> <br/> <br/>
                            </div>
              ...
              <script>
                  function pushover(elem)
                  {
                      var rs = $(elem).attr("rs");
                      //alert(rs)
                      if(rs == "Decline") { $('#GMCSapprove').val(0) } else {$('#GMCSapprove').val(1) }
                      $('#INUPDATE').submit();
                  }
              </script>
