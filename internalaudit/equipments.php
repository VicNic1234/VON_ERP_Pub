...
<?php
 ...
 , equip_category.station_name AS EquipCategory
 , equip_subcategory.station_name AS EquipTypeNme
 ...
 LEFT JOIN equip_stations ON equipments.EquipLoc = equip_stations.cid
   ...
   LEFT JOIN equip_category ON equipments.EquipCat = equip_category.cid
    LEFT JOIN equip_subcategory ON equipments.EquipType = equip_subcategory.cid
