...
//fetch tha data from the database
  ...
  //$enlinvoiceCode
/*  $PostedAmt = 0.0;
  $resultPOSTING = mysql_query("SELECT * FROM postings Where ENLINVOICE='$enlinvoiceCode' AND TransacType='CREDIT' AND GLImpacted='589'");
            ...
            <table class="table table-striped" style="border: 2px solid black; text-align: center;">
                 <tbody>
                  ...
                  <tr style="border: 2px solid black; text-align: center; font-size:12px">
                        <td><?php echo strtoupper($PostedAmt); ?></td>
                  </tr>
                 </tbody>
            </table>
           </div>-->
          ...
          <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
              <address>
                ...
                <b style="color:#888888">FINANCE/ACCOUNT MGR </b><br>
              </address>
            </div><!-- /.col -->
            <div class="col-sm-4 invoice-col">
             <strong> &nbsp; </strong>
