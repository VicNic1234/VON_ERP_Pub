...
$TCRD = 0.0; $TDRD = 0.0; $CHKBAL = 0.0;
    $resultChartMaster = mysql_query("SELECT *, postings.tncid As TNID, enlinvoices.cid As ivcid, reciepts.CheuqeNME As CHKNME  FROM postings
             ...
             WHERE (postings.GLImpacted <> 589 AND TransacType = 'DEBIT' AND postings.CusID = $CusID AND postings.isActive=1 )   
             OR (GLDescription =  'Trade Receivable' AND postings.CusID = $CusID AND postings.isActive=1) 
