...
if ($NoRowSUP > 0) {
  while ($row = mysql_fetch_array($resultSUP)) 
  {
    ...
    $SupNme = $row['station_name'];
    if($EquipCat == $supid)
    { $CatOpt .= '<option value="'.$supid.'" selected >'.$SupNme.'</option>'; }else
...
//fetch tha data from the database
  ...
  while ($row = mysql_fetch_array($resultLI)) {
    ...
    $EquipCat = $row['EquipCat'];
    $EquipType = $row['EquipType'];
    $Deper = $row['PerDepre'];
    $EquipQty = $row['Qty'];
    $EquipAmt = $row['UnitPrice'];
    $YearOfUse = $row['YearOfUse'];
    $EquipYrMake = $row['EquipYrMake'];
    $EquipFNo = $row['EquipFNo'];
    $Comment = $row['Comment'];  
    $OficerInc = $row['OficerInc'];  
...
if ($NoRowuser > 0) {
  while ($row = mysql_fetch_array($resultUser)) 
  {
    ...
    if($OficerInc == $uhid)
    { $UserOpt .= '<option value="'.$uhid.'" selected >'.$UserNme.'</option>'; }
    else { $UserOpt .= '<option value="'.$uhid.'">'.$UserNme.'</option>'; }
...
if ($NoRowSUP > 0) {
  while ($row = mysql_fetch_array($resultSUP)) 
  {
    ...
    $SupNme = $row['station_name'];
     if($EquipType == $supid)
     { $TypeOpt .= '<option value="'.$supid.'" selected >'.$SupNme.'</option>'; } else { $TypeOpt .= '<option value="'.$supid.'">'.$SupNme.'</option>'; }
  }
 }
...
?>
              ...
              <div class="box"> <!-- collapsed-box -->
                ...
                <div class="box-body">
                  <div class="row">
                     ...
                     <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="updateEQUIP" method="post">

           <div class="form-group has-feedback col-md-4" >
                <label>Equipment Name:</label>
                <input type="text"  class="form-control" id="EquipNme" name="EquipNme" value="<?php echo $EquipNme; ?>" required>
          ...
          <div class="form-group has-feedback col-md-4" >
                ...
                <input type="text"  class="form-control" id="EquipCode" name="EquipCode" value="<?php echo $EquipCode; ?>" required>
          ...
          <div class="form-group has-feedback col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control datep" name="EquipYrMake" value="<?php echo $EquipYrMake; ?>" readonly="" required />
                    </div><!-- /.input group -->
          </div>

           <div class="form-group has-feedback col-md-4" >
                <label>File No.:</label>
                <input type="text"  class="form-control" id="EquipFNo" name="EquipFNo" value="<?php echo $EquipCode; ?>" required>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
          ...
          <script>
              function calDepreciation()
              {
                  ...
                  if(Qty == 0) { Qty = 1; }
                  var EquipAmt = $('#EquipAmt').val();
                  var Deper = $('#Deper').val();
                  var EquipYrStart = $('#EquipYrStart').val();
                  var Der = Number(Deper)/100;
                 var TY = calculateAge(EquipYrStart);
                 var DepVal = Der* Number(EquipAmt)* Number(Qty) * TY;
                 var NETVAL = (Number(EquipAmt)* Number(Qty)) - DepVal;
                 $('#AcumDeper').val(addCommas(DepVal));
                 $('#NetDeper').val(addCommas(NETVAL));
           ...
           <div class="form-group has-feedback col-md-2" >
                <label>Qty:</label>
                <input type="text"  class="form-control" id="EquipQty" name="EquipQty" oninput="calDepreciation();" onKeyPress="return isNumber(event)" value="<?php echo $EquipQty; ?>" required>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
          
           <div class="form-group has-feedback col-md-2" >
                <label>Amount:</label>
                <input type="text"  class="form-control" id="EquipAmt" name="EquipAmt" oninput="calDepreciation();" onKeyPress="return isNumber(event)" value="<?php echo $EquipAmt; ?>" required>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
          
           <div class="form-group has-feedback col-md-2" >
                <label>Depreciate %:</label>
                <input type="text"  class="form-control" id="Deper" name="Deper" oninput="calDepreciation();" onKeyPress="return isNumber(event)" value="<?php echo $Deper; ?>" required>
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
           ...
           <div class="form-group has-feedback col-md-2">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control datey" name="EquipYrStart" onchange="calDepreciation();" id="EquipYrStart" readonly="" placeholder="Click to set date" value="<?php echo $YearOfUse; ?>" required />
                    </div><!-- /.input group -->
          </div>
          ...
          <div class="form-group has-feedback col-md-2" >
                <label>Acum. Depreciate:</label>
                <input type="text"  class="form-control" id="AcumDeper" onKeyPress="return isNumber(event)"  readonly >
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
          
          <div class="form-group has-feedback col-md-2" >
                <label>NET Value:</label>
                <input type="text"  class="form-control" id="NetDeper" onKeyPress="return isNumber(event)"  readonly >
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
