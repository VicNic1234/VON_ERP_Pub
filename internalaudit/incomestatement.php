  ...
  while ($row = mysql_fetch_array($ChartClassQ)) {
    ...
    if(getTotalAmt($cid) != 0 && $EXZ == 1)
    {
       ...
       $TY7 += floatval($SetAmtY);
        ...
        $RecChartMaster .= '<tr><td><a href="viewacct?TID='.$cid.'"><i class="fa fa-eye"></i></a> <em>'.$AccTClass.'</em></td><td>'. number_format($SetAmt, 2).'</td><td>'. number_format($SetAmtPer,2).'</td><td>'. number_format($SetAmtY, 2).'</td><td>'. number_format($SetAmtPerY,2).'</td></tr>';
    }
    else if ( $EXZ == 0)
     {
         $SetAmt = getTotalAmt($cid);  $SetAmtY = getTotalAmtYTD($cid);
  ...
  while ($row = mysql_fetch_array($ChartClassQ)) {
    ...
    if(getTotalAmt($cid) != 0 && $EXZ == 1)
    {
       ...
       $T8 += floatval($SetAmt); $TY8 += floatval($SetAmtY);
        $RecChartMaster .= '<tr><td><a href="viewacct?TID='.$cid.'"><i class="fa fa-eye"></i></a> <em>'.$AccTClass.'</em></td><td>'. number_format($SetAmt, 2).'</td><td>-</td><td>'. number_format($SetAmtY, 2).'</td><td>-</td></tr>';
    }
    else if ( $EXZ == 0)
     {
         $SetAmt = getTotalAmt($cid);  $SetAmtY = getTotalAmtYTD($cid);
    ...
    if(getTotalAmt($cid) != 0 && $EXZ == 1)
    {
    ...
    else if ( $EXZ == 0)
     {
        ...
        $SetAmtPerZ += $SetAmtPer; $SetAmtPerZY += $SetAmtPerY;
         ...
         $T6 += floatval($SetAmt); $TY6 += floatval($SetAmtY);
        $RecChartMaster .= '<tr><td><a href="viewacct?TID='.$cid.'"><i class="fa fa-eye"></i></a> <em>'.$AccTClass.'</em></td><td>'. number_format(getTotalAmt($cid), 2).'</td><td>'. number_format($SetAmtPer,2).'</td><td>'. number_format($SetAmtY, 2).'</td><td>'. number_format($SetAmtPerY,2).'</td></tr>';
    }
   }
  ...
  while ($row = mysql_fetch_array($ChartClassQ)) {
    ...
    if(getTotalAmt($cid) != 0 && $EXZ == 1)
    {
       ...
       $T5 += floatval($SetAmt); $TY5 += floatval($SetAmtY);
        $RecChartMaster .= '<tr><td><a href="viewacct?TID='.$cid.'"><i class="fa fa-eye"></i></a> <em>'.$AccTClass.'</em></td><td>'. number_format(getTotalAmt($cid), 2).'</td><td>'. number_format($SetAmtPer,2).'</td><td>'. number_format(getTotalAmtYTD($cid), 2).'</td><td>'. number_format($SetAmtPerY,2).'</td></tr>';
    }
    else if ( $EXZ == 0)
     {
        $SetAmt = getTotalAmt($cid);  $SetAmtY = getTotalAmtYTD($cid);
