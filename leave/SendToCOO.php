...
$sql_res=mysql_query("SELECT * FROM users WHERE COO ='1'"); //	LEFT JOIN users ON divisions.GM = users.uid WHERE divid.id='1'"
...
$resultLeave = mysql_query("UPDATE empleave SET HRApp='$StaffID', HRAppDate='$TodayD', HRAppComment='$ReqMSG', GMCSApp='$HODID', Status='9' WHERE id = '".$reqID."'");
		require_approval_action_notification ($HODEmail, $HODFullname, $reqID, "COO"); 
...
//Lets sned the EMail here, No time
		function require_approval_action_notification ($email, $fullnme, $pdfid, $role)
		{
		        ...
		        $msgLink = 'https://www.elshcon.space/leave/cooleave';
