...
$sql_res=mysql_query("SELECT * FROM users WHERE users.CEO='1'");
...
$resultLeave = mysql_query("UPDATE empleave SET HRApp='$StaffID', HRAppDate='$TodayD', HRAppComment='$ReqMSG', MDApp='$HODID', Status='6' WHERE id = '".$reqID."'");
		require_approval_action_notification ($HODEmail, $HODFullname, $reqID, "MD"); 
...
//Lets sned the EMail here, No time
		function require_approval_action_notification ($email, $fullnme, $pdfid, $role)
		{
		        ...
		        $MsgTitle = "Elshcon ERP [Approved Leave by HR]";
		        ...
		        $msgLink = 'https://www.elshcon.space/leave/gmcsleave';
