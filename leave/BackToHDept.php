...
$sql_res=mysql_query("SELECT * FROM empleave LEFT JOIN users ON empleave.HODApp = users.uid WHERE empleave.id='$reqID'");
...
$resultLeave = mysql_query("UPDATE empleave SET DivHApp='$StaffID', DivHAppDate='$TodayD', DivHAppComment='$ReqMSG', Status='1' WHERE id = '".$reqID."'");
		require_approval_action_notification ($HODEmail, $HODFullname, $reqID, "Head of Department"); 
...
//Lets sned the EMail here, No time
		function require_approval_action_notification ($email, $fullnme, $pdfid, $role)
		{
		        ...
		        $MsgTitle = "Elshcon ERP [Sent Back Leave]";
		        ...
		        $msgLink = 'https://www.elshcon.space/leave/deptleave';
