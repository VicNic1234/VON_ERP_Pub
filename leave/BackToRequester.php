...
$sql_res=mysql_query("SELECT * FROM empleave LEFT JOIN users ON empleave.uid = users.uid WHERE empleave.id='$reqID'");
...
$resultLeave = mysql_query("UPDATE empleave SET HODApp='$StaffID', HODAppDate='$TodayD', HODAppComment='$ReqMSG', Status='0' WHERE id = '".$reqID."'");
