...
//Let's know is this requester is a GM
$sql_GMCHK = mysql_query("SELECT * FROM divisions WHERE GM='$HODHRID'");
$isGM = mysql_num_rows($sql_GMCHK);
if($isGM > 0)
{
...
//Lets sned the EMail here, No time
		function require_approval_action_notification ($email, $fullnme, $pdfid, $role)
		{
		        ...
		        $MsgTitle = "Elshcon ERP [Approved by GM of CS Leave]";
