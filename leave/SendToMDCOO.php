...
$resultLeave = mysql_query("UPDATE empleave SET GMCSApp='$StaffID', GMCSAppDate='$TodayD', GMCSAppComment='$ReqMSG', MDApp='$HODID', Status='6' WHERE id = '".$reqID."'");
		require_approval_action_notification ($MDEmail, $MDFullname, $reqID, "MD"); 
...
//Lets sned the EMail here, No time
		function require_approval_action_notification ($email, $fullnme, $pdfid, $role)
		{
		        ...
		        $MsgTitle = "Elshcon ERP [Approved Leave by COO]";
