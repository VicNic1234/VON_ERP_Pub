  ...
  while ($row = mysql_fetch_array($result)) {
   ...
   $Record .='
     ...
     $RecordEditable .='
					 <tr>
            <td>'.$ReqDate.'</td>
					  <td><select class="form-control" id="LeaveType" name="LeaveType" required >
                        <option value=""> -- </option>
                      ...
                      </select> <input type="hidden" name="LID" value="'.$LID.'" ></td>
						<td><textarea class="form-control" name="LeavePurpose">'.$Note.'</textarea></td>
            <td> <input type="text" class="form-control" id="StartDay" name="StartDay" value="'.$StartDay.'" placeholder="yy-mm-dd" readonly required /></td>
						<td>  <input type="text" class="form-control" id="EndDay" name="EndDay" placeholder="yy-mm-dd" value="'.$EndDay.'" readonly required /></td>
            <td>'.$NoOfDays.'</td>
            <td><button type="sumbit" class="btn btn-success"> Update Request </button></td>
          ...
          <span class="logo-lg"> <img src="../mBOOT/plant.png" style ="width:40px; height:40px;"/></span>-->
              ...
              <table id="CommTab" class="table table-striped">
                ...
                <div class="table-responsive col-md-12">
                  <form method="post" action="updatemyleave">
                     <table id="userTab" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <?php if($Editable == "Yes") { echo  $RecordEditable; } else { echo $Record; } ?>
                        </tbody>
