...
$sql_res=mysql_query("SELECT * FROM divisions 
	...
	LEFT JOIN users ON divisions.GM = users.uid WHERE divid.id='1'");
...
$resultLeave = mysql_query("UPDATE empleave SET HRApp='$StaffID', HRAppDate='$TodayD', HRAppComment='$ReqMSG', GMCSApp='$HODID', Status='4' WHERE id = '".$reqID."'");
		require_approval_action_notification ($HODEmail, $HODFullname, $reqID, "GM Of CS"); 
