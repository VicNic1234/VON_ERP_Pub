...
<?php if ($NoRowCUS > 0) 
 ...
 LEFT JOIN users ON jha.raisedby = users.uid WHERE jha.jhaid = '$JHID'
 "); 
    ...
    <?php include('leftmenu.php') ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            View Job Harzard Analysis Report 
...
?>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12" style="background-color:#C1E0FF; border-radius: 15px; padding-top:22px; border: 2px solid #888;">
                     ...
                     <form enctype="multipart/form-data" id="fRFQ" name="fRFQ" action="updateJHA" method="post">
          
          <div class="form-group has-feedback col-md-4" >
                <label>Project Title:</label>
                <input type="text" class="form-control" id="ProjTitle" name="ProjTitle" value="<?php echo $ProjectTitle; ?>" required />
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
            <input type="hidden" name="JHAID" value="<?php echo $jhaid; ?>">
          </div>

          <div class="form-group has-feedback col-md-4" >
                <label>Client:</label>
                <input type="text" class="form-control" id="CLient" name="CLient" value="<?php echo $Client; ?>" required />
            <span class="glyphicon glyphicon-export form-control-feedback"></span>
          </div>
      ...
      <label>JHA Review Team Composition</label>
		   <textarea rows="4" cols="50" placeholder=" Type here..." id="Desc" name="ReviewTeam" style="width:100%; display: inline-block;" required ><?php echo $TeamComposition; ?></textarea>
		 </div>
