...
$UID = $_SESSION['uid'];
  ...
  $Today = date('Y/m/d h:i:s a'); 
	...
	$query1 = "UPDATE lineitems SET Description='".$LiDescription."', Qty='".$LiQty."', UOM='".$UOM."', UnitCost='".$LiRate."', ExtendedCost='".$LiTRate."' WHERE LitID='".$lineitemID."'"; 

if(mysql_query($query1, $dbhandle))
{
   
  	$_SESSION['ErrMsgB'] = "Line Item is Update";
...
//echo mysql_error();
//exit;
 $_SESSION['ErrMsg'] = "Oops! Did not update Item ";
  header('Location: viewrfq?cnid='.$conID);
