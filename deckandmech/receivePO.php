       ...
       function setRFQNo(elem)
       {
		 ...
		 <div class="form-group has-feedback col-md-12">
		   <textarea rows="4" cols="50" placeholder=" Enter comment here..." id="Comment" name="Comment" style="width:100%; display: inline-block;"></textarea>
            ...
            <input type="text" class="form-control" value="" id="PONo" name="PONo" placeholder=""  required />
...
<br/>
      ...
      <div class="form-group has-feedback">
        ...
        <br/>
			<p class="text-center">
                        <strong>PO Document (Optional)</strong>
                      </p>
			<div class="form-group has-feedback">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <button type="submit" class="btn btn-success btn-block btn-flat">Receive PO</button>
            </div><!-- /.col -->
          </div>
                      </form> 
                    </div><!-- /.col -->
