            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Raise Sales Order (Receive Purchase Order)</h3>
	...
	<div class="box box-primary">
		 ...
		 <div class="form-group has-feedback" style="width:83%; display: inline-block; ">
		   <textarea rows="4" cols="50" placeholder=" Enter comment here..." id="Comment" name="Comment" style="width:100%; display: inline-block;"></textarea>
                    ...
                    <div class="col-md-4">
                      <p class="text-center">
                        <strong>Customer's order number</strong>
                      </p>
...
<div class="form-group has-feedback" style="width:100%; display: inline-block;">
            <input type="text" class="form-control" id="RFQNo" name="RFQNo" placeholder="SO Number" ReadOnly required />
            <span class="glyphicon glyphicon-barcode form-control-feedback"></span>
          </div>
<br>
			<p class="text-center">
                        <strong>Attach SO Document (Optional)</strong>
                      </p>
			<div class="form-group has-feedback">
