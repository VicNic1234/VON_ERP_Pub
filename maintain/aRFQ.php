...
ON rfq.PEAID=users.uid WHERE Status='OPEN'");
//check if user exist
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
       ...
       <li class="treeview">
              <a href="dnt">
                   <i class="fa fa-book"></i><span>Delivery Note</span></i>
              </a>
            </li>

      <li class="treeview">
              <a href="gdn">
                   <i class="fa fa-book"></i><span>Goods Dispatched Note</span></i>
              </a>
            </li>

      <li class="treeview">
              <a href="grn">
                   <i class="fa fa-book"></i><span>Goods Received Note</span></i>
              </a>
            </li>
