...
//Let's Read all SO
$resultSO = mysql_query("SELECT * FROM so ");
    ...
    <div class="wrapper">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Customer's RFQ</span>
      ...
      <a title="Add Unit of Measure" href="../utility/aUOM" target="_blank">
       <div class="info-box">
             ...
             <div class="col-md-3 col-sm-6 col-xs-12">
      <a title="PO Requistion" href="../requisition/rpor" target="_blank">
       <div class="info-box">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
      <a title="Print PO Requistion" href="../requisition/ppor" target="_blank">
       <div class="info-box">
