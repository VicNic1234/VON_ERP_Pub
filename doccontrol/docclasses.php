              ...
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"></h3>
				          <button class="btn btn-primary pull-right" onclick="addclass()">Add New Document Class</button>
                </div><!-- /.box-header -->
...
//fetch tha data from the database
	 if ($NoRowLI > 0) 
   {
    ...
    $ViewCon = '<a title="View Doc" href="viewdoc?cnid='.$sdid.'"><i class="fa fa-eye"></i></a>';
    ...
    <script type="text/javascript">
      ...
      function addclass()
      {
        ...
        //alert(CONID);
          ...
          var size='standart';
                  var content = '<form role="form" action="addClass" method="POST" enctype="multipart/form-data" ><div class="form-group">' +
                  // '<input type="hidden" name="conID" value="'+CONID+'" required />'+
                   ...
                   '<button type="submit" class="btn btn-success pull-right">Add Doc. Class</button><br/></form>';
                  var title = 'New Doc. Class';
