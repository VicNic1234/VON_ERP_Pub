...
//check if user exist
 ...
 {
 $resultLI = mysql_query("SELECT * FROM logistics WHERE OPWh='1' AND GoodsRv='1'");
//check if user exist
 $NoRowLI = mysql_num_rows($resultLI);
 }
 else
 {
 $resultLI = mysql_query("SELECT * FROM logistics WHERE POID='".$_GET['sRFQ']."' AND OPWh='1' AND GoodsRv='1'");
//check if user exist
 $NoRowLI = mysql_num_rows($resultLI);
 }
