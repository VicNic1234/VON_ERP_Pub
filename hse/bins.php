...
//onKeyPress="return isNumber(event)"
    var size='standart';
            var content = '<form role="form" action="addBin" method="POST" ><div class="form-group">' +
              ...
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Bin Code: </label><input type="text" class="form-control" onKeyPress="return isNumber(event)" id="addCode" name="addCode" placeholder="e.g 1234"  ></div>' +
