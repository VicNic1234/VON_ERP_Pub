      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Hazard ID Reports</li>
          </ol>
        </section>
...
<?php
 ...
 LEFT JOIN users ON hir.raisedby = users.uid WHERE hir.isActive=1
...
if($Comment == "")
{
    $ViewCon = '<a title="View full HIR" href="viewhir?cnid='.$hirid.'"><i class="fa fa-eye"></i></a>';
}
