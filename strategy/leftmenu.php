<aside class="main-sidebar">
  ...
  <!--
               <li><a href="pendingcashreq"><i class="fa fa-money text-aqua"></i> <span>Cash Request</span> <small class="label pull-right bg-green">On</small></a></li>

                <li><a href="pendingmaterialreq"><i class="fa fa-cogs text-aqua"></i> <span>Material Request</span> <small class="label pull-right bg-green">On</small></a></li>
