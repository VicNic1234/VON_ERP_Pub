        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li><a href="newjob"><i class="fa fa-xing text-aqua"></i>
                   <span>New JOB</span> <small class="label pull-right bg-green">On</small></a></li>
                <li><a href="jobs"><i class="fa fa-xing text-lemon"></i>
                   <span>Treat JOBs</span> <small class="label pull-right bg-green">On</small></a></li>
            <!--
             <li><a href=""><i class="fa fa-money text-aqua"></i> 
                   <span>Quotations</span> <small class="label pull-right bg-green">On</small></a></li>
-->
            <li><a href="VUtilities"><i class="fa fa-anchor text-aqua"></i>
                   <span>Vessels Utilization</span> <small class="label pull-right bg-aqua">On</small></a></li>
