...
$query = "INSERT INTO rfq (RFQNum, Customer, cusid, Attention, DateStart, DateEnd, Comment, RFQBusUnit, Attachment, Status, Currency, PEAID, CreatedOn) 
VALUES ('$RFQNo','$CusSCode','$CusID', '$Attn', '$conSDate','$conEDate','$Comment','$conBusn','$FILEURL', 'OPEN', '$Currency', '$UID', '$TDay');";
    ...
    //if(mysql_query($query1, $dbhandle))
{
   ...
   $query2 = "UPDATE sysvar SET variableValue='".$CONcount."' WHERE variableName = 'RFQCount'";
