    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Marine and Logistics Dashboard
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <a href="../utility/Cus" target="_blank">
              <div class="info-box" title="Customers/Clients">
                <span class="info-box-icon bg-aqua"><i class="fa fa-cog spin"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">Customers/Clients</span>
                  <span class="info-box-number"><?php echo $NoRowcrfq; ?><small> for <?php echo date("Y"); ?></small></span>
            ...
            <a href="rfqs">
              <div class="info-box">
                <span class="info-box-icon bg-purple"><i class="ion ion-ios-gear"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">All RFQs</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Open RFQs</span>
                  <span class="info-box-number"><?php echo $NoRowRFQ1; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
             </a>
            </div><!-- /.col -->
              <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <span class="info-box-icon bg-yellow"><i class="ion ion-ios-gear"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">Open Request</span>
                  <span class="info-box-number"><?php echo $NoRowReqO; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
