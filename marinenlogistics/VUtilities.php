    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Vessels Utilities Update
           <small>Version <?php echo $_SESSION['version']; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Vessels Utilities Update</li>
          </ol>
        </section>
...
<?php
 ...
 $resultLI = mysql_query("SELECT * FROM mljobs 
...
//fetch tha data from the database
	 if ($NoRowLI > 0) 
   {
    ...
    if($FileLink != ""){
    $FileLinkn = '<a target="_blank" title="Download JOB document" href="'.$FileLink.'"><i class="fa fa-link"></i></a>';
    }
    else
    {
      $FileLinkn = '';
    ...
    $ViewCon = '<a title="View full Job" href="viewjob?cnid='.$cid.'"><i class="fa fa-eye"></i></a>';
