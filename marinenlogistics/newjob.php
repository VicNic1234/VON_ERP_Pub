...
//check if user exist
 ...
 while ($row = mysql_fetch_array($result)) 
  {
    $suid = $row['uid'];
    $sName = $row['Firstname'] . " " . $row['Middlename'] ." ".$row['Surname'];
    $StaffList .= '<option value="'.$suid.'">'.$sName.'</option>';
  }
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-8" style="background-color:#00C888; border-radius: 15px; padding-top:22px;">
                     ...
                     <form enctype="multipart/form-data" id="fJOB" name="fJOB" action="regJOB" method="post">
...
<br/>
			...
			<p class="text-center">
                        <strong>JOB Document (Optional)</strong>
                      </p>
			<div class="form-group has-feedback">
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Create Job</button>
            </div><!-- /.col -->
          </div>
                      </form> 
                    </div><!-- /.col -->
