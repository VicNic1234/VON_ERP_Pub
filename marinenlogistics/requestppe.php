...
$ChartClassQ = mysql_query("SELECT * FROM ppe_kit Where isActive=1 ORDER BY ppe_name");
...
if ($NoRowChartType > 0) {
  while ($row = mysql_fetch_array($resultChartType)) {
    ...
    <td><a href="delppereq?id='.$id.'" ><i class="fa fa-trash text-red"></i></a></td>
    </tr>';
    }
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">PPE Requests</li>
          </ol>
        </section>
           ...
           <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">All PPE Request on ERP</h3>
              ...
              <div class="box">
                <div class="box-header">
                 <button class="btn btn-success pull-right" id="addAcct" onclick="addAcc(this)"> Make PPE Request</button>
...
function addAcc(elem)
{
    var OptClClass = '<?php echo $OptClass ?>'
    var size='standart';
            var content = '<form role="form" action="addPPEReq" method="POST" ><div class="form-group">' +

              '<div class="form-group col-md-12"><label>Kit Name: </label><select class="form-control" id="KitNme" name="KitNme" required>'+ 
                  OptClClass +
              '</select></div>' +
              ...
              '<div class="form-group col-md-6" ><label>Staff Data: </label><input type="text" class="form-control" id="KPIData" name="KPIData" placeholder="" required ></div>' +
              '<button type="submit" class="btn btn-primary pull-right">Send Request</button><br/></form>';
            var title = 'New PPE Request';
            var footer = '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
