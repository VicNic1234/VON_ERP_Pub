...
//Unattended RFQ
$resulturfq = mysql_query("SELECT * FROM rfq WHERE Status='OPEN'");
$NoRowurfq = mysql_num_rows($resulturfq);
//Get Customers
...
//No of Stations
$resultStations = mysql_query("SELECT * FROM wh_stations");
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $NoRowStocks; ?><small> for <?php echo date("Y"); ?></small></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            <div class="col-md-3 col-sm-6 col-xs-12">
			 <a title="Add Station" href="stations" target="_blank" >
              <div class="info-box">
                <span class="info-box-icon bg-red"><i class="fa fa-map-marker"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">No. of Locations</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
			<a title="Add Storage" href="storages" target="_blank">
              <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa fa-bank"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">No. of Storages</span>
                  <span class="info-box-number"><?php echo $NoRowStorages; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
			</a>
            </div><!-- /.col -->
              <div class="col-md-3 col-sm-6 col-xs-12">
      <a title="Add Bin" href="bins" target="_blank">
              <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa fa-database"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">No. of Bins</span>
                  <span class="info-box-number"><?php echo $NoRowBins; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
      </a>
            </div><!-- /.col -->
            <div class="col-md-3 col-sm-6 col-xs-12">
			<a title="Add Inventory" href="stocks" target="_blank">
			 <div class="info-box">
                <span class="info-box-icon bg-yellow"><i class="ion ion-ios-people-outline"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">No. of Items</span>
                  <span class="info-box-number"><?php echo $NoRowStocks; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
			</a>
            </div><!-- /.col -->
