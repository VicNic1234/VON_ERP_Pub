...
if ($NoRowChartMaster > 0) {
  while ($row = mysql_fetch_array($resultChartMaster)) {
    ...
    <td><a mid="'.$mid.'" id="'.$id.'" catname="'.$catname.'" catID="'.$catID.'"  Description="'.$Description.'" Station="'.$StationID.'" Storage="'.$StorageID.'" Bin="'.$BinID.'" Bal="'.$Bal.'" AmtBal="'.$TotalAmtBal.'" Condi="'.$Condi.'" onclick="addStockItem(this)"  ><i class="fa fa-plus"></i></a></td>
    <td><a mid="'.$mid.'" id="'.$id.'" catname="'.$catname.'" catID="'.$catID.'"  Description="'.$Description.'" Station="'.$StationID.'" Storage="'.$StorageID.'" Bin="'.$BinID.'" Bal="'.$Bal.'" AmtBal="'.$TotalAmtBal.'" Condi="'.$Condi.'" onclick="removeStockItem(this)"  ><i class="fa fa-minus"></i></a></td>
...
{   
  ...
  /*
   mid="'.$mid.'" id="'.$id.'" catname="'.$catname.'" Description="'.$Description.'" Station="'.$Station.'" Storage="'.$Storage.'" Bin="'.$Bin.'" Bal="'.$Bal.'" Condi="'.$Condi.'"*/
    ...
    var size='standart';
            var content = '<form role="form" action="addStockItem" method="POST" ><div class="form-group">' +
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Location: </label><select class="form-control" id="addLocation" name="Location" binCtrl="eBin" storageCtrl="edStorage" onchange="loadStorage(this)" readonly required >'+OptClClass+'</select></div>' +
              '<input type="hidden" name="SID" value="'+SID+'" required />'+
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Storage: </label><select class="form-control" id="edStorage" binCtrl="eBin" onchange="setBin(this)" name="Storage" readonly required ><option value=""> -- </option>'+OptType+'</select></div>' +
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Bin: </label><select class="form-control" id="eBin" name="Bin" readonly required >'+OptBin+'</select></div>' +
              
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Item Category: </label><select class="form-control" id="itCat" onchange="setPS();" name="itCat" readonly required >'+ OptITCat +'</select></div>' +
              
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Item Code: </label><input type="text" class="form-control" id="ItCode" name="itCode" placeholder="Item Code" readonly value="'+id+'" required ></div>' +

               '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Item Description: </label><textarea class="form-control" id="ItDes" name="itDes" placeholder="Item Description" readonly required >'+Description+'</textarea></div>' +
...
{   
  ...
  /*
   mid="'.$mid.'" id="'.$id.'" catname="'.$catname.'" Description="'.$Description.'" Station="'.$Station.'" Storage="'.$Storage.'" Bin="'.$Bin.'" Bal="'.$Bal.'" Condi="'.$Condi.'"*/
    ...
    var size='standart';
            var content = '<form role="form" action="removeStockItem" method="POST" ><div class="form-group">' +
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Location: </label><select class="form-control" id="addLocation" name="Location" binCtrl="eBin" storageCtrl="edStorage" onchange="loadStorage(this)" readonly required >'+OptClClass+'</select></div>' +
              '<input type="hidden" name="SID" value="'+SID+'" required />'+
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Storage: </label><select class="form-control" id="edStorage" binCtrl="eBin" onchange="setBin(this)" name="Storage" readonly required ><option value=""> -- </option>'+OptType+'</select></div>' +
              '<div class="form-group" style="width:100%; display: inline-block; margin: 6px"><label>Bin: </label><select class="form-control" id="eBin" name="Bin" readonly required >'+OptBin+'</select></div>' +
           ...
           <div class="col-md-12">
              ...
              <div class="box">
                <div class="box-header">
                 <button class="btn btn-success pull-right" id="addAcct" onclick="addAcc(this)" > Add Stocks</button>
                   ...
                   <table id="userTab" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Bal</th>
                        <th>Condition</th>
                       <!-- <th>Edit</th> -->  <th>Add</th>  <th>Remove</th>
                        <th>History</th>
                      </tr>
                    </thead>
                    <tbody>
