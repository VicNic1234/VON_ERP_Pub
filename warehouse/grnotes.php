...
$resultPOIt = mysql_query("SELECT * FROM grn LEFT JOIN poitems ON poitems.poitid = grn.ItemID Where grn.isActive=1");
...
if ($NoRowPOIt > 0) {
  while ($row = mysql_fetch_array($resultPOIt)) 
  {
    ...
    $LineItems .= '<tr style="border: 2px solid black;">
                    <td style="border: 1px solid black;">'.$GRNCoden.'</td>
                    ...
                    <td style="border: 1px solid black;"><a href="printGRN?GRNCODE='.$GRNCoden.'"><i class="fa fa-eye"></i></a></td>
...
<?php
 ...
 $resultLI = mysql_query("SELECT *, DISTINCT GRNCode FROM grn LE
