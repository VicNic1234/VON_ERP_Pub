...
$CONID = $_GET['poid'];
 ...
 LEFT JOIN users ON purchaseorders.DDOfficer = users.uid
 WHERE cid='".$CONID."'
...
//fetch tha data from the database
  ...
  while ($row = mysql_fetch_array($resultLI)) {
    ...
    $DDOfficer = $row['Firstname'] . " " . $row['Surname'];//$row['RaisedBy'];
...
if ($NoRowPOIt > 0) {
  while ($row = mysql_fetch_array($resultPOIt)) 
  {
   ...
   // $setGRN = "<button class='btn btn-success'><i class='fa fa-upload'></i></button>";
...
if ($NoRowPOM > 0) {
  while ($row = mysql_fetch_array($resultPOM)) 
  {
   ...
   /* if($DDOfficerOn != "")
    {
      $delDoc = '<form action="delPOMItem" method="POST">
      <input type="hidden" name="id" value="'.$sdid.'" />
      <input type="hidden" name="poid" value="'.$CONID.'" />
      <button type="submit" class="btn btn-success"><i class="fa fa-trash"></i></button>
      </form>';
...
?>
          ...
          <div class="form-group has-feedback col-md-12" >
                <label>Vendor:</label>
          		  <input type="text" class="form-control" readonly="" value="<?php echo $SupOpt; ?>">  
		  ...
		  <div class="form-group has-feedback col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" readonly value="<?php echo $PODate; ?>" name="PODate" required />
                    </div><!-- /.input group -->
          </div>
         ...
         <div class="form-group has-feedback col-md-6">
                   ...
                   <div class="input-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $OptStaff; ?>" readonly >  
                    </div><!-- /.input group -->
          </div>

          <div class="form-group has-feedback col-md-6">
            <label>Business Unit:</label>
            <input type="text" value="<?php echo $RecDiv; ?>" class="form-control" readonly >
             <span class="glyphicon glyphicon-download form-control-feedback"></span>
          </div>

          <div class="form-group has-feedback col-md-6">
            <label>Currency:</label>
            <input type="text" value="<?php echo $CurrOpt; ?>" class="form-control" readonly >
		 ...
		 <div class="form-group has-feedback col-md-12">
		   <textarea rows="4" cols="50" placeholder=" Enter comment here..." id="Comment" name="Comment" style="width:100%; display: inline-block;" readonly=""><?php echo $Comment; ?></textarea>
            ...
            <input type="text" class="form-control"  value="<?php echo $PONo; ?>" id="ContractNo" name="ContractNo" readonly  required />
            <span class="glyphicon glyphicon-barcode form-control-feedback"></span>
          </div>
		 <br/>
             <p class="text-center">
                        <strong>PDF Number</strong>
                      </p>
          <div class="form-group has-feedback">
           <input type="text" class="form-control" value="<?php echo $ReQOpt; ?>" readonly  >
            <span class="glyphicon glyphicon-barcode form-control-feedback"></span>
          </div>
<br/>
                      ...
                      <p class="text-center">
                        <?php if($FileLink != "") { ?>
                       <a href="<?php echo $FileLink; ?>"><strong>Click To Download Main PO Document</strong></a>
                     <?php } ?>
                      </p>
