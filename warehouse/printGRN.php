...
$GRNCode = $_GET['GRNCODE']; 


$CurrNme = "Naira";
$PageTitle = "GRN No. : ".$GRNCode;
    ...
    /*Get Line Item */
$resultPOIt = mysql_query("SELECT * FROM grn LEFT JOIN poitems ON poitems.poitid = grn.ItemID Where grn.GRNCode='$GRNCode' AND grn.isActive=1");
...
if ($NoRowPOIt > 0) {
  while ($row = mysql_fetch_array($resultPOIt)) 
  {
    ...
    $LineItems .= '<tr style="border: 2px solid black;">
                    ...
                    /*
                    <td style="border: 1px solid black;">'.number_format($unitprice).'</td>
                    <td style="border: 1px solid black;">'.number_format($totalprice).'</td>
                    */
  }
 }  
...
<div class="pad margin no-print">
          <div class="callout callout-info" style="margin-bottom: 0!important;">												
            ...
            This page has been enhanced for printing. Click the print button at the bottom of the Goods Received Note to print.
          </div>
</div>
        <!-- Main content -->
        <section>
...
<div id="PrintArea">
          ...
          <center><b><h2>GOODS RECEIVED NOTE</h2></b></center>
          <small class="pull-right"><?php echo $GRNCode; ?></small>
          <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
              ...
              <?php echo $GRNCode; ?><br/>
              <br/>
              <b>GRN Date:</b><br/> <?php echo $GRNDate;?>
            </div><!-- /.col -->
          </div><!-- /.row -->
