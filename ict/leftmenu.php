          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li><a href="itcat"><i class="fa fa-cubes text-blue"></i>
                   <span>Request Categories</span> <small class="label pull-right bg-green">On</small></a></li>

             <li><a href="treatreq"><i class="fa fa-wrench text-yellow"></i> 
                   <span>Treat Requests</span> <small class="label pull-right bg-green">On</small></a></li>
