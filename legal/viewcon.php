                    ...
                    <div class="col-md-12">
                       ...
                       <form enctype="multipart/form-data" action="updateCONT" method="post">
                            <div class="form-group has-feedback col-md-12" >
                                  ...
                                  <textarea class="form-control" required name="legalcomment" ><?php echo $LegalOfficerComment; ?></textarea> 
                            </div>
                            <div class="form-group has-feedback col-md-12" >
                              <?php if($LegalOfficerOn == "") { ?>
                                  <label><input type="checkbox" name="legelapprove"> &nbsp; &nbsp; Approve</label>
                              <?php } else { ?>
                                <label><input type="checkbox" checked name="legelapprove"> &nbsp; &nbsp; Approve</label>
                              <?php } ?>
