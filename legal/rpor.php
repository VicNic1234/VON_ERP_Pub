...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PEEL ERP | Register New RPO</title>
...
<br>
      ...
      <div class="form-group has-feedback col-xs-12" style="width:90%; display: inline-block; margin:12px;">
       ...
       <input type="text" class="form-control" id="rqid" name="rqid" placeholder="Request ID" value="PEEL-<?php echo $NoRowNumofRP; ?>B" required />
      </div>
            <div class="col-xs-12">
